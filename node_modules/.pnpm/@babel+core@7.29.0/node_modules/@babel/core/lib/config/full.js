...
const makeDescriptorLoader = apiFactory => (0, _caching.makeWeakCache)(function*  makeDescriptorLoader({
  value,
  options,
  dirname,
  alias
...
const instantiatePlugin = (0, _caching.makeWeakCache)(function*  instantiatePlugin({
  value,
  options,
  dirname,
  alias,
