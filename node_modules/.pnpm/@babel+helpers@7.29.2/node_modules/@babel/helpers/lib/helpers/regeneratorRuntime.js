...
function _regeneratorRuntime() {
  ...
  function wrapInnerFn(innerFn) {
    ...
    return function (context) {
      if (!compatContext) {
        ...
        callSyncState = function  callSyncState(fn, a1, a2) {
  ...
  return (exports.default = _regeneratorRuntime = function  _regeneratorRuntime() {
    return {
      wrap: function  wrap(innerFn, outerFn, self, tryLocsList) {
        return r.w(wrapInnerFn(innerFn), outerFn, self, tryLocsList && tryLocsList.reverse());
      },
      isGeneratorFunction: isGeneratorFunction,
      mark: r.m,
      awrap: function  awrap(value, kind) {
