...
function _getDecoratorsApi() {
  ...
  var e = {
    ...
    initializeInstanceElements: function initializeInstanceElements(e, r) {
      ["method", "field"].forEach(function  initializeInstanceElements(t) {
        r.forEach(function  initializeInstanceElements(r) {
    ...
    initializeClassElements: function initializeClassElements(e, r) {
      var t = e.prototype;
      ["method", "field"].forEach(function  initializeClassElements(i) {
        r.forEach(function  initializeClassElements(r) {
          var o = r.placement;
    ...
    decorateClass: function decorateClass(e, r) {
      ...
      if (e.forEach(function  decorateClass(e) {
        this.addElementPlacement(e, o);
      }, this), e.forEach(function  decorateClass(e) {
    ...
    toElementDescriptors: function toElementDescriptors(e) {
      if (void 0 !== e) return toArray(e).map(function  toElementDescriptors(e) {
