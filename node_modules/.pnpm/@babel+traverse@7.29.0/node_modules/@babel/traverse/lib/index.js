...
traverse.clearNode = function  clearNode(node, opts) {
  removeProperties(node, opts);
};
traverse.removeProperties = function  removeProperties(tree, opts) {
  traverseFast(tree, traverse.clearNode, opts);
  return tree;
};
traverse.hasType = function  hasType(tree, type, denylistTypes) {
  if (denylistTypes != null && denylistTypes.includes(tree.type)) return false;
  if (tree.type === type) return true;
  return traverseFast(tree, function  hasType(node) {
