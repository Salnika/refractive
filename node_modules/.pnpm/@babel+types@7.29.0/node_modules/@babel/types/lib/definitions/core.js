...
defineType("AssignmentExpression", {
  fields: {
    operator: {
      validate: !process.env.BABEL_TYPES_8_BREAKING ? (0, _utils.assertValueType)("string") : Object.assign(function  validate() {
        const identifier = (0, _utils.assertOneOf)(..._index.ASSIGNMENT_OPERATORS);
        const pattern = (0, _utils.assertOneOf)("=");
        return function  validate(node, key, val) {
...
defineType("FunctionDeclaration", {
  ...
  validate: !process.env.BABEL_TYPES_8_BREAKING ? undefined : function  validate() {
    const identifier = (0, _utils.assertNodeType)("Identifier");
    return function  validate(parent, key, node) {
...
defineType("Identifier", {
  ...
  fields: Object.assign({}, patternLikeCommon(), {
    name: {
      validate: process.env.BABEL_TYPES_8_BREAKING ? (0, _utils.chain)((0, _utils.assertValueType)("string"), Object.assign(function  validate(node, key, val) {
  ...
  validate: process.env.BABEL_TYPES_8_BREAKING ? function  validate(parent, key, node) {
...
defineType("NumericLiteral", {
  ...
  fields: {
    value: {
      validate: (0, _utils.chain)((0, _utils.assertValueType)("number"), Object.assign(function  validate(node, key, val) {
...
defineType("ObjectProperty", {
  ...
  fields: {
    ...
    shorthand: {
      validate: process.env.BABEL_TYPES_8_BREAKING ? (0, _utils.chain)((0, _utils.assertValueType)("boolean"), Object.assign(function  validate(node, key, shorthand) {
        if (!shorthand) return;
        if (node.computed) {
...
defineType("RestElement", {
  ...
  validate: process.env.BABEL_TYPES_8_BREAKING ? function  validate(parent, key) {
...
defineType("TryStatement", {
  ...
  fields: {
    block: {
      validate: process.env.BABEL_TYPES_8_BREAKING ? (0, _utils.chain)((0, _utils.assertNodeType)("BlockStatement"), Object.assign(function  validate(node) {
...
defineType("ExportNamedDeclaration", {
  ...
  fields: Object.assign({
    declaration: {
      optional: true,
      validate: process.env.BABEL_TYPES_8_BREAKING ? (0, _utils.chain)((0, _utils.assertNodeType)("Declaration"), Object.assign(function  validate(node, key, val) {
    ...
    specifiers: {
      default: [],
      validate: (0, _utils.arrayOf)(function  validate() {
        const sourced = (0, _utils.assertNodeType)("ExportSpecifier", "ExportDefaultSpecifier", "ExportNamespaceSpecifier");
        const sourceless = (0, _utils.assertNodeType)("ExportSpecifier");
        if (!process.env.BABEL_TYPES_8_BREAKING) return sourced;
        return Object.assign(function  validate(node, key, val) {
...
defineType("MetaProperty", {
  ...
  fields: {
    meta: {
      validate: process.env.BABEL_TYPES_8_BREAKING ? (0, _utils.chain)((0, _utils.assertNodeType)("Identifier"), Object.assign(function  validate(node, key, val) {
        let property;
        switch (val.name) {
          case "function":
            property = "sent";
...
const classMethodOrPropertyCommon = () => ({
  ...
  key: {
    validate: (0, _utils.chain)(function  validate() {
      const normal = (0, _utils.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral", "BigIntLiteral");
      const computed = (0, _utils.assertNodeType)("Expression");
      return function  validate(node, key, val) {
        const validator = node.computed ? computed : normal;
...
defineType("TemplateLiteral", {
  ...
  fields: {
    ...
    expressions: {
      validate: (0, _utils.chain)((0, _utils.assertValueType)("array"), (0, _utils.assertEach)((0, _utils.assertNodeType)("Expression", "TSType")), function  validate(node, key, val) {
...
defineType("YieldExpression", {
  ...
  fields: {
    delegate: {
      validate: process.env.BABEL_TYPES_8_BREAKING ? (0, _utils.chain)((0, _utils.assertValueType)("boolean"), Object.assign(function  validate(node, key, val) {
