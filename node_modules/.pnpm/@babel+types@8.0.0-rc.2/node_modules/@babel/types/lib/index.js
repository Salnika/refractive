...
defineType$4("AssignmentExpression", {
  fields: {
    operator: {
      validate: Object.assign(function  validate() {
...
defineType$4("Identifier", {
  ...
  fields: {
    ...patternLikeCommon(),
    name: {
      validate: chain(assertValueType("string"), Object.assign(function  validate(node, key, val) {
...
defineType$4("NumericLiteral", {
  ...
  fields: {
    value: {
      validate: chain(assertValueType("number"), Object.assign(function  validate(node, key, val) {
...
defineType$4("ObjectProperty", {
  ...
  fields: {
    ...
    shorthand: {
      validate: chain(assertValueType("boolean"), Object.assign(function  validate(node, key, shorthand) {
        if (!shorthand) return;
        if (node.computed) {
...
defineType$4("TryStatement", {
  ...
  fields: {
    block: {
      validate: chain(assertNodeType("BlockStatement"), Object.assign(function  validate(node) {
...
defineType$4("ExportNamedDeclaration", {
  ...
  fields: {
    declaration: {
      optional: true,
      validate: chain(assertNodeType("Declaration"), Object.assign(function  validate(node, key, val) {
    ...
    specifiers: {
      default: [],
      validate: arrayOf(function  validate() {
...
defineType$4("MetaProperty", {
  ...
  fields: {
    meta: {
      validate: chain(assertNodeType("Identifier"), Object.assign(function  validate(node, key, val) {
        let property;
        switch (val.name) {
          case "function":
            property = "sent";
...
const classMethodOrPropertyCommon = () => ({
  ...
  key: {
    validate: chain(function  validate() {
      const normal = assertNodeType("Identifier", "StringLiteral", "NumericLiteral", "BigIntLiteral");
      const computed = assertNodeType("Expression");
      return function  validate(node, key, val) {
        const validator = node.computed ? computed : normal;
...
defineType$4("TemplateLiteral", {
  ...
  fields: {
    ...
    expressions: {
      validate: chain(assertValueType("array"), assertEach(assertNodeType("Expression", "TSType")), function  validate(node, key, val) {
...
defineType$4("YieldExpression", {
  ...
  fields: {
    delegate: {
      validate: chain(assertValueType("boolean"), Object.assign(function  validate(node, key, val) {
...
defineType("TSTemplateLiteralType", {
  ...
  fields: {
    quasis: validateArrayOfType("TemplateElement"),
    types: {
      validate: chain(assertValueType("array"), assertEach(assertNodeType("TSType")), function  validate(node, key, val) {
        if (node.quasis.length !== val.length + 1) {
...
defineType("TSModuleDeclaration", {
  ...
  fields: {
    ...
    declare: validateOptional(bool),
    id: {
      validate: chain(assertNodeType("TSEntityName", "StringLiteral"), Object.assign(function  validate(node, key, val) {
...
function toIdentifier(input) {
  ...
  name = name.replace(/[-\s]+(.)?/g, function  name(match, c) {
...
toKeyAlias.uid = 0;
toKeyAlias.increment = function  increment() {
