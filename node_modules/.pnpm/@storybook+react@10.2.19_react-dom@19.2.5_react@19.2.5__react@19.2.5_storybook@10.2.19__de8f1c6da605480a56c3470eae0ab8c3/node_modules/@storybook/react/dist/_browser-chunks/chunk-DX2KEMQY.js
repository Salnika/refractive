  ...
  "../../../node_modules/escodegen/node_modules/source-map/lib/source-node.js"(exports) {
    ...
    SourceNode.prototype.add = function add(aChunk) {
      if (Array.isArray(aChunk))
        aChunk.forEach(function add(chunk) {
          this.add(chunk);
        }, this);
    ...
    SourceNode.prototype.toString = function toString() {
      var str = "";
      return this.walk(function toString(chunk) {
        str += chunk;
      }), str;
    };
    SourceNode.prototype.toStringWithSourceMap = function toStringWithSourceMap(aArgs) {
      ...
      return this.walk(function toStringWithSourceMap(chunk, original) {
...
` && (result = ["{"])), stmt.body[0].leadingComments || generateBlankLines(stmt.range[0], stmt.body[0].range[0], result)), i > 0 && !stmt.body[i - 1].trailingComments && !stmt.body[i].leadingComments && generateBlankLines(stmt.body[i - 1].range[1], stmt.body[i].range[0], result)), i === iz - 1 && (bodyFlags |= F_SEMICOLON_OPT), stmt.body[i].leadingComments && preserveBlankLines ? fragment = that.generateStatement(stmt.body[i], bodyFlags) : fragment = addIndent(that.generateStatement(stmt.body[i], bodyFlags)), result.push(fragment), endsWithLineTerminator(toSourceNodeWhenNeeded(fragment).toString()) || preserveBlankLines && i < iz - 1 && stmt.body[i + 1].leadingComments || result.push(newline), preserveBlankLines && i === iz - 1 && (stmt.body[i].trailingComments || generateBlankLines(stmt.body[i].range[1], stmt.range[1], result));
        ...
        ClassBody: function ClassBody(stmt, flags) {
          ...
          return withIndent(function ClassBody(indent2) {
            var i, iz;
        ...
        ExportNamedDeclaration: function ExportNamedDeclaration(stmt, flags) {
          ...
          return bodyFlags = flags & F_SEMICOLON_OPT ? S_TFFT : S_TFFF, stmt.declaration ? join(result, this.generateStatement(stmt.declaration, bodyFlags)) : (stmt.specifiers && (stmt.specifiers.length === 0 ? result = join(result, "{" + space + "}") : stmt.specifiers[0].type === Syntax.ExportBatchSpecifier ? result = join(result, this.generateExpression(stmt.specifiers[0], Precedence.Sequence, E_TTT)) : (result = join(result, "{"), withIndent(function ExportNamedDeclaration(indent2) {
            var i, iz;
        ...
        ImportDeclaration: function ImportDeclaration(stmt, flags) {
          ...
          return stmt.specifiers.length === 0 ? [
            ...
            space,
            this.generateExpression(stmt.specifiers[cursor], Precedence.Sequence, E_TTT)
          ]) : (result.push(space + "{"), stmt.specifiers.length - cursor === 1 ? (result.push(space), result.push(this.generateExpression(stmt.specifiers[cursor], Precedence.Sequence, E_TTT)), result.push(space + "}" + space)) : (withIndent(function ImportDeclaration(indent2) {
            var i, iz;
...
` : ""], bodyFlags = S_TFTF, i = 0; i < iz; ++i)
        ...
        ArrayExpression: function ArrayExpression(expr, precedence, flags, isPattern) {
          ...
          return expr.elements.length ? (multiline = isPattern ? !1 : expr.elements.length > 1, result = ["[", multiline ? newline : ""], withIndent(function ArrayExpression(indent2) {
            var i, iz;
        ...
        ObjectExpression: function ObjectExpression(expr, precedence, flags) {
          ...
          }), !multiline && !hasLineTerminator(toSourceNodeWhenNeeded(fragment).toString()) ? ["{", space, fragment, space, "}"] : (withIndent(function ObjectExpression(indent2) {
            var i, iz;
        ...
        ObjectPattern: function ObjectPattern(expr, precedence, flags) {
          ...
          return result = ["{", multiline ? newline : ""], withIndent(function ObjectPattern(indent2) {
            var i2, iz2;
...
var base = {};
base.Program = base.BlockStatement = function BlockStatement(node, st, c) {
...
base.MethodDefinition = base.Property = function Property(node, st, c) {
