(function (global, factory) {
	...
	(function (module) {
	  ...
	  const wrapAnsi256 = function  wrapAnsi256(offset) {
	    if (offset === void 0) {
	      offset = 0;
	    }
	    return code => "\x1B[" + (38 + offset) + ";5;" + code + "m";
	  };
	  const wrapAnsi16m = function  wrapAnsi16m(offset) {
	    if (offset === void 0) {
	      offset = 0;
	    }
	...
	function _typeof$2(obj) {
	  ...
	  return _typeof$2 = "function" === typeof Symbol && "symbol" === typeof Symbol.iterator ? function  _typeof$2(obj) {
	    return typeof obj;
	  } : function  _typeof$2(obj) {
	...
	var SetLike = /*#__PURE__*/function () {
	  ...
	  _createClass(SetLike, [{
	    ...
	    value: function _delete(value) {
	      ...
	      this.items = this.items.filter(function  items(item) {
	        return item !== value;
	      });
	...
	function _typeof$1(obj) {
	  ...
	  return _typeof$1 = "function" === typeof Symbol && "symbol" === typeof Symbol.iterator ? function  _typeof$1(obj) {
	    return typeof obj;
	  } : function  _typeof$1(obj) {
	    return obj && "function" === typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
	  }, _typeof$1(obj);
	...
	function computeAccessibleDescription(root) {
	  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	  var description = queryIdRefs(root, "aria-describedby").map(function  description(element) {
	...
	var ariaPropsMap = {
	  ...
	  get: function get(key) {
	    var item = properties.find(function  item(tuple) {
	...
	var domMap = {
	  ...
	  get: function get(key) {
	    var item = dom$1.find(function  item(tuple) {
	      return tuple[0] === key ? true : false;
	    });
	    return item && item[1];
	  },
	  ...
	  keys: function keys() {
	    return dom$1.map(function  keys(_ref) {
	    ...
	    for (_iterator.s(); !(_step = _iterator.n()).done;) {
	      ...
	      try {
	        var _loop = function _loop() {
	          ...
	          var superClassRoleTuple = roles$1.find(function  superClassRoleTuple(_ref3) {
	...
	var rolesMap = {
	  ...
	  get: function get(key) {
	    var item = roles$1.find(function  item(tuple) {
	      return tuple[0] === key ? true : false;
	    });
	    return item && item[1];
	  },
	  ...
	  keys: function keys() {
	    return roles$1.map(function  keys(_ref5) {
	    ...
	    for (var k$1 = 0; k$1 < concepts$1.length; k$1++) {
	      ...
	      if (relation$1.module === 'HTML') {
	        (function () {
	          ...
	          if (concept) {
	            var elementRoleRelation = elementRoles$1.find(function  elementRoleRelation(relation) {
	...
	var elementRoleMap = {
	  ...
	  get: function get(key) {
	    var item = elementRoles$1.find(function  item(tuple) {
	  ...
	  keys: function keys() {
	    return elementRoles$1.map(function  keys(_ref) {
	...
	var roleElementMap = {
	  ...
	  get: function get(key) {
	    var item = roleElement.find(function  item(tuple) {
	      return tuple[0] === key ? true : false;
	    });
	    return item && item[1];
	  },
	...
	const logRoles = function  logRoles(dom, _temp2) {
	  let {
	    hidden = false
	...
	*/
	...
	const wrapSingleQueryWithSuggestion = (query, queryAllByName, variant) => function  wrapSingleQueryWithSuggestion(container) {
	...
	const wrapAllByQueryWithSuggestion = (query, queryAllByName, variant) => function  wrapAllByQueryWithSuggestion(container) {
	...
	const queryAllLabelsByText = function  queryAllLabelsByText(container, text, _temp) {
	  let {
	    exact = true,
	    trim,
	    collapseWhitespace,
	...
	const queryAllByLabelText = function  queryAllByLabelText(container, text, _temp2) {
	  let {
	    selector = '*',
	    exact = true,
	    collapseWhitespace,
	...
	const getAllByLabelText = function  getAllByLabelText(container, text) {
	...
	const queryAllByPlaceholderText = function  queryAllByPlaceholderText() {
	...
	const queryAllByText = function  queryAllByText(container, text, _temp) {
	  let {
	    selector = '*',
	    exact = true,
	    collapseWhitespace,
	...
	const getMissingError$5 = function  getMissingError$5(c, text, options) {
	  if (options === void 0) {
	    options = {};
	  }
	  const {
	...
	const queryAllByDisplayValue = function  queryAllByDisplayValue(container, value, _temp) {
	  let {
	    exact = true,
	    collapseWhitespace,
	    trim,
	...
	const queryAllByAltText = function  queryAllByAltText(container, alt, options) {
	  if (options === void 0) {
	    options = {};
	  }
	  checkContainerType(container);
	...
	const queryAllByTitle = function  queryAllByTitle(container, text, _temp) {
	  let {
	    exact = true,
	    collapseWhitespace,
	    trim,
	...
	const queryAllByRole = function  queryAllByRole(container, role, _temp) {
	  let {
	...
	const getMultipleError$1 = function  getMultipleError$1(c, role, _temp2) {
	  let {
	    name
	  } = _temp2 === void 0 ? {} : _temp2;
	  return "Found multiple elements with the role \"" + role + "\"" + getNameHint(name);
	};
	const getMissingError$1 = function  getMissingError$1(container, role, _temp3) {
	  let {
	    hidden = getConfig().defaultHidden,
	    name,
	    description
	...
	const queryAllByTestId = function  queryAllByTestId() {
	  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
	    args[_key] = arguments[_key];
	  }
	  checkContainerType(args[0]);
	...
	*/
	  ...
	  var LZString = function () {
	    ...
	    var LZString = {
	      compressToBase64: function  compressToBase64(input) {
	        ...
	        var res = LZString._compress(input, 6, function  res(a) {
	      ...
	      decompressFromBase64: function  decompressFromBase64(input) {
	        ...
	        return LZString._decompress(input.length, 32, function  decompressFromBase64(index) {
	          return getBaseValue(keyStrBase64, input.charAt(index));
	        });
	      },
	      compressToUTF16: function  compressToUTF16(input) {
	        if (input == null) return "";
	        return LZString._compress(input, 15, function  compressToUTF16(a) {
	          return f(a + 32);
	        }) + " ";
	      },
	      decompressFromUTF16: function  decompressFromUTF16(compressed) {
	        ...
	        return LZString._decompress(compressed.length, 16384, function  decompressFromUTF16(index) {
	      ...
	      decompressFromUint8Array: function  decompressFromUint8Array(compressed) {
	        if (compressed === null || compressed === undefined) {
	          ...
	          var result = [];
	          buf.forEach(function  decompressFromUint8Array(c) {
	            result.push(f(c));
	          });
	      ...
	      compressToEncodedURIComponent: function  compressToEncodedURIComponent(input) {
	        if (input == null) return "";
	        return LZString._compress(input, 6, function  compressToEncodedURIComponent(a) {
	      ...
	      decompressFromEncodedURIComponent: function  decompressFromEncodedURIComponent(input) {
	        ...
	        return LZString._decompress(input.length, 32, function  decompressFromEncodedURIComponent(index) {
	          return getBaseValue(keyStrUriSafe, input.charAt(index));
	        });
	      },
	      compress: function  compress(uncompressed) {
	        return LZString._compress(uncompressed, 16, function  compress(a) {
	          return f(a);
	        });
	      },
	      ...
	      decompress: function  decompress(compressed) {
	        if (compressed == null) return "";
	        if (compressed == "") return null;
	        return LZString._decompress(compressed.length, 32768, function  decompress(index) {
	...
	const logTestingPlaygroundURL = function  logTestingPlaygroundURL(element) {
	  if (element === void 0) {
