...
export function injectIntoGlobalHook(globalObject) {
  ...
  hook.inject = function  inject(injected) {
  ...
  hook.onScheduleFiberRoot = function  onScheduleFiberRoot(id, root, children) {
    if (!isPerformingRefresh) {
  ...
  hook.onCommitFiberRoot = function  onCommitFiberRoot(id, root, maybePriorityLevel, didError) {
