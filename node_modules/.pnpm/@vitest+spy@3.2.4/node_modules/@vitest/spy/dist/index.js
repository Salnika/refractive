...
function enhanceSpy(spy) {
	...
	stub.mockReturnThis = () => stub.mockImplementation(function mockReturnThis() {
		return this;
	});
...
function fn(implementation) {
	const enhancedSpy = enhanceSpy(tinyspy.internalSpyOn({ spy: implementation || function spy() {} }, "spy"));
	if (implementation) {
