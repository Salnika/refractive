...
function requireReactIs_production_min() {
  ...
  reactIs_production_min.isAsyncMode = function isAsyncMode() {
    return false;
  };
  reactIs_production_min.isConcurrentMode = function isConcurrentMode() {
    return false;
  };
  reactIs_production_min.isContextConsumer = function isContextConsumer(a) {
    return v(a) === h;
  };
  reactIs_production_min.isContextProvider = function isContextProvider(a) {
    return v(a) === g;
  };
  reactIs_production_min.isElement = function isElement(a) {
    return "object" === typeof a && null !== a && a.$$typeof === b2;
  };
  reactIs_production_min.isForwardRef = function isForwardRef(a) {
    return v(a) === l;
  };
  reactIs_production_min.isFragment = function isFragment(a) {
    return v(a) === d2;
  };
  reactIs_production_min.isLazy = function isLazy(a) {
    return v(a) === q;
  };
  reactIs_production_min.isMemo = function isMemo(a) {
    return v(a) === p;
  };
  reactIs_production_min.isPortal = function isPortal(a) {
    return v(a) === c;
  };
  reactIs_production_min.isProfiler = function isProfiler(a) {
    return v(a) === f;
  };
  reactIs_production_min.isStrictMode = function isStrictMode(a) {
    return v(a) === e;
  };
  reactIs_production_min.isSuspense = function isSuspense(a) {
    return v(a) === m;
  };
  reactIs_production_min.isSuspenseList = function isSuspenseList(a) {
    return v(a) === n;
  };
  reactIs_production_min.isValidElementType = function isValidElementType(a) {
...
const resolve$1 = function resolve$1(...arguments_) {
...
const isAbsolute$1 = function isAbsolute$1(p) {
...
const resolve = function resolve(...arguments_) {
...
const isAbsolute = function isAbsolute(p) {
...
function createChainable(keys, fn, context) {
  function create(context2) {
    const chain2 = function chain2(...args) {
...
function createSuiteCollector(name, factory = () => {
  ...
  let suite2;
  initSuite();
  const task = function task(name2 = "", options = {}) {
    var _a, _b, _c, _d, _e;
  ...
  const test2 = createTest(function test2(name2, optionsOrFn, timeoutOrTest) {
...
function createSuite() {
  ...
  suiteFn.each = function each(cases, ...args) {
    const context = getChainableContext(this);
...
function createTaskCollector(fn) {
  const taskFn = fn;
  taskFn.each = function each(cases, ...args) {
    const context = getChainableContext(this);
  ...
  taskFn.skipIf = function skipIf(condition) {
    return condition ? this.skip : this;
  };
  taskFn.runIf = function runIf(condition) {
  ...
  taskFn.override = function override(fixturesOrName, optionsOrFn, maybeFn) {
  ...
  taskFn.scoped = function scoped(fixtures) {
  ...
  taskFn.extend = function extend(fixturesOrName, optionsOrFn, maybeFn) {
    const userFixtures = parseBuilderFixtures(fixturesOrName, optionsOrFn, maybeFn);
    const fixtures = getChainableContext(this).getFixtures().extend(runner, userFixtures);
    const _test2 = createTest(function _test2(name, optionsOrFn2, optionsOrTest) {
