...
const ChaiStyleAssertions = (chai, utils) => {
  function defProperty(name, delegateTo) {
    utils.addProperty(chai.Assertion.prototype, name, function ChaiStyleAssertions() {
  ...
  function defMethod(name, delegateTo) {
    utils.addMethod(chai.Assertion.prototype, name, function ChaiStyleAssertions(...args) {
      const jestMethod = chai.Assertion.prototype[delegateTo];
      if (!jestMethod) {
        throw new Error(`Cannot delegate to ${String(delegateTo)}: method not found. Ensure JestChaiExpect plugin is loaded first.`);
      }
...
const JestChaiExpect = (chai, utils) => {
  ...
  [
    ...
    utils.overwriteMethod(chai.Assertion.prototype, m, (_super) => {
      return function JestChaiExpect(...args) {
  ...
  def("withTest", function JestChaiExpect(test) {
  ...
  def("toBeNullable", function JestChaiExpect() {
    const obj = utils.flag(this, "object");
  ...
  def("toHaveBeenNthCalledWith", function JestChaiExpect(times, ...args) {
    const spy = getSpy(this);
    const spyName = spy.getMockName();
  ...
  def("toHaveBeenLastCalledWith", function JestChaiExpect(...args) {
    const spy = getSpy(this);
    const spyName = spy.getMockName();
  ...
  */
  ...
  def(["toHaveBeenCalledBefore"], function JestChaiExpect(resultSpy, failIfNoFirstInvocation = true) {
  ...
  def(["toHaveBeenCalledAfter"], function JestChaiExpect(resultSpy, failIfNoFirstInvocation = true) {
    const expectSpy = getSpy(this);
    if (!isMockFunction(resultSpy)) {
      throw new TypeError(`${utils.inspect(resultSpy)} is not a spy or a call to a spy`);
    }
