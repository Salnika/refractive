...
function createMockInstance(options = {}) {
  ...
  mock.mockReturnThis = function mockReturnThis() {
    return mock.mockImplementation(function mockReturnThis() {
      return this;
    });
  };
  mock.mockReturnValue = function mockReturnValue(value) {
    return mock.mockImplementation(function mockReturnValue() {
      if (new.target) {
  ...
  mock.mockReturnValueOnce = function mockReturnValueOnce(value) {
    return mock.mockImplementationOnce(function mockReturnValueOnce() {
      if (new.target) {
  ...
  mock.mockThrow = function mockThrow(value) {
    ...
    return mock.mockImplementation(function mockThrow() {
      throw value;
    });
  };
  mock.mockThrowOnce = function mockThrowOnce(value) {
    // eslint-disable-next-line prefer-arrow-callback
    return mock.mockImplementationOnce(function mockThrowOnce() {
      throw value;
    });
  };
  mock.mockResolvedValue = function mockResolvedValue(value) {
    return mock.mockImplementation(function mockResolvedValue() {
      if (new.target) {
  ...
  mock.mockResolvedValueOnce = function mockResolvedValueOnce(value) {
    return mock.mockImplementationOnce(function mockResolvedValueOnce() {
      if (new.target) {
  ...
  mock.mockRejectedValue = function mockRejectedValue(value) {
    return mock.mockImplementation(function mockRejectedValue() {
      if (new.target) {
  ...
  mock.mockRejectedValueOnce = function mockRejectedValueOnce(value) {
    return mock.mockImplementationOnce(function mockRejectedValueOnce() {
      if (new.target) {
...
function createMock({ state, config, name: mockName, prototypeState, prototypeConfig, keepMembersImplementation, mockImplementation, prototypeMembers = [] }) {
  ...
  const namedObject = { [name]: (function(...args) {
    ...
    const implementation = config.onceMockImplementations.shift() || config.mockImplementation || prototypeConfig?.onceMockImplementations.shift() || prototypeConfig?.mockImplementation || original || function implementation() {};
    let returnValue;
    let thrownValue;
    let didThrow = false;
    try {
