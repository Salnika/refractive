...
var hasOwn = Object.hasOwn || (function  hasOwn(obj, propName) { return (
  hasOwnProperty.call(obj, propName)
); });

var isArray = Array.isArray || (function  isArray(obj) { return (
...
prototypeAccessors.inGenerator.get = function  get() { return (this.currentVarScope().flags & SCOPE_GENERATOR) > 0 && !this.currentVarScope().inClassFieldInit };

prototypeAccessors.inAsync.get = function  get() { return (this.currentVarScope().flags & SCOPE_ASYNC) > 0 && !this.currentVarScope().inClassFieldInit };
...
pp$8.parseStatement = function parseStatement(context, topLevel, exports$1) {
...
pp$8.parseExportAllDeclaration = function parseExportAllDeclaration(node, exports$1) {
...
pp$8.parseExport = function parseExport(node, exports$1) {
  this.next();
  // export * from '...'
...
pp$8.checkExport = function checkExport(exports$1, name, pos) {
  if (!exports$1) { return }
...
pp$8.checkPatternExport = function checkPatternExport(exports$1, pat) {
  var type = pat.type;
  if (type === "Identifier")
...
pp$8.checkVariableExport = function checkVariableExport(exports$1, decls) {
  if (!exports$1) { return }
...
pp$8.parseExportSpecifier = function parseExportSpecifier(exports$1) {
  var node = this.startNode();
...
pp$8.parseExportSpecifiers = function parseExportSpecifiers(exports$1) {
...
var types = {
  ...
  q_tmpl: new TokContext("`", true, true, function  q_tmpl(p) { return p.tryReadTemplateToken(); }),
