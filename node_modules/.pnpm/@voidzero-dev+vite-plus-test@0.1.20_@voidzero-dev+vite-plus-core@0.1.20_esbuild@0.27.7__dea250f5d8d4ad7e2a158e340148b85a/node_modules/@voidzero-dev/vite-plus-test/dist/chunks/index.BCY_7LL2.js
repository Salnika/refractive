...
const getPackageInfo = quansync(function*  getPackageInfo(name, options = {}) {
...
const loadPackageJSON = quansync(function*  loadPackageJSON(cwd = process$1.cwd()) {
...
const isPackageListed = quansync(function*  isPackageListed(name, cwd) {
