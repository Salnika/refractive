...
function requireClear$1 () {
  ...
  clear$1 = function  clear$1(prompt, perLine) {
...
function requireLines$1 () {
  ...
  lines$1 = function  lines$1(msg, perLine) {
...
function requireDist () {
  ...
  function _prompt() {
    _prompt = _asyncToGenerator(function*  _prompt(questions = [], {
      onSubmit = noop,
      onCancel = noop
    } = {}) {
      const answers = {};
      ...
      const getFormattedAnswer = /*#__PURE__*/function  getFormattedAnswer() {
        var _ref = _asyncToGenerator(function*  _ref(question, answer, skipValidation = false) {
...
function requireClear () {
   ...
   * @param {number} perLine
   */
  clear = function clear(prompt, perLine) {
    if (!perLine) return erase.line + cursor.to(0);
