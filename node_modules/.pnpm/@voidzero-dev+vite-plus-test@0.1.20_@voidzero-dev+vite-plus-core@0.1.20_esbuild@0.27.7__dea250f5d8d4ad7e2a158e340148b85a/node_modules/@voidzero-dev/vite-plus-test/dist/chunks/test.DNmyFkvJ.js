...
import { getNames, getTests, getTestName, createChainable, matchesTags } from '../@vitest/runner/utils.js';
...
import { addSerializer, stripSnapshotIndentation, SnapshotClient } from '../@vitest/snapshot/index.js';
...
function requireCopyPrototypeMethods () {
  ...
  copyPrototypeMethods = function copyPrototypeMethods(prototype) {
      ...
      return Object.getOwnPropertyNames(prototype).reduce(function  copyPrototypeMethods(
          result,
          name
      ) {
...
function requireDeprecated () {
  ...
  (function (exports$1) {
     ...
     * @returns {Function}
     */
    exports$1.wrap = function  wrap(func, msg) {
     ...
     * @returns {string}
     */
    exports$1.defaultMsg = function  defaultMsg(packageName, funcName) {
     ...
     * @returns {undefined}
     */
    exports$1.printWarning = function  printWarning(msg) {
        /* istanbul ignore next */
...
function requireFakeTimersSrc () {
  ...
  function withGlobal(_global) {
      ...
      const NOOP_ARRAY = function  NOOP_ARRAY() {
          return [];
      };
      const isPresent = {};
      let timeoutResult,
      ...
      function createIntl() {
          ...
          ClockIntl.DateTimeFormat = function  DateTimeFormat(...args) {
      ...
      function createClock(start, loopLimit) {
           ...
           */
          clock.setTickMode = function  setTickMode(tickModeConfig) {
          ...
          if (typeof _global.Promise !== "undefined") {
              ...
              clock.tickAsync = function tickAsync(tickValue) {
                  return pauseAutoTickUntilFinished(
                      new _global.Promise(function  tickAsync(resolve, reject) {
                          originalSetTimeout(function  tickAsync() {
                              try {
          ...
          if (typeof _global.Promise !== "undefined") {
              clock.nextAsync = function nextAsync() {
                  return pauseAutoTickUntilFinished(
                      new _global.Promise(function  nextAsync(resolve, reject) {
                          originalSetTimeout(function  nextAsync() {
                              try {
                                  const timer = firstTimer(clock);
                                  if (!timer) {
                                      resolve(clock.now);
          ...
          if (typeof _global.Promise !== "undefined") {
              clock.runAllAsync = function runAllAsync() {
                  return pauseAutoTickUntilFinished(
                      new _global.Promise(function  runAllAsync(resolve, reject) {
                          let i = 0;
                          /**
                           *
                           */
                          function doRun() {
                              originalSetTimeout(function  runAllAsync() {
                                  try {
                                      runJobs(clock);
          ...
          if (typeof _global.Promise !== "undefined") {
              clock.runToLastAsync = function runToLastAsync() {
                  return pauseAutoTickUntilFinished(
                      new _global.Promise(function  runToLastAsync(resolve, reject) {
                          originalSetTimeout(function  runToLastAsync() {
                              try {
                                  const timer = lastTimer(clock);
                                  if (!timer) {
                                      runJobs(clock);
...
const SnapshotPlugin = (chai, utils) => {
  for (const key of ["matchSnapshot", "toMatchSnapshot"]) utils.addMethod(chai.Assertion.prototype, key, wrapAssertion(utils, key, function SnapshotPlugin(propertiesOrHint, hint) {
  ...
  utils.addMethod(chai.Assertion.prototype, "toMatchFileSnapshot", function SnapshotPlugin(filepath, hint) {
  ...
  utils.addMethod(chai.Assertion.prototype, "toThrowErrorMatchingSnapshot", wrapAssertion(utils, "toThrowErrorMatchingSnapshot", function SnapshotPlugin(propertiesOrHint, hint) {
    validateAssertion(this);
