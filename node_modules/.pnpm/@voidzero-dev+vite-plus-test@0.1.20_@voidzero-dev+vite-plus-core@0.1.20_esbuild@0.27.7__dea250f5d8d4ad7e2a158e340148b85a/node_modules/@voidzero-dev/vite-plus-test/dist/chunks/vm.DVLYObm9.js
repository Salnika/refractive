...
import { toArray, splitFileAndPostfix, isBareImport } from '../@vitest/utils/helpers.js';
...
class CommonjsExecutor {
  ...
  getCjsSyntheticModule(path, identifier) {
    ...
    const module = new SyntheticModule([...keys, "default"], function module() {
...
class EsmExecutor {
  ...
  async loadEsModule(fileURL, getCode) {
    ...
    if (fileURL.endsWith(".json")) {
      const m = new SyntheticModule(["default"], function m() {
  ...
  async createDataModule(identifier) {
    ...
    if (mime === "application/json") {
      const module = new SyntheticModule(["default"], function module() {
...
class ViteExecutor {
  ...
  createViteClientModule() {
    ...
    const module = new SyntheticModule(moduleKeys, function module() {
