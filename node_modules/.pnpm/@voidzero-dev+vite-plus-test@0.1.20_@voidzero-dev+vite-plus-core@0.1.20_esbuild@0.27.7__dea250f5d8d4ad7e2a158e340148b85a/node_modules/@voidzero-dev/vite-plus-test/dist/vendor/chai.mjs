...
function expectTypes(obj, types) {
	...
	obj = flag(obj, "object");
	types = types.map(function types(t) {
...
function getMessage2(obj, args) {
	...
	msg = msg || "";
	msg = msg.replace(/#\{this\}/g, function msg() {
...
function addProperty(ctx, name, getter) {
	getter = getter === void 0 ? function getter() {} : getter;
...
var fnLengthDesc = Object.getOwnPropertyDescriptor(function fnLengthDesc() {}, "length");
function addLengthGuard(fn, assertionName, isChainable) {
	if (!fnLengthDesc.configurable) return fn;
	Object.defineProperty(fn, "length", { get: /* @__PURE__ */ __name(function get() {
...
function proxify(obj, nonChainableMethodName) {
	...
	return new Proxy(obj, { get: /* @__PURE__ */ __name(function proxyGetter(target, property) {
		if (typeof property === "string" && config.proxyExcludedKeys.indexOf(property) === -1 && !Reflect.has(target, property)) {
			...
			getProperties(target).forEach(function get(prop) {
...
function overwriteProperty(ctx, name, getter) {
	let _get = Object.getOwnPropertyDescriptor(ctx, name), _super = /* @__PURE__ */ __name(function _super() {}, "_super");
...
function overwriteMethod(ctx, name, method) {
	let _method = ctx[name], _super = /* @__PURE__ */ __name(function _super() {
...
var testFn = /* @__PURE__ */ __name(function testFn() {}, "testFn");
var excludeNames = Object.getOwnPropertyNames(testFn).filter(function excludeNames(name) {
...
function addChainableMethod(ctx, name, method, chainingBehavior) {
	if (typeof chainingBehavior !== "function") chainingBehavior = /* @__PURE__ */ __name(function chainingBehavior() {}, "chainingBehavior");
	...
	Object.defineProperty(ctx, name, {
		get: /* @__PURE__ */ __name(function chainableMethodGetter() {
			...
			} else Object.getOwnPropertyNames(ctx).forEach(function get(asserterName) {
...
function include(val, msg) {
	...
	switch (objType) {
		...
		case "set":
			...
			break;
		case "array":
			if (isDeep) included = obj.some(function included(item) {
...
function assertKeys(keys) {
	...
	if (objType === "Map" || objType === "Set") {
		...
		keys = keys.map(function keys(val) {
	...
	if (!any && !all) all = true;
	if (any) ok = expected.some(function ok(expectedKey) {
		return actual.some(function ok(actualKey) {
			return isEql(expectedKey, actualKey);
		});
	});
	if (all) {
		ok = expected.every(function ok(expectedKey) {
			return actual.some(function ok(actualKey) {
				return isEql(expectedKey, actualKey);
			});
		});
	...
	if (len > 1) {
		keys = keys.map(function keys(key) {
			return inspect2(key);
		});
		let last = keys.pop();
...
function loadShould() {
	...
	let should2 = {};
	should2.fail = function fail(actual, expected, message, operator) {
		if (arguments.length < 2) {
			message = actual;
			actual = void 0;
		}
	...
	should2.Throw = function Throw(fn, errt, errs, msg) {
	...
	should2.not = {};
	should2.not.equal = function equal(actual, expected, msg) {
		new Assertion(actual, msg).to.not.equal(expected);
	};
	should2.not.Throw = function Throw(fn, errt, errs, msg) {
...
assert.typeOf = function typeOf(val, type3, msg) {
	new Assertion(val, msg, assert.typeOf, true).to.be.a(type3);
};
assert.notTypeOf = function notTypeOf(value, type3, message) {
	new Assertion(value, message, assert.notTypeOf, true).to.not.be.a(type3);
};
assert.instanceOf = function instanceOf(val, type3, msg) {
	new Assertion(val, msg, assert.instanceOf, true).to.be.instanceOf(type3);
};
assert.notInstanceOf = function notInstanceOf(val, type3, msg) {
...
assert.hasAnyKeys = function hasAnyKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.hasAnyKeys, true).to.have.any.keys(keys);
};
assert.hasAllKeys = function hasAllKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.hasAllKeys, true).to.have.all.keys(keys);
};
assert.containsAllKeys = function containsAllKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.containsAllKeys, true).to.contain.all.keys(keys);
};
assert.doesNotHaveAnyKeys = function doesNotHaveAnyKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.doesNotHaveAnyKeys, true).to.not.have.any.keys(keys);
};
assert.doesNotHaveAllKeys = function doesNotHaveAllKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.doesNotHaveAllKeys, true).to.not.have.all.keys(keys);
};
assert.hasAnyDeepKeys = function hasAnyDeepKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.hasAnyDeepKeys, true).to.have.any.deep.keys(keys);
};
assert.hasAllDeepKeys = function hasAllDeepKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.hasAllDeepKeys, true).to.have.all.deep.keys(keys);
};
assert.containsAllDeepKeys = function containsAllDeepKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.containsAllDeepKeys, true).to.contain.all.deep.keys(keys);
};
assert.doesNotHaveAnyDeepKeys = function doesNotHaveAnyDeepKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.doesNotHaveAnyDeepKeys, true).to.not.have.any.deep.keys(keys);
};
assert.doesNotHaveAllDeepKeys = function doesNotHaveAllDeepKeys(obj, keys, msg) {
	new Assertion(obj, msg, assert.doesNotHaveAllDeepKeys, true).to.not.have.all.deep.keys(keys);
};
assert.throws = function throws(fn, errorLike, errMsgMatcher, msg) {
...
assert.doesNotThrow = function doesNotThrow(fn, errorLike, errMsgMatcher, message) {
	if ("string" === typeof errorLike || errorLike instanceof RegExp) {
		errMsgMatcher = errorLike;
		errorLike = null;
	}
...
assert.changes = function changes(fn, obj, prop, msg) {
...
assert.changesBy = function changesBy(fn, obj, prop, delta, msg) {
...
assert.doesNotChange = function doesNotChange(fn, obj, prop, msg) {
	if (arguments.length === 3 && typeof obj === "function") {
		msg = prop;
		prop = null;
	}
...
assert.changesButNotBy = function changesButNotBy(fn, obj, prop, delta, msg) {
	if (arguments.length === 4 && typeof obj === "function") {
		let tmpMsg = delta;
		delta = prop;
		msg = tmpMsg;
...
assert.increases = function increases(fn, obj, prop, msg) {
	if (arguments.length === 3 && typeof obj === "function") {
		msg = prop;
		prop = null;
	}
...
assert.increasesBy = function increasesBy(fn, obj, prop, delta, msg) {
	if (arguments.length === 4 && typeof obj === "function") {
		let tmpMsg = delta;
		delta = prop;
		msg = tmpMsg;
...
assert.doesNotIncrease = function doesNotIncrease(fn, obj, prop, msg) {
	if (arguments.length === 3 && typeof obj === "function") {
		msg = prop;
		prop = null;
	}
...
assert.increasesButNotBy = function increasesButNotBy(fn, obj, prop, delta, msg) {
	if (arguments.length === 4 && typeof obj === "function") {
		let tmpMsg = delta;
		delta = prop;
		msg = tmpMsg;
...
assert.decreases = function decreases(fn, obj, prop, msg) {
	if (arguments.length === 3 && typeof obj === "function") {
		msg = prop;
		prop = null;
	}
...
assert.decreasesBy = function decreasesBy(fn, obj, prop, delta, msg) {
	if (arguments.length === 4 && typeof obj === "function") {
		let tmpMsg = delta;
		delta = prop;
		msg = tmpMsg;
...
assert.doesNotDecrease = function doesNotDecrease(fn, obj, prop, msg) {
	if (arguments.length === 3 && typeof obj === "function") {
		msg = prop;
		prop = null;
	}
...
assert.doesNotDecreaseBy = function doesNotDecreaseBy(fn, obj, prop, delta, msg) {
	if (arguments.length === 4 && typeof obj === "function") {
		let tmpMsg = delta;
		delta = prop;
		msg = tmpMsg;
...
assert.decreasesButNotBy = function decreasesButNotBy(fn, obj, prop, delta, msg) {
	if (arguments.length === 4 && typeof obj === "function") {
		let tmpMsg = delta;
		delta = prop;
		msg = tmpMsg;
