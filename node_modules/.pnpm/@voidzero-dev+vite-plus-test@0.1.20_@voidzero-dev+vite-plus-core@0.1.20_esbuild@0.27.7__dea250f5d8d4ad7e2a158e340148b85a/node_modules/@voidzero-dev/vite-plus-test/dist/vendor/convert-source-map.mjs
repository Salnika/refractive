import { t as __commonJSMin } from "./shared-tWUjj5ux.mjs";
...
var require_convert_source_map = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Converter.prototype.toJSON = function toJSON(space) {
	...
	Converter.prototype.toURI = function toURI() {
		var json = this.toJSON();
		return encodeURIComponent(json);
	};
	Converter.prototype.toComment = function toComment(options) {
	...
	Converter.prototype.toObject = function toObject() {
		return JSON.parse(this.toJSON());
	};
	Converter.prototype.addProperty = function addProperty(key, value) {
		if (this.sourcemap.hasOwnProperty(key)) throw new Error("property \"" + key + "\" already exists on the sourcemap, use set property instead");
		return this.setProperty(key, value);
	};
	Converter.prototype.setProperty = function setProperty(key, value) {
		this.sourcemap[key] = value;
		return this;
	};
	Converter.prototype.getProperty = function getProperty(key) {
		return this.sourcemap[key];
	};
	exports.fromObject = function fromObject(obj) {
		return new Converter(obj);
	};
	exports.fromJSON = function fromJSON(json) {
		return new Converter(json, { isJSON: true });
	};
	exports.fromURI = function fromURI(uri) {
		return new Converter(uri, { encoding: "uri" });
	};
	exports.fromBase64 = function fromBase64(base64) {
		return new Converter(base64, { encoding: "base64" });
	};
	exports.fromComment = function fromComment(comment) {
		var m, encoding;
	...
	exports.fromMapFileComment = function fromMapFileComment(comment, read) {
	...
	exports.fromSource = function fromSource(content) {
		var m = content.match(exports.commentRegex);
		return m ? exports.fromComment(m.pop()) : null;
	};
	exports.fromMapFileSource = function fromMapFileSource(content, read) {
	...
	exports.removeComments = function removeComments(src) {
		return src.replace(exports.commentRegex, "");
	};
	exports.removeMapFileComments = function removeMapFileComments(src) {
		return src.replace(exports.mapFileCommentRegex, "");
	};
	exports.generateMapFileComment = function generateMapFileComment(file, options) {
