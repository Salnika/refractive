  ...
  if (role) {
    ...
    var _loop = function _loop() {
      ...
      if (relation.module === 'HTML') {
        ...
        if (concept) {
          var elementRoleRelation = elementRoles.filter(function  elementRoleRelation(relation) {
...
var elementRoleMap = {
  ...
  get: function get(key) {
    var item = elementRoles.filter(function  item(tuple) {
  ...
  keys: function keys() {
    return elementRoles.map(function  keys(_ref) {
