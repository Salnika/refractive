...
function scopePlugin(fork) {
    ...
    Sp.didScan = false;
    Sp.declares = function  declares(name) {
        this.scan();
        return hasOwn.call(this.bindings, name);
    };
    Sp.declaresType = function  declaresType(name) {
        this.scan();
        return hasOwn.call(this.types, name);
    };
    Sp.declareTemporary = function  declareTemporary(prefix) {
        if (prefix) {
    ...
    Sp.injectTemporary = function  injectTemporary(identifier, init) {
    ...
    Sp.getBindings = function  getBindings() {
        this.scan();
        return this.bindings;
    };
    Sp.getTypes = function  getTypes() {
        this.scan();
        return this.types;
    };
    ...
    Sp.lookup = function  lookup(name) {
        for (var scope = this; scope; scope = scope.parent)
            if (scope.declares(name))
                break;
        return scope;
    };
    Sp.lookupType = function  lookupType(name) {
        for (var scope = this; scope; scope = scope.parent)
            if (scope.declaresType(name))
                break;
        return scope;
    };
    Sp.getGlobalScope = function  getGlobalScope() {
        var scope = this;
