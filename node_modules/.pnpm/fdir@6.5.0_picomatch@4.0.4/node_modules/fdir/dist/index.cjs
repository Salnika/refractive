...
const resolveSymlinksAsync = function resolveSymlinksAsync(path$1, state, callback$1) {
...
const resolveSymlinks = function resolveSymlinks(path$1, state, callback$1) {
	const { queue, fs: fs$1, options: { suppressErrors } } = state;
	queue.enqueue();
	try {
