...
var LZString = {
  ...
  writeBit : function writeBit(value, data) {
  ...
  writeBits : function writeBits(numBits, value, data) {
  ...
  produceW : function  produceW(context) {
  ...
  decrementEnlargeIn : function decrementEnlargeIn(context) {
    context.enlargeIn--;
  ...
  readBits : function readBits(numBits, data) {
    var res = 0;
