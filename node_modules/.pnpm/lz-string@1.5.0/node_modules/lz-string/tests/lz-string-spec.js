var compressionTests = function compressionTests(compress, decompress, uint8array_mode) {
    it('compresses and decompresses  "Hello world!"', function compressionTests() {
    ...
    it('compresses and decompresses null', function compressionTests() {
    ...
    it('compresses and decompresses undefined', function compressionTests() {
    ...
    it('decompresses null', function compressionTests() {
        var decompressed = decompress(null);
        expect(decompressed).toBe('');
    });

    it('compresses and decompresses an empty string', function compressionTests() {
        var compressed = compress('');
        if (uint8array_mode===false){
...
var testEncBinCompat = function testEncBinCompat(comp, expectedDec, expectedComp) {
  var compressed = comp(expectedDec);
  expect(compressed).toEqual(expectedComp);
};

var testDecBinCompat = function testDecBinCompat(dec, expectedDec, expectedComp) {
