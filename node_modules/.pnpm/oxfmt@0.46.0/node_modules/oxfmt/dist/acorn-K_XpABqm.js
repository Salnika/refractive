...
var $e = ot((yr, Ye) => {
	...
	function $t(e) {
		...
		if (!t) {
			...
			l.jsxTagStart.updateContext = function updateContext() {
				this.context.push(p), this.context.push(o), this.exprAllowed = !1;
			}, l.jsxTagEnd.updateContext = function updateContext(m) {
	...
	Ye.exports = function exports(e) {
		return e = e || {}, function exports(t) {
			return Es({
...
var yt = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, k = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, gt = Object.prototype, Ji = gt.hasOwnProperty, Ki = gt.toString, $ = Object.hasOwn || (function $(e, t) {
	return Ji.call(e, t);
}), ht = Array.isArray || (function ht(e) {
...
var Hi = /(?:[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/, ne = function ne(t, i) {
	this.line = t, this.column = i;
};
ne.prototype.offset = function offset(t) {
	return new ne(this.line, this.column + t);
};
var be = function be(t, i, s) {
...
var xe = 0, We = 1, K = 2, Ct = 3, Tt = 4, Et = 5, A = function A(t, i, s) {
...
A.prototype.parse = function parse() {
	var t = this.options.program || this.startNode();
	return this.nextToken(), this.parseTopLevel(t);
};
U.inFunction.get = function get() {
	return (this.currentVarScope().flags & Z) > 0;
};
U.inGenerator.get = function get() {
	return (this.currentVarScope().flags & bt) > 0;
};
U.inAsync.get = function get() {
	return (this.currentVarScope().flags & Ke) > 0;
};
U.canAwait.get = function get() {
...
U.allowSuper.get = function get() {
	return (this.currentThisScope().flags & Se) > 0 || this.options.allowSuperOutsideMethod;
};
U.allowDirectSuper.get = function get() {
	return (this.currentThisScope().flags & _t) > 0;
};
U.treatFunctionsAsVar.get = function get() {
	return this.treatFunctionsAsVarInScope(this.currentScope());
};
U.allowNewDotTarget.get = function get() {
	for (var e = this.scopeStack.length - 1; e >= 0; e--) {
		var i = this.scopeStack[e].flags;
...
U.inClassStaticBlock.get = function get() {
	return (this.currentVarScope().flags & z) > 0;
};
...
A.parse = function parse(t, i) {
	return new this(i, t).parse();
};
A.parseExpressionAt = function parseExpressionAt(t, i, s) {
	var r = new this(s, t, i);
	return r.nextToken(), r.parseExpression();
};
A.tokenizer = function tokenizer(t, i) {
	return new this(i, t);
};
Object.defineProperties(A.prototype, U);
var w = A.prototype, zi = /^(?:'((?:\\[^]|[^'\\])*?)'|"((?:\\[^]|[^"\\])*?)")/;
w.strictDirective = function strictDirective(e) {
...
w.eat = function eat(e) {
	return this.type === e ? (this.next(), !0) : !1;
};
w.isContextual = function isContextual(e) {
	return this.type === a.name && this.value === e && !this.containsEsc;
};
w.eatContextual = function eatContextual(e) {
	return this.isContextual(e) ? (this.next(), !0) : !1;
};
w.expectContextual = function expectContextual(e) {
	this.eatContextual(e) || this.unexpected();
};
w.canInsertSemicolon = function canInsertSemicolon() {
	return this.type === a.eof || this.type === a.braceR || L.test(this.input.slice(this.lastTokEnd, this.start));
};
w.insertSemicolon = function insertSemicolon() {
	if (this.canInsertSemicolon()) return this.options.onInsertedSemicolon && this.options.onInsertedSemicolon(this.lastTokEnd, this.lastTokEndLoc), !0;
};
w.semicolon = function semicolon() {
	!this.eat(a.semi) && !this.insertSemicolon() && this.unexpected();
};
w.afterTrailingComma = function afterTrailingComma(e, t) {
...
w.expect = function expect(e) {
	this.eat(e) || this.unexpected();
};
w.unexpected = function unexpected(e) {
	this.raise(e ?? this.start, "Unexpected token");
};
var Ce = function Ce() {
	this.shorthandAssign = this.trailingComma = this.parenthesizedAssign = this.parenthesizedBind = this.doubleProto = -1;
};
w.checkPatternErrors = function checkPatternErrors(e, t) {
	if (e) {
...
w.checkExpressionErrors = function checkExpressionErrors(e, t) {
	if (!e) return !1;
...
w.checkYieldAwaitInDefaultParams = function checkYieldAwaitInDefaultParams() {
	this.yieldPos && (!this.awaitPos || this.yieldPos < this.awaitPos) && this.raise(this.yieldPos, "Yield expression cannot be a default value"), this.awaitPos && this.raise(this.awaitPos, "Await expression cannot be a default value");
};
w.isSimpleAssignTarget = function isSimpleAssignTarget(e) {
	return e.type === "ParenthesizedExpression" ? this.isSimpleAssignTarget(e.expression) : e.type === "Identifier" || e.type === "MemberExpression";
};
var d = A.prototype;
d.parseTopLevel = function parseTopLevel(e) {
...
d.isAsyncFunction = function isAsyncFunction() {
...
d.isUsingKeyword = function isUsingKeyword(e, t) {
...
d.isAwaitUsing = function isAwaitUsing(e) {
	return this.isUsingKeyword(!0, e);
};
d.isUsing = function isUsing(e) {
	return this.isUsingKeyword(!1, e);
};
d.parseStatement = function parseStatement(e, t, i) {
...
d.parseBreakContinueStatement = function parseBreakContinueStatement(e, t) {
	var i = t === "break";
...
d.parseDebuggerStatement = function parseDebuggerStatement(e) {
	return this.next(), this.semicolon(), this.finishNode(e, "DebuggerStatement");
};
d.parseDoStatement = function parseDoStatement(e) {
...
d.parseForStatement = function parseForStatement(e) {
	this.next();
...
d.parseForAfterInit = function parseForAfterInit(e, t, i) {
...
d.parseFunctionStatement = function parseFunctionStatement(e, t, i) {
	return this.next(), this.parseFunction(e, ae | (i ? 0 : Ge), !1, t);
};
d.parseIfStatement = function parseIfStatement(e) {
...
d.parseReturnStatement = function parseReturnStatement(e) {
...
d.parseSwitchStatement = function parseSwitchStatement(e) {
...
d.parseThrowStatement = function parseThrowStatement(e) {
...
var Yi = [];
d.parseCatchClauseParam = function parseCatchClauseParam() {
	var e = this.parseBindingAtom(), t = e.type === "Identifier";
	return this.enterScope(t ? St : 0), this.checkLValPattern(e, t ? Tt : K), this.expect(a.parenR), e;
};
d.parseTryStatement = function parseTryStatement(e) {
...
d.parseVarStatement = function parseVarStatement(e, t, i) {
	return this.next(), this.parseVar(e, !1, t, i), this.semicolon(), this.finishNode(e, "VariableDeclaration");
};
d.parseWhileStatement = function parseWhileStatement(e) {
...
d.parseWithStatement = function parseWithStatement(e) {
	return this.strict && this.raise(this.start, "'with' in strict mode"), this.next(), e.object = this.parseParenExpression(), e.body = this.parseStatement("with"), this.finishNode(e, "WithStatement");
};
d.parseEmptyStatement = function parseEmptyStatement(e) {
	return this.next(), this.finishNode(e, "EmptyStatement");
};
d.parseLabeledStatement = function parseLabeledStatement(e, t, i, s) {
...
d.parseExpressionStatement = function parseExpressionStatement(e, t) {
	return e.expression = t, this.semicolon(), this.finishNode(e, "ExpressionStatement");
};
d.parseBlock = function parseBlock(e, t, i) {
...
d.parseFor = function parseFor(e, t) {
...
d.parseForIn = function parseForIn(e, t) {
...
d.parseVar = function parseVar(e, t, i, s) {
...
d.parseFunctionParams = function parseFunctionParams(e) {
...
d.parseClass = function parseClass(e, t) {
	this.next();
	var i = this.strict;
...
d.parseClassElement = function parseClassElement(e) {
...
d.parseClassMethod = function parseClassMethod(e, t, i, s) {
	var r = e.key;
...
d.parseClassField = function parseClassField(e) {
...
d.parseClassStaticBlock = function parseClassStaticBlock(e) {
	e.body = [];
	var t = this.labels;
...
d.exitClassBody = function exitClassBody() {
...
d.parseExportAllDeclaration = function parseExportAllDeclaration(e, t) {
...
d.parseExport = function parseExport(e, t) {
...
d.parseExportDeclaration = function parseExportDeclaration(e) {
	return this.parseStatement(null);
};
d.parseExportDefaultDeclaration = function parseExportDefaultDeclaration() {
	var e;
...
d.checkVariableExport = function checkVariableExport(e, t) {
	if (e) for (var i = 0, s = t; i < s.length; i += 1) {
		var r = s[i];
		this.checkPatternExport(e, r.id);
	}
};
d.shouldParseExportStatement = function shouldParseExportStatement() {
	return this.type.keyword === "var" || this.type.keyword === "const" || this.type.keyword === "class" || this.type.keyword === "function" || this.isLet() || this.isAsyncFunction();
};
d.parseExportSpecifier = function parseExportSpecifier(e) {
	var t = this.startNode();
...
d.parseExportSpecifiers = function parseExportSpecifiers(e) {
	var t = [], i = !0;
...
d.parseImport = function parseImport(e) {
...
d.parseImportSpecifier = function parseImportSpecifier() {
...
d.parseImportDefaultSpecifier = function parseImportDefaultSpecifier() {
	var e = this.startNode();
	return e.local = this.parseIdent(), this.checkLValSimple(e.local, K), this.finishNode(e, "ImportDefaultSpecifier");
};
d.parseImportNamespaceSpecifier = function parseImportNamespaceSpecifier() {
	var e = this.startNode();
...
d.parseImportSpecifiers = function parseImportSpecifiers() {
	var e = [], t = !0;
...
d.parseWithClause = function parseWithClause() {
	var e = [];
...
d.parseImportAttribute = function parseImportAttribute() {
	var e = this.startNode();
...
d.parseModuleExportName = function parseModuleExportName() {
...
d.adaptDirectivePrologue = function adaptDirectivePrologue(e) {
	for (var t = 0; t < e.length && this.isDirectiveCandidate(e[t]); ++t) e[t].directive = e[t].expression.raw.slice(1, -1);
};
d.isDirectiveCandidate = function isDirectiveCandidate(e) {
...
var D = A.prototype;
D.toAssignable = function toAssignable(e, t, i) {
...
D.toAssignableList = function toAssignableList(e, t) {
...
D.parseSpread = function parseSpread(e) {
	var t = this.startNode();
	return this.next(), t.argument = this.parseMaybeAssign(!1, e), this.finishNode(t, "SpreadElement");
};
D.parseRestBinding = function parseRestBinding() {
	var e = this.startNode();
...
D.parseBindingAtom = function parseBindingAtom() {
...
D.parseBindingList = function parseBindingList(e, t, i, s) {
...
D.parseAssignableListItem = function parseAssignableListItem(e) {
	var t = this.parseMaybeDefault(this.start, this.startLoc);
	return this.parseBindingListItem(t), t;
};
D.parseBindingListItem = function parseBindingListItem(e) {
	return e;
};
D.parseMaybeDefault = function parseMaybeDefault(e, t, i) {
...
D.checkLValSimple = function checkLValSimple(e, t, i) {
	t === void 0 && (t = xe);
	var s = t !== xe;
	switch (e.type) {
		case "Identifier":
...
D.checkLValPattern = function checkLValPattern(e, t, i) {
...
D.checkLValInnerPattern = function checkLValInnerPattern(e, t, i) {
	switch (t === void 0 && (t = xe), e.type) {
		case "Property":
...
var F = function F(t, i, s, r, o) {
	...
	p_stat: new F("(", !1),
	p_expr: new F("(", !0),
	q_tmpl: new F("`", !0, !0, function q_tmpl(e) {
...
ee.initialContext = function initialContext() {
	return [T.b_stat];
};
ee.curContext = function curContext() {
	return this.context[this.context.length - 1];
};
ee.braceIsBlock = function braceIsBlock(e) {
...
ee.inGeneratorContext = function inGeneratorContext() {
...
ee.updateContext = function updateContext(e) {
	var t, i = this.type;
	i.keyword && e === a.dot ? this.exprAllowed = !1 : (t = i.updateContext) ? t.call(this, e) : this.exprAllowed = i.beforeExpr;
};
ee.overrideContext = function overrideContext(e) {
	this.curContext() !== e && (this.context[this.context.length - 1] = e);
};
a.parenR.updateContext = a.braceR.updateContext = function updateContext() {
...
a.braceL.updateContext = function updateContext(e) {
	this.context.push(this.braceIsBlock(e) ? T.b_stat : T.b_expr), this.exprAllowed = !0;
};
a.dollarBraceL.updateContext = function updateContext() {
	this.context.push(T.b_tmpl), this.exprAllowed = !0;
};
a.parenL.updateContext = function updateContext(e) {
	var t = e === a._if || e === a._for || e === a._with || e === a._while;
	this.context.push(t ? T.p_stat : T.p_expr), this.exprAllowed = !0;
};
a.incDec.updateContext = function updateContext() {};
a._function.updateContext = a._class.updateContext = function updateContext(e) {
...
a.colon.updateContext = function updateContext() {
	this.curContext().token === "function" && this.context.pop(), this.exprAllowed = !0;
};
a.backQuote.updateContext = function updateContext() {
	this.curContext() === T.q_tmpl ? this.context.pop() : this.context.push(T.q_tmpl), this.exprAllowed = !1;
};
a.star.updateContext = function updateContext(e) {
	if (e === a._function) {
...
a.name.updateContext = function updateContext(e) {
	var t = !1;
...
var g = A.prototype;
g.checkPropClash = function checkPropClash(e, t, i) {
...
g.parseExpression = function parseExpression(e, t) {
...
g.parseMaybeAssign = function parseMaybeAssign(e, t, i) {
...
g.parseMaybeConditional = function parseMaybeConditional(e, t) {
...
g.parseExprOps = function parseExprOps(e, t) {
...
g.parseExprOp = function parseExprOp(e, t, i, s, r) {
...
g.buildBinary = function buildBinary(e, t, i, s, r, o) {
...
g.parseMaybeUnary = function parseMaybeUnary(e, t, i, s) {
...
g.parseExprSubscripts = function parseExprSubscripts(e, t) {
...
g.parseSubscripts = function parseSubscripts(e, t, i, s, r) {
...
g.shouldParseAsyncArrow = function shouldParseAsyncArrow() {
	return !this.canInsertSemicolon() && this.eat(a.arrow);
};
g.parseSubscriptAsyncArrow = function parseSubscriptAsyncArrow(e, t, i, s) {
	return this.parseArrowExpression(this.startNodeAt(e, t), i, !0, s);
};
g.parseSubscript = function parseSubscript(e, t, i, s, r, o, u) {
...
g.parseExprAtom = function parseExprAtom(e, t, i) {
...
g.parseExprAtomDefault = function parseExprAtomDefault() {
	this.unexpected();
};
g.parseExprImport = function parseExprImport(e) {
	var t = this.startNode();
...
g.parseDynamicImport = function parseDynamicImport(e) {
...
g.parseParenExpression = function parseParenExpression() {
	this.expect(a.parenL);
	var e = this.parseExpression();
	return this.expect(a.parenR), e;
};
g.shouldParseArrow = function shouldParseArrow(e) {
	return !this.canInsertSemicolon();
};
g.parseParenAndDistinguishExpression = function parseParenAndDistinguishExpression(e, t) {
...
g.parseParenItem = function parseParenItem(e) {
	return e;
};
g.parseParenArrowList = function parseParenArrowList(e, t, i, s) {
	return this.parseArrowExpression(this.startNodeAt(e, t), i, !1, s);
};
var Zi = [];
g.parseNew = function parseNew() {
...
g.parseTemplateElement = function parseTemplateElement(e) {
...
g.parseTemplate = function parseTemplate(e) {
	e === void 0 && (e = {});
	var t = e.isTagged;
	t === void 0 && (t = !1);
	var i = this.startNode();
...
g.isAsyncProp = function isAsyncProp(e) {
...
g.parseObj = function parseObj(e, t) {
...
g.parseProperty = function parseProperty(e, t) {
...
g.parseGetterSetter = function parseGetterSetter(e) {
	var t = e.key.name;
...
g.parsePropertyValue = function parsePropertyValue(e, t, i, s, r, o, u, p) {
...
g.parsePropertyName = function parsePropertyName(e) {
	if (this.options.ecmaVersion >= 6) {
...
g.initFunction = function initFunction(e) {
	e.id = null, this.options.ecmaVersion >= 6 && (e.generator = e.expression = !1), this.options.ecmaVersion >= 8 && (e.async = !1);
};
g.parseMethod = function parseMethod(e, t, i) {
...
g.parseArrowExpression = function parseArrowExpression(e, t, i, s) {
...
g.parseFunctionBody = function parseFunctionBody(e, t, i, s) {
...
g.checkUnreserved = function checkUnreserved(e) {
...
g.parseIdent = function parseIdent(e) {
	var t = this.parseIdentNode();
	return this.next(!!e), this.finishNode(t, "Identifier"), e || (this.checkUnreserved(t), t.name === "await" && !this.awaitIdentPos && (this.awaitIdentPos = t.start)), t;
};
g.parseIdentNode = function parseIdentNode() {
	var e = this.startNode();
...
g.parseAwait = function parseAwait(e) {
	this.awaitPos || (this.awaitPos = this.start);
	var t = this.startNode();
	return this.next(), t.argument = this.parseMaybeUnary(null, !0, !1, e), this.finishNode(t, "AwaitExpression");
};
var ge = A.prototype;
ge.raise = function raise(e, t) {
...
ge.curPosition = function curPosition() {
	if (this.options.locations) return new ne(this.curLine, this.pos - this.lineStart);
};
var W = A.prototype, es = function es(t) {
	this.flags = t, this.var = [], this.lexical = [], this.functions = [];
};
W.enterScope = function enterScope(e) {
	this.scopeStack.push(new es(e));
};
W.exitScope = function exitScope() {
	this.scopeStack.pop();
};
W.treatFunctionsAsVarInScope = function treatFunctionsAsVarInScope(e) {
	return e.flags & Z || !this.inModule && e.flags & oe;
};
W.declareName = function declareName(e, t, i) {
	var s = !1;
	if (t === K) {
...
W.checkLocalExport = function checkLocalExport(e) {
	this.scopeStack[0].lexical.indexOf(e.name) === -1 && this.scopeStack[0].var.indexOf(e.name) === -1 && (this.undefinedExports[e.name] = e);
};
W.currentScope = function currentScope() {
	return this.scopeStack[this.scopeStack.length - 1];
};
W.currentVarScope = function currentVarScope() {
	for (var e = this.scopeStack.length - 1;; e--) {
		var t = this.scopeStack[e];
		if (t.flags & (_e | ue | z)) return t;
	}
};
W.currentThisScope = function currentThisScope() {
	for (var e = this.scopeStack.length - 1;; e--) {
		var t = this.scopeStack[e];
		if (t.flags & (_e | ue | z) && !(t.flags & He)) return t;
	}
};
var Te = function Te(t, i, s) {
...
var ft, me, Fe, f = A.prototype, ve = function ve(t, i) {
	this.parent = t, this.base = i || this;
};
ve.prototype.separatedFrom = function separatedFrom(t) {
	for (var i = this; i; i = i.parent) for (var s = t; s; s = s.parent) if (i.base === s.base && i !== s) return !0;
	return !1;
};
ve.prototype.sibling = function sibling() {
...
G.prototype.reset = function reset(t, i, s) {
...
G.prototype.raise = function raise(t) {
	this.parser.raiseRecoverable(this.start, "Invalid regular expression: /" + this.source + "/: " + t);
};
G.prototype.at = function at(t, i) {
	i === void 0 && (i = !1);
...
G.prototype.nextIndex = function nextIndex(t, i) {
	i === void 0 && (i = !1);
	var s = this.source, r = s.length;
	if (t >= r) return r;
...
G.prototype.current = function current(t) {
	return t === void 0 && (t = !1), this.at(this.pos, t);
};
G.prototype.lookahead = function lookahead(t) {
	return t === void 0 && (t = !1), this.at(this.nextIndex(this.pos, t), t);
};
G.prototype.advance = function advance(t) {
	t === void 0 && (t = !1), this.pos = this.nextIndex(this.pos, t);
};
G.prototype.eat = function eat(t, i) {
	return i === void 0 && (i = !1), this.current(i) === t ? (this.advance(i), !0) : !1;
};
G.prototype.eatChars = function eatChars(t, i) {
	i === void 0 && (i = !1);
...
f.validateRegExpFlags = function validateRegExpFlags(e) {
...
f.regexp_disjunction = function regexp_disjunction(e) {
...
f.regexp_alternative = function regexp_alternative(e) {
	for (; e.pos < e.source.length && this.regexp_eatTerm(e););
};
f.regexp_eatTerm = function regexp_eatTerm(e) {
	return this.regexp_eatAssertion(e) ? (e.lastAssertionIsQuantifiable && this.regexp_eatQuantifier(e) && e.switchU && e.raise("Invalid quantifier"), !0) : (e.switchU ? this.regexp_eatAtom(e) : this.regexp_eatExtendedAtom(e)) ? (this.regexp_eatQuantifier(e), !0) : !1;
};
f.regexp_eatAssertion = function regexp_eatAssertion(e) {
	var t = e.pos;
...
f.regexp_eatQuantifier = function regexp_eatQuantifier(e, t) {
	return t === void 0 && (t = !1), this.regexp_eatQuantifierPrefix(e, t) ? (e.eat(63), !0) : !1;
};
f.regexp_eatQuantifierPrefix = function regexp_eatQuantifierPrefix(e, t) {
	return e.eat(42) || e.eat(43) || e.eat(63) || this.regexp_eatBracedQuantifier(e, t);
};
f.regexp_eatBracedQuantifier = function regexp_eatBracedQuantifier(e, t) {
	var i = e.pos;
	if (e.eat(123)) {
		var s = 0, r = -1;
...
f.regexp_eatAtom = function regexp_eatAtom(e) {
	return this.regexp_eatPatternCharacters(e) || e.eat(46) || this.regexp_eatReverseSolidusAtomEscape(e) || this.regexp_eatCharacterClass(e) || this.regexp_eatUncapturingGroup(e) || this.regexp_eatCapturingGroup(e);
};
f.regexp_eatReverseSolidusAtomEscape = function regexp_eatReverseSolidusAtomEscape(e) {
	var t = e.pos;
	if (e.eat(92)) {
...
f.regexp_eatUncapturingGroup = function regexp_eatUncapturingGroup(e) {
	var t = e.pos;
	if (e.eat(40)) {
		if (e.eat(63)) {
...
f.regexp_eatCapturingGroup = function regexp_eatCapturingGroup(e) {
	if (e.eat(40)) {
...
f.regexp_eatModifiers = function regexp_eatModifiers(e) {
...
f.regexp_eatExtendedAtom = function regexp_eatExtendedAtom(e) {
	return e.eat(46) || this.regexp_eatReverseSolidusAtomEscape(e) || this.regexp_eatCharacterClass(e) || this.regexp_eatUncapturingGroup(e) || this.regexp_eatCapturingGroup(e) || this.regexp_eatInvalidBracedQuantifier(e) || this.regexp_eatExtendedPatternCharacter(e);
};
f.regexp_eatInvalidBracedQuantifier = function regexp_eatInvalidBracedQuantifier(e) {
	return this.regexp_eatBracedQuantifier(e, !0) && e.raise("Nothing to repeat"), !1;
};
f.regexp_eatSyntaxCharacter = function regexp_eatSyntaxCharacter(e) {
	var t = e.current();
...
f.regexp_eatPatternCharacters = function regexp_eatPatternCharacters(e) {
	for (var t = e.pos, i = 0; (i = e.current()) !== -1 && !jt(i);) e.advance();
	return e.pos !== t;
};
f.regexp_eatExtendedPatternCharacter = function regexp_eatExtendedPatternCharacter(e) {
	var t = e.current();
	return t !== -1 && t !== 36 && !(t >= 40 && t <= 43) && t !== 46 && t !== 63 && t !== 91 && t !== 94 && t !== 124 ? (e.advance(), !0) : !1;
};
f.regexp_groupSpecifier = function regexp_groupSpecifier(e) {
	if (e.eat(63)) {
...
f.regexp_eatGroupName = function regexp_eatGroupName(e) {
...
f.regexp_eatRegExpIdentifierName = function regexp_eatRegExpIdentifierName(e) {
...
f.regexp_eatRegExpIdentifierStart = function regexp_eatRegExpIdentifierStart(e) {
...
f.regexp_eatRegExpIdentifierPart = function regexp_eatRegExpIdentifierPart(e) {
	var t = e.pos, i = this.options.ecmaVersion >= 11, s = e.current(i);
...
f.regexp_eatAtomEscape = function regexp_eatAtomEscape(e) {
	return this.regexp_eatBackReference(e) || this.regexp_eatCharacterClassEscape(e) || this.regexp_eatCharacterEscape(e) || e.switchN && this.regexp_eatKGroupName(e) ? !0 : (e.switchU && (e.current() === 99 && e.raise("Invalid unicode escape"), e.raise("Invalid escape")), !1);
};
f.regexp_eatBackReference = function regexp_eatBackReference(e) {
	var t = e.pos;
...
f.regexp_eatKGroupName = function regexp_eatKGroupName(e) {
	if (e.eat(107)) {
...
f.regexp_eatCharacterEscape = function regexp_eatCharacterEscape(e) {
	return this.regexp_eatControlEscape(e) || this.regexp_eatCControlLetter(e) || this.regexp_eatZero(e) || this.regexp_eatHexEscapeSequence(e) || this.regexp_eatRegExpUnicodeEscapeSequence(e, !1) || !e.switchU && this.regexp_eatLegacyOctalEscapeSequence(e) || this.regexp_eatIdentityEscape(e);
};
f.regexp_eatCControlLetter = function regexp_eatCControlLetter(e) {
	var t = e.pos;
	if (e.eat(99)) {
...
f.regexp_eatZero = function regexp_eatZero(e) {
	return e.current() === 48 && !Ee(e.lookahead()) ? (e.lastIntValue = 0, e.advance(), !0) : !1;
};
f.regexp_eatControlEscape = function regexp_eatControlEscape(e) {
	var t = e.current();
	return t === 116 ? (e.lastIntValue = 9, e.advance(), !0) : t === 110 ? (e.lastIntValue = 10, e.advance(), !0) : t === 118 ? (e.lastIntValue = 11, e.advance(), !0) : t === 102 ? (e.lastIntValue = 12, e.advance(), !0) : t === 114 ? (e.lastIntValue = 13, e.advance(), !0) : !1;
};
f.regexp_eatControlLetter = function regexp_eatControlLetter(e) {
	var t = e.current();
...
f.regexp_eatRegExpUnicodeEscapeSequence = function regexp_eatRegExpUnicodeEscapeSequence(e, t) {
	t === void 0 && (t = !1);
...
f.regexp_eatIdentityEscape = function regexp_eatIdentityEscape(e) {
	if (e.switchU) return this.regexp_eatSyntaxCharacter(e) ? !0 : e.eat(47) ? (e.lastIntValue = 47, !0) : !1;
	var t = e.current();
	return t !== 99 && (!e.switchN || t !== 107) ? (e.lastIntValue = t, e.advance(), !0) : !1;
};
f.regexp_eatDecimalEscape = function regexp_eatDecimalEscape(e) {
	e.lastIntValue = 0;
	var t = e.current();
	if (t >= 49 && t <= 57) {
		do
...
var Gt = 0, J = 1, B = 2;
f.regexp_eatCharacterClassEscape = function regexp_eatCharacterClassEscape(e) {
	var t = e.current();
...
f.regexp_eatUnicodePropertyValueExpression = function regexp_eatUnicodePropertyValueExpression(e) {
	var t = e.pos;
...
f.regexp_validateUnicodePropertyNameAndValue = function regexp_validateUnicodePropertyNameAndValue(e, t, i) {
...
f.regexp_validateUnicodePropertyNameOrValue = function regexp_validateUnicodePropertyNameOrValue(e, t) {
	if (e.unicodeProperties.binary.test(t)) return J;
	if (e.switchV && e.unicodeProperties.binaryOfStrings.test(t)) return B;
	e.raise("Invalid property name");
};
f.regexp_eatUnicodePropertyName = function regexp_eatUnicodePropertyName(e) {
	var t = 0;
...
f.regexp_eatUnicodePropertyValue = function regexp_eatUnicodePropertyValue(e) {
	var t = 0;
...
f.regexp_eatLoneUnicodePropertyNameOrValue = function regexp_eatLoneUnicodePropertyNameOrValue(e) {
	return this.regexp_eatUnicodePropertyValue(e);
};
f.regexp_eatCharacterClass = function regexp_eatCharacterClass(e) {
	if (e.eat(91)) {
...
f.regexp_classContents = function regexp_classContents(e) {
	return e.current() === 93 ? J : e.switchV ? this.regexp_classSetExpression(e) : (this.regexp_nonEmptyClassRanges(e), J);
};
f.regexp_nonEmptyClassRanges = function regexp_nonEmptyClassRanges(e) {
...
f.regexp_eatClassAtom = function regexp_eatClassAtom(e) {
	var t = e.pos;
	if (e.eat(92)) {
...
f.regexp_eatClassEscape = function regexp_eatClassEscape(e) {
	var t = e.pos;
...
f.regexp_classSetExpression = function regexp_classSetExpression(e) {
	var t = J, i;
...
f.regexp_eatClassSetRange = function regexp_eatClassSetRange(e) {
	var t = e.pos;
...
f.regexp_eatClassSetOperand = function regexp_eatClassSetOperand(e) {
	return this.regexp_eatClassSetCharacter(e) ? J : this.regexp_eatClassStringDisjunction(e) || this.regexp_eatNestedClass(e);
};
f.regexp_eatNestedClass = function regexp_eatNestedClass(e) {
	var t = e.pos;
	if (e.eat(91)) {
...
f.regexp_eatClassStringDisjunction = function regexp_eatClassStringDisjunction(e) {
	var t = e.pos;
...
f.regexp_classStringDisjunctionContents = function regexp_classStringDisjunctionContents(e) {
	for (var t = this.regexp_classString(e); e.eat(124);) this.regexp_classString(e) === B && (t = B);
	return t;
};
f.regexp_classString = function regexp_classString(e) {
	for (var t = 0; this.regexp_eatClassSetCharacter(e);) t++;
	return t === 1 ? J : B;
};
f.regexp_eatClassSetCharacter = function regexp_eatClassSetCharacter(e) {
	var t = e.pos;
...
f.regexp_eatClassSetReservedPunctuator = function regexp_eatClassSetReservedPunctuator(e) {
	var t = e.current();
...
f.regexp_eatClassControlLetter = function regexp_eatClassControlLetter(e) {
	var t = e.current();
	return Ee(t) || t === 95 ? (e.lastIntValue = t % 32, e.advance(), !0) : !1;
};
f.regexp_eatHexEscapeSequence = function regexp_eatHexEscapeSequence(e) {
	var t = e.pos;
	if (e.eat(120)) {
...
f.regexp_eatDecimalDigits = function regexp_eatDecimalDigits(e) {
	var t = e.pos, i = 0;
...
f.regexp_eatHexDigits = function regexp_eatHexDigits(e) {
	var t = e.pos, i = 0;
...
f.regexp_eatLegacyOctalEscapeSequence = function regexp_eatLegacyOctalEscapeSequence(e) {
...
f.regexp_eatOctalDigit = function regexp_eatOctalDigit(e) {
	var t = e.current();
...
f.regexp_eatFixedHexDigits = function regexp_eatFixedHexDigits(e, t) {
	var i = e.pos;
	e.lastIntValue = 0;
	for (var s = 0; s < t; ++s) {
		var r = e.current();
...
b.nextToken = function nextToken() {
...
b.skipLineComment = function skipLineComment(e) {
...
b.skipSpace = function skipSpace() {
...
b.finishToken = function finishToken(e, t) {
	this.end = this.pos, this.options.locations && (this.endLoc = this.curPosition());
	var i = this.type;
	this.type = e, this.value = t, this.updateContext(i);
};
b.readToken_dot = function readToken_dot() {
...
b.readToken_slash = function readToken_slash() {
	var e = this.input.charCodeAt(this.pos + 1);
	return this.exprAllowed ? (++this.pos, this.readRegexp()) : e === 61 ? this.finishOp(a.assign, 2) : this.finishOp(a.slash, 1);
};
b.readToken_mult_modulo_exp = function readToken_mult_modulo_exp(e) {
...
b.readToken_pipe_amp = function readToken_pipe_amp(e) {
	var t = this.input.charCodeAt(this.pos + 1);
	if (t === e) {
...
b.readToken_lt_gt = function readToken_lt_gt(e) {
...
b.readToken_eq_excl = function readToken_eq_excl(e) {
	var t = this.input.charCodeAt(this.pos + 1);
...
b.readToken_question = function readToken_question() {
...
b.readToken_numberSign = function readToken_numberSign() {
...
b.getTokenFromCode = function getTokenFromCode(e) {
	switch (e) {
...
b.finishOp = function finishOp(e, t) {
	var i = this.input.slice(this.pos, this.pos + t);
	return this.pos += t, this.finishToken(e, i);
};
b.readRegexp = function readRegexp() {
...
b.readInt = function readInt(e, t, i) {
...
b.readRadixNumber = function readRadixNumber(e) {
	var t = this.pos;
	this.pos += 2;
...
b.readNumber = function readNumber(e) {
	var t = this.pos;
...
b.readCodePoint = function readCodePoint() {
...
b.readString = function readString(e) {
...
var Wt = {};
b.tryReadTemplateToken = function tryReadTemplateToken() {
...
b.invalidStringToken = function invalidStringToken(e, t) {
	if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw Wt;
	this.raise(e, t);
};
b.readTmplToken = function readTmplToken() {
...
b.readInvalidTemplateToken = function readInvalidTemplateToken() {
...
b.readEscapedChar = function readEscapedChar(e) {
...
var ks = Array.prototype.findLast ?? function ks(e) {
	for (let t = this.length - 1; t >= 0; t--) {
		let i = this[t];
		if (e(i, t, this)) return i;
	}
}, Zt = te("findLast", function Zt() {
	if (Array.isArray(this)) return ks;
});
function Ps(e) {
	return this[e < 0 ? this.length + e : e];
}
var ie = te("at", function ie() {
...
var Pe = Gs;
var qs = String.prototype.replaceAll ?? function qs(e, t) {
	return e.global ? this.replace(e, t) : this.split(e).join(t);
}, fe = te("replaceAll", function fe() {
