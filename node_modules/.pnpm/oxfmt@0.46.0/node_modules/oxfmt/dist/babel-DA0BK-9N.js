...
var ur = Array.prototype.findLast ?? function ur(a) {
	for (let t = this.length - 1; t >= 0; t--) {
		let e = this[t];
		if (a(e, t, this)) return e;
	}
}, xs = ee("findLast", function xs() {
	if (Array.isArray(this)) return ur;
});
function dr(a) {
	return this[a < 0 ? this.length + a : a];
}
var Ps = ee("at", function Ps() {
...
var Me = kr;
var vr = String.prototype.replaceAll ?? function vr(a, t) {
	return a.global ? this.replace(a, t) : this.split(a).join(t);
}, xe = ee("replaceAll", function xe() {
