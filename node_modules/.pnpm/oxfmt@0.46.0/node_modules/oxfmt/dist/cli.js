import { r as runCli } from "./bindings-C2_LYpRs.js";
import { i as resolvePlugins } from "./apis-6K9lp4qz.js";
...
(async () => {
	...
	if (mode === "migrate:prettier") {
		await import("./migrate-prettier-nRex0Mh1.js").then((m) => m.runMigratePrettier());
		return;
	}
