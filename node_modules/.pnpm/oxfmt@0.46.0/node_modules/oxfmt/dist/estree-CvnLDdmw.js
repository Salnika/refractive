...
var ba = String.prototype.replaceAll ?? function ba(e, t) {
	return e.global ? this.replace(e, t) : this.split(e).join(t);
}, W = Wt("replaceAll", function W() {
	if (typeof this === "string") return ba;
});
function ka(e) {
	return this[e < 0 ? this.length + e : e];
}
var N = Wt("at", function N() {
...
var Am = Array.prototype.findLast ?? function Am(e) {
	for (let t = this.length - 1; t >= 0; t--) {
		let r = this[t];
		if (e(r, t, this)) return r;
	}
}, xu = Wt("findLast", function xu() {
