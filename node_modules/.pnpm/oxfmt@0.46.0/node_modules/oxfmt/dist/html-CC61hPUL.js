...
var ts = String.prototype.replaceAll ?? function ts(e, t) {
	return e.global ? this.replace(e, t) : this.split(e).join(t);
}, w = ve("replaceAll", function w() {
	if (typeof this === "string") return ts;
});
function ns(e) {
	return this[e < 0 ? this.length + e : e];
}
var M = ve("at", function M() {
...
var Yr = Es;
var Cs = Array.prototype.toReversed ?? function Cs() {
	return [...this].reverse();
}, jr = ve("toReversed", function jr() {
...
var cr = { name: "custom-elements" }, ur = { name: "no-errors-schema" }, Z = (function Z(e) {
...
re = /* @__PURE__ */ new WeakSet(), br = function br() {
