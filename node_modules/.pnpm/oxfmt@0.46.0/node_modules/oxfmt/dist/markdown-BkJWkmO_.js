...
var hu = x((rv, Yt) => {
	typeof Object.create === "function" ? Yt.exports = function exports(r, t) {
	...
	} : Yt.exports = function exports(r, t) {
		if (t) {
			r.super_ = t;
			var n = function n() {};
...
var Le = x((Je, Ia) => {
	...
	Je.left = function left(e) {
		return e.trimLeft ? e.trimLeft() : e.replace(/^\s\s*/, "");
	};
	Je.right = function right(e) {
...
var Pn = x((v2, lc) => {
	lc.exports = function exports(r) {
		return r != null && r.constructor != null && typeof r.constructor.isBuffer === "function" && r.constructor.isBuffer(r);
	};
});
var Ec = x((A2, gc) => {
	"use strict";
	var pt = Object.prototype.hasOwnProperty, Fc = Object.prototype.toString, fc = Object.defineProperty, Dc = Object.getOwnPropertyDescriptor, pc = function pc(r) {
...
var bi = Re(Tr(), 1);
var ef = Array.prototype.toReversed ?? function ef() {
	return [...this].reverse();
}, Di = Me("toReversed", function Di() {
...
var oF = function oF() {
	...
	t.locator = function locator(n, i) {
		return n.indexOf("{", i);
	};
}, cl = oF;
var sF = function sF() {
	...
	i.locator = function locator(u, a) {
		return u.indexOf("[", a);
	};
}, ll = sF;
function ml({ isMDX: e }) {
