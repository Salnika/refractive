...
var er = w((Cx, po) => {
	"use strict";
	var Jt = /[\t\n\f\r "#'()/;[\\\]{}]/g, Zt = /[\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, Qc = /.[\r\n"'(/\\]/, fo = /[\da-f]/i;
	po.exports = function exports(e, s = {}) {
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`));
		...
		return Object.defineProperty(n, "postcss", { get() {
			return i || (i = n()), i;
		} }), n.process = function process(o, u, a) {
...
var ca = w((r_, la) => {
	"use strict";
	var or = /[\t\n\f\r "#'()/;[\\\]{}]/g, ar = /[,\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, cp = /.[\r\n"'(/\\]/, ua = /[\da-f]/i, ur = /[\n\f\r]/g;
	la.exports = function exports(e, s = {}) {
...
var da = w((n_, ha) => {
	...
	ha.exports = function exports(e, s) {
...
var qs = w((Is) => {
	...
	function vt(t) {
		var e = this;
		this.constructor(t), this.nodes = t.nodes, this.after === void 0 && (this.after = this.nodes.length > 0 ? this.nodes[this.nodes.length - 1].after : ""), this.before === void 0 && (this.before = this.nodes.length > 0 ? this.nodes[0].before : ""), this.sourceIndex === void 0 && (this.sourceIndex = this.before.length), this.nodes.forEach(function qs(s) {
			s.parent = e;
		});
	}
	vt.prototype = Object.create(ya.default.prototype);
	vt.constructor = ya.default;
	vt.prototype.walk = function walk(e, s) {
	...
	vt.prototype.each = function each() {
		for (var e = arguments.length <= 0 || arguments[0] === void 0 ? function e() {} : arguments[0], s = 0; s < this.nodes.length; s++) {
			var r = this.nodes[s];
...
var Us = w((m_, Sa) => {
	Sa.exports = function exports(e, s) {
		if (s = typeof s === "number" ? s : Infinity, !s) return Array.isArray(e) ? e.map(function exports(n) {
			return n;
		}) : e;
		return r(e, 1);
		function r(n, i) {
			return n.reduce(function exports(o, u) {
...
var Fs = w((y_, ka) => {
	ka.exports = function exports(t, e) {
...
var ke = w((lr, Oa) => {
	"use strict";
	lr.__esModule = !0;
	var Aa = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function Aa(t) {
		return typeof t;
	} : function Aa(t) {
	...
	lr.default = (function() {
		...
		return t.prototype.remove = function remove() {
			return this.parent && this.parent.removeChild(this), this.parent = void 0, this;
		}, t.prototype.replaceWith = function replaceWith() {
			if (this.parent) {
		...
		}, t.prototype.prev = function prev() {
			return this.parent.at(this.parent.index(this) - 1);
		}, t.prototype.clone = function clone() {
...
var fr = w((cr, Ca) => {
	...
	cr.default = (function(t) {
		...
		return e.prototype.append = function append(r) {
			return r.parent = this, this.nodes.push(r), this;
		}, e.prototype.prepend = function prepend(r) {
			return r.parent = this, this.nodes.unshift(r), this;
		}, e.prototype.at = function at(r) {
			return this.nodes[r];
		}, e.prototype.index = function index(r) {
			return typeof r === "number" ? r : this.nodes.indexOf(r);
		}, e.prototype.removeChild = function removeChild(r) {
			...
			return this;
		}, e.prototype.removeAll = function removeAll() {
		...
		}, e.prototype.empty = function empty() {
			return this.removeAll();
		}, e.prototype.insertAfter = function insertAfter(r, n) {
			var i = this.index(r);
			this.nodes.splice(i + 1, 0, n);
			var o = void 0;
			for (var u in this.indexes) o = this.indexes[u], i <= o && (this.indexes[u] = o + this.nodes.length);
			return this;
		}, e.prototype.insertBefore = function insertBefore(r, n) {
			var i = this.index(r);
			this.nodes.splice(i, 0, n);
			var o = void 0;
			for (var u in this.indexes) o = this.indexes[u], i <= o && (this.indexes[u] = o + this.nodes.length);
			return this;
		}, e.prototype.each = function each(r) {
		...
		}, e.prototype.walk = function walk(r) {
			return this.each(function walk(n, i) {
				var o = r(n, i);
				if (o !== !1 && n.length && (o = n.walk(r)), o === !1) return !1;
			});
		}, e.prototype.walkAttributes = function walkAttributes(r) {
			var n = this;
			return this.walk(function walkAttributes(i) {
				if (i.type === re.ATTRIBUTE) return r.call(n, i);
			});
		}, e.prototype.walkClasses = function walkClasses(r) {
			var n = this;
			return this.walk(function walkClasses(i) {
				if (i.type === re.CLASS) return r.call(n, i);
			});
		}, e.prototype.walkCombinators = function walkCombinators(r) {
			var n = this;
			return this.walk(function walkCombinators(i) {
				if (i.type === re.COMBINATOR) return r.call(n, i);
			});
		}, e.prototype.walkComments = function walkComments(r) {
			var n = this;
			return this.walk(function walkComments(i) {
				if (i.type === re.COMMENT) return r.call(n, i);
			});
		}, e.prototype.walkIds = function walkIds(r) {
			var n = this;
			return this.walk(function walkIds(i) {
				if (i.type === re.ID) return r.call(n, i);
			});
		}, e.prototype.walkNesting = function walkNesting(r) {
			var n = this;
			return this.walk(function walkNesting(i) {
				if (i.type === re.NESTING) return r.call(n, i);
			});
		}, e.prototype.walkPseudos = function walkPseudos(r) {
			var n = this;
			return this.walk(function walkPseudos(i) {
				if (i.type === re.PSEUDO) return r.call(n, i);
			});
		}, e.prototype.walkTags = function walkTags(r) {
			var n = this;
			return this.walk(function walkTags(i) {
				if (i.type === re.TAG) return r.call(n, i);
			});
		}, e.prototype.walkUniversals = function walkUniversals(r) {
			var n = this;
			return this.walk(function walkUniversals(i) {
				if (i.type === re.UNIVERSAL) return r.call(n, i);
			});
		}, e.prototype.split = function split(r) {
			var n = this, i = [];
			return this.reduce(function split(o, u, a) {
				var l = r.call(n, u);
				return i.push(u), l ? (o.push(i), i = []) : a === n.length - 1 && o.push(i), o;
			}, []);
		}, e.prototype.map = function map(r) {
			return this.nodes.map(r);
		}, e.prototype.reduce = function reduce(r, n) {
			return this.nodes.reduce(r, n);
		}, e.prototype.every = function every(r) {
			return this.nodes.every(r);
		}, e.prototype.some = function some(r) {
			return this.nodes.some(r);
		}, e.prototype.filter = function filter(r) {
			return this.nodes.filter(r);
		}, e.prototype.sort = function sort(r) {
			return this.nodes.sort(r);
		}, e.prototype.toString = function toString() {
...
var Pa = w((pr, Na) => {
	...
	pr.default = (function(t) {
		...
		return e.prototype.toString = function toString() {
			var r = this.reduce(function r(n, i) {
				var o = String(i);
				return o ? n + o + "," : "";
			}, "").slice(0, -1);
...
var fu = w((Or, cu) => {
	...
	function tm(t) {
		for (var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, u = void 0, a = void 0, l = void 0, f = void 0, h = void 0, c = void 0, g = void 0, b = s.length, d = -1, p = 1, m = 0, y = function y(O, q) {
...
var du = w((Cr, hu) => {
	...
	Cr.default = (function() {
		...
		return t.prototype.attribute = function attribute() {
		...
		}, t.prototype.combinator = function combinator() {
		...
		}, t.prototype.comma = function comma() {
		...
		}, t.prototype.comment = function comment() {
		...
		}, t.prototype.error = function error(s) {
			throw new this.input.error(s);
		}, t.prototype.missingBackslash = function missingBackslash() {
			return this.error("Expected a backslash preceding the semicolon.");
		}, t.prototype.missingParenthesis = function missingParenthesis() {
			return this.error("Expected opening parenthesis.");
		}, t.prototype.missingSquareBracket = function missingSquareBracket() {
			return this.error("Expected opening square bracket.");
		}, t.prototype.namespace = function namespace() {
		...
		}, t.prototype.nesting = function nesting() {
		...
		}, t.prototype.parentheses = function parentheses() {
		...
		}, t.prototype.pseudo = function pseudo() {
			...
			if (this.currToken[0] === "word") {
				var i = void 0;
				this.splitWord(!1, function pseudo(o, u) {
		...
		}, t.prototype.space = function space() {
		...
		}, t.prototype.string = function string() {
			var s = this.currToken;
		...
		}, t.prototype.universal = function universal(s) {
		...
		}, t.prototype.splitWord = function splitWord(s, r) {
			...
			h.length && (f = f.filter(function f(g) {
				return !~h.indexOf(g);
			}));
			...
			c.forEach(function splitWord(g, b) {
		...
		}, t.prototype.word = function word(s) {
			var r = this.nextToken;
			return r && r[1] === "|" ? (this.position++, this.namespace()) : this.splitWord(s);
		}, t.prototype.loop = function loop() {
			for (; this.position < this.tokens.length;) this.parse(!0);
			return this.root;
		}, t.prototype.parse = function parse(s) {
		...
		}, t.prototype.parseNamespace = function parseNamespace(s) {
			if (this.lossy && typeof s === "string") {
				var r = s.trim();
				return r.length ? r : !0;
			}
			return s;
		}, t.prototype.parseSpace = function parseSpace(s, r) {
			return this.lossy ? r || "" : s;
		}, t.prototype.parseValue = function parseValue(s) {
			return this.lossy && s && typeof s === "string" ? s.trim() : s;
		}, t.prototype.parseParenthesisToken = function parseParenthesisToken(s) {
			return this.lossy ? s[0] === "space" ? this.parseSpace(s[1], " ") : this.parseValue(s[1]) : s[1];
		}, t.prototype.newNode = function newNode(s, r) {
...
var yu = w((Nr, mu) => {
	...
	Nr.default = (function() {
		function t(e) {
			return Gm(this, t), this.func = e || function func() {}, this;
		}
		return t.prototype.process = function process(s) {
...
var Ju = w((Z_, Xu) => {
	...
	Xu.exports = function exports(e, s) {
		s = s || {};
