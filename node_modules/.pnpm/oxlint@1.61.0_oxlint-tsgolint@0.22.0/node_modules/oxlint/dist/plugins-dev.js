...
var import_json_stable_stringify_without_jsonify = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = function exports(obj, opts) {
		opts ||= {}, typeof opts === "function" && (opts = { cmp: opts });
		var space = opts.space || "";
		typeof space === "number" && (space = Array(space + 1).join(" "));
		var cycles = typeof opts.cycles === "boolean" ? opts.cycles : !1, replacer = opts.replacer || function replacer(key, value) {
			return value;
		}, cmp = opts.cmp && (function cmp(f) {
			return function cmp(node) {
	...
	var isArray = Array.isArray || function isArray(x) {
		return {}.toString.call(x) === "[object Array]";
	}, objectKeys = Object.keys || function objectKeys(obj) {
		var has = Object.prototype.hasOwnProperty || function has() {
			return !0;
		}, keys = [];
