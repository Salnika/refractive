        ...
        try {
          if (construct) {
            ...
            (Fake = fn()) &&
              ...
              Fake.catch(function  DetermineComponentFrameRoot() {});
          }
        } catch (sample) {
    ...
    "undefined" !== typeof AbortController
      ...
      : function  AbortControllerLocal() {
          ...
          this.abort = function  abort() {
            signal.aborted = !0;
            listeners.forEach(function  abort(listener) {
              return listener();
            });
          };
        },
...
ReactSharedInternals.S = function  S(transition, returnValue) {
...
var SuspenseException = Error(formatProdErrorMessage(460)),
  ...
  noopSuspenseyCommitThenable = { then: function  then() {} };
  ...
  if (null == memoCache) {
    ...
    null !== current &&
      ...
      null !== current &&
        ...
        null != current &&
          (memoCache = {
            data: current.data.map(function  data(array) {
              return array.slice();
            }),
            index: 0
          })));
...
function startTransition(fiber, queue, pendingState, finishedState, callback) {
  ...
  try {
    ...
    dispatchSetStateInternal(
      fiber,
      queue,
      { then: function  then() {}, status: "rejected", reason: error },
      requestUpdateLane()
    );
  } finally {
    (ReactDOMSharedInternals.p = previousPriority),
...
function createRootErrorUpdate(root, errorInfo, lane) {
  ...
  lane.callback = function  callback() {
...
function initializeClassErrorUpdate(update, root, fiber, errorInfo) {
  ...
  if ("function" === typeof getDerivedStateFromError) {
    ...
    update.payload = function  payload() {
  ...
  if (ownerDocument && href) {
    ...
    if (!resource) {
      ...
      if (
        ...
        link._p = new Promise(function  _p(resolve, reject) {
          link.onload = resolve;
          link.onerror = reject;
        });
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        linkInstance._p = new Promise(function  _p(resolve, reject) {
...
function waitForCommitToBeReady(state, timeoutOffset) {
  ...
  return 0 < state.count || 0 < state.imgCount
    ? function (commit) {
        var stylesheetTimer = setTimeout(function  stylesheetTimer() {
          state.stylesheets &&
            insertSuspendedStylesheets(state, state.stylesheets);
          if (state.unsuspend) {
...
ReactDOMHydrationRoot.prototype.unstable_scheduleHydration = function  unstable_scheduleHydration(target) {
  if (target) {
...
ReactDOMSharedInternals.findDOMNode = function  findDOMNode(componentOrElement) {
...
exports.createPortal = function  createPortal(children, container) {
  var key =
    2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null;
  if (!isValidContainer(container)) throw Error(formatProdErrorMessage(299));
  return createPortal$1(children, container, null, key);
};
exports.createRoot = function  createRoot(container, options) {
  if (!isValidContainer(container)) throw Error(formatProdErrorMessage(299));
  var isStrictMode = !1,
    identifierPrefix = "",
...
exports.hydrateRoot = function  hydrateRoot(container, initialChildren, options) {
  if (!isValidContainer(container)) throw Error(formatProdErrorMessage(299));
  var isStrictMode = !1,
    identifierPrefix = "",
    onUncaughtError = defaultOnUncaughtError,
...
exports.preconnect = function  preconnect(href, options) {
  "string" === typeof href &&
    (options
...
exports.prefetchDNS = function  prefetchDNS(href) {
  "string" === typeof href && ReactDOMSharedInternals.d.D(href);
};
exports.preinit = function  preinit(href, options) {
...
exports.preinitModule = function  preinitModule(href, options) {
...
exports.preload = function  preload(href, options) {
  if (
    "string" === typeof href &&
...
exports.preloadModule = function  preloadModule(href, options) {
  if ("string" === typeof href)
    if (options) {
...
exports.requestFormReset = function  requestFormReset(form) {
  ReactDOMSharedInternals.d.r(form);
};
exports.unstable_batchedUpdates = function  unstable_batchedUpdates(fn, a) {
  return fn(a);
};
exports.useFormState = function  useFormState(action, initialState, permalink) {
  return ReactSharedInternals.H.useFormState(action, initialState, permalink);
};
exports.useFormStatus = function  useFormStatus() {
