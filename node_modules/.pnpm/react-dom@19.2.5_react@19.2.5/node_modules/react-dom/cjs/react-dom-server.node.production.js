...
function useActionState(action, initialState, permalink) {
  ...
  if ("function" === typeof action.$$FORM_ACTION) {
    ...
    "function" === typeof boundAction.$$FORM_ACTION &&
      (action.$$FORM_ACTION = function  $$FORM_ACTION(prefix) {
...
var HooksDispatcher = {
    ...
    useCallback: function  useCallback(callback, deps) {
      return useMemo(function  useCallback() {
        return callback;
      }, deps);
    },
...
exports.prerender = function  prerender(children, options) {
  return new Promise(function  prerender(resolve, reject) {
    var onHeaders = options ? options.onHeaders : void 0,
      onHeadersImpl;
    onHeaders &&
      (onHeadersImpl = function  onHeadersImpl(headersDescriptor) {
...
exports.prerenderToNodeStream = function  prerenderToNodeStream(children, options) {
  return new Promise(function  prerenderToNodeStream(resolve, reject) {
    var resumableState = createResumableState(
        options ? options.identifierPrefix : void 0,
        options ? options.unstable_externalRuntimeSrc : void 0,
        options ? options.bootstrapScriptContent : void 0,
...
exports.renderToPipeableStream = function  renderToPipeableStream(children, options) {
...
exports.renderToReadableStream = function  renderToReadableStream(children, options) {
  return new Promise(function  renderToReadableStream(resolve, reject) {
    var onFatalError,
      onAllReady,
      allReady = new Promise(function  allReady(res, rej) {
        onAllReady = res;
        onFatalError = rej;
      }),
    ...
    var resumableState = createResumableState(
      ...
      request = createRequest(
        ...
        function  request(error) {
          allReady.catch(function  request() {});
          reject(error);
        },
        onFatalError,
        options ? options.onPostpone : void 0,
...
exports.resume = function  resume(children, postponedState, options) {
  return new Promise(function  resume(resolve, reject) {
    var onFatalError,
      onAllReady,
      allReady = new Promise(function  allReady(res, rej) {
        onAllReady = res;
...
exports.resumeAndPrerender = function  resumeAndPrerender(children, postponedState, options) {
  return new Promise(function  resumeAndPrerender(resolve, reject) {
...
exports.resumeAndPrerenderToNodeStream = function  resumeAndPrerenderToNodeStream(
  children,
  postponedState,
  options
) {
  return new Promise(function  resumeAndPrerenderToNodeStream(resolve, reject) {
    var request = resumeAndPrerenderRequest(
      children,
      postponedState,
      createRenderState(
...
exports.resumeToPipeableStream = function  resumeToPipeableStream(children, postponedState, options) {
