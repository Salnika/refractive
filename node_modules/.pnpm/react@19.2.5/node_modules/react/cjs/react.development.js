...
"production" !== process.env.NODE_ENV &&
  (function () {
    ...
    Component.prototype.setState = function  setState(partialState, callback) {
      if (
      ...
      queueSeveralMicrotasks =
        "function" === typeof queueMicrotask
          ? function  queueSeveralMicrotasks(callback) {
              queueMicrotask(function  queueSeveralMicrotasks() {
    ...
    var fnName = {
      ...
      count: function  count(children) {
        var n = 0;
        mapChildren(children, function  count() {
          n++;
        });
        return n;
      },
      toArray: function  toArray(children) {
        return (
          mapChildren(children, function  toArray(child) {
            return child;
          }) || []
        );
      },
    ...
    exports.act = function  act(callback) {
      ...
      if (
        ...
        var thenable = result;
        queueSeveralMicrotasks(function  act() {
          didAwaitActCall ||
            didWarnNoAwaitAct ||
            ((didWarnNoAwaitAct = !0),
            console.error(
        ...
        return {
          then: function  then(resolve, reject) {
            didAwaitActCall = !0;
            thenable.then(
              function  then(returnValue) {
                popActScope(prevActQueue, prevActScopeDepth);
                if (0 === prevActScopeDepth) {
                  try {
                    flushActQueue(queue),
                      enqueueTask(function  then() {
    ...
    exports.cacheSignal = function  cacheSignal() {
      return null;
    };
    exports.captureOwnerStack = function  captureOwnerStack() {
      var getCurrentStack = ReactSharedInternals.getCurrentStack;
      return null === getCurrentStack ? null : getCurrentStack();
    };
    exports.cloneElement = function  cloneElement(element, config, children) {
    ...
    exports.createElement = function  createElement(type, config, children) {
    ...
    exports.startTransition = function  startTransition(scope) {
    ...
    exports.unstable_useCacheRefresh = function  unstable_useCacheRefresh() {
      return resolveDispatcher().useCacheRefresh();
    };
    exports.use = function  use(usable) {
      return resolveDispatcher().use(usable);
    };
    exports.useActionState = function  useActionState(action, initialState, permalink) {
    ...
    exports.useDeferredValue = function  useDeferredValue(value, initialValue) {
    ...
    exports.useOptimistic = function  useOptimistic(passthrough, reducer) {
    ...
    exports.useSyncExternalStore = function  useSyncExternalStore(
      subscribe,
      getSnapshot,
      getServerSnapshot
    ) {
