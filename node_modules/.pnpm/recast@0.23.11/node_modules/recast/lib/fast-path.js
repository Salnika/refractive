...
FastPath.from = function  from(obj) {
...
FPp.valueIsDuplicate = function  valueIsDuplicate() {
    var s = this.stack;
...
FPp.hasParens = function  hasParens() {
...
FPp.getPrevToken = function  getPrevToken(node) {
...
FPp.getNextToken = function  getNextToken(node) {
    node = node || this.getNode();
    var loc = node && node.loc;
    var tokens = loc && loc.tokens;
...
FPp.needsParens = function  needsParens(assumeExpressionContext) {
    var node = this.getNode();
...
FPp.canBeFirstInStatement = function  canBeFirstInStatement() {
    var node = this.getNode();
...
FPp.firstInStatement = function  firstInStatement() {
    var s = this.stack;
