...
var Mapping = /** @class */ (function () {
    ...
    Mapping.prototype.slice = function  slice(lines, start, end) {
    ...
    Mapping.prototype.add = function  add(line, column) {
        return new Mapping(this.sourceLines, this.sourceLoc, {
            start: addPos(this.targetLoc.start, line, column),
            end: addPos(this.targetLoc.end, line, column),
        });
    };
    Mapping.prototype.subtract = function  subtract(line, column) {
        return new Mapping(this.sourceLines, this.sourceLoc, {
            start: subtractPos(this.targetLoc.start, line, column),
            end: subtractPos(this.targetLoc.end, line, column),
        });
    };
    Mapping.prototype.indent = function  indent(by, skipFirstLine, noNegativeColumns) {
