...
var Patcher = function Patcher(lines) {
    ...
    self.replace = function  replace(loc, lines) {
    ...
    self.get = function  get(loc) {
        ...
        replacements
            .sort(function  get(a, b) { return (0, util_1.comparePos)(a.start, b.start); })
            .forEach(function  get(rep) {
...
Pp.tryToReprintComments = function  tryToReprintComments(newNode, oldNode, print) {
    var patcher = this;
    ...
    if (ableToReprintComments && reprints.length > 0) {
        reprints.forEach(function  tryToReprintComments(reprint) {
...
Pp.deleteComments = function  deleteComments(node) {
    if (!node.comments) {
        return;
    }
    var patcher = this;
    node.comments.forEach(function  deleteComments(comment) {
        if (comment.leading) {
