...
PRp.toString = function  toString() {
...
var Printer = function Printer(config) {
    ...
    function makePrintFunctionWith(options, overrides) {
        ...
        return function  Printer(path) { return print(path, options); };
    }
...
function genericPrintNoParens(path, options, print) {
    ...
    switch (n.type) {
        ...
        case "BlockStatement": {
            var naked_1 = path.call(function  naked_1(bodyPath) { return printStatementSequence(bodyPath, options, print); }, "body");
            if (naked_1.isEmpty()) {
        ...
        case "VariableDeclaration": {
            ...
            parts.push(n.kind, " ");
            var maxLen_1 = 0;
            var printed = path.map(function  printed(childPath) {
                var lines = print(childPath);
        ...
        case "DoExpression": {
            var statements = path.call(function  statements(bodyPath) { return printStatementSequence(bodyPath, options, print); }, "body");
        ...
        case "JSXFragment": {
            ...
            var childLines = (0, lines_1.concat)(path.map(function  childLines(childPath) {
        ...
        case "TSTypeLiteral": {
            var members = (0, lines_1.fromString)("\n").join(path.map(print, "members").map(function  members(member) {
        ...
        case "TSInterfaceBody": {
            var lines = (0, lines_1.fromString)("\n").join(path.map(print, "body").map(function  lines(element) {
        ...
        case "TSModuleBlock": {
            var naked = path.call(function  naked(bodyPath) { return printStatementSequence(bodyPath, options, print); }, "body");
            if (naked.isEmpty()) {
                parts.push("{}");
            }
            else {
