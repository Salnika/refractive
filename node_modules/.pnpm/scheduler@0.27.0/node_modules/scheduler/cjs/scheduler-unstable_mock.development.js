...
"production" !== process.env.NODE_ENV &&
  (function () {
    ...
    exports.unstable_advanceTime = function  unstable_advanceTime(ms) {
      "disabledLog" === console.log.name ||
        disableYieldValue ||
        ((currentMockTime += ms),
    ...
    exports.unstable_clearLog = function  unstable_clearLog() {
      if (null === yieldedValues) return [];
      var values = yieldedValues;
      yieldedValues = null;
      return values;
    };
    exports.unstable_flushAll = function  unstable_flushAll() {
    ...
    exports.unstable_flushAllWithoutAsserting =
      unstable_flushAllWithoutAsserting;
    exports.unstable_flushExpired = function  unstable_flushExpired() {
      if (isFlushing) throw Error("Already flushing work.");
      if (null !== scheduledCallback) {
        isFlushing = !0;
        try {
    ...
    exports.unstable_flushNumberOfYields = function  unstable_flushNumberOfYields(count) {
      if (isFlushing) throw Error("Already flushing work.");
      if (null !== scheduledCallback) {
        var cb = scheduledCallback;
    ...
    exports.unstable_flushUntilNextPaint = function  unstable_flushUntilNextPaint() {
      if (isFlushing) throw Error("Already flushing work.");
      if (null !== scheduledCallback) {
        var cb = scheduledCallback;
    ...
    exports.unstable_forceFrameRate = function  unstable_forceFrameRate() {};
    exports.unstable_getCurrentPriorityLevel = function  unstable_getCurrentPriorityLevel() {
      return currentPriorityLevel;
    };
    exports.unstable_hasPendingWork = function  unstable_hasPendingWork() {
    ...
    exports.unstable_now = function  unstable_now() {
      return currentMockTime;
    };
    exports.unstable_requestPaint = function  unstable_requestPaint() {
      needsPaint = !0;
    };
    ...
    exports.unstable_setDisableYieldValue = function  unstable_setDisableYieldValue(newValue) {
      disableYieldValue = newValue;
    };
    exports.unstable_shouldYield = shouldYieldToHost;
    exports.unstable_wrapCallback = function  unstable_wrapCallback(callback) {
      var parentPriorityLevel = currentPriorityLevel;
      return function  unstable_wrapCallback() {
        var previousPriorityLevel = currentPriorityLevel;
