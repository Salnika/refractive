...
exports.unstable_cancelCallback = function  unstable_cancelCallback(node) {
...
exports.unstable_next = function  unstable_next(callback) {
...
exports.unstable_runWithPriority = function  unstable_runWithPriority(priorityLevel, callback) {
  var previousPriorityLevel = currentPriorityLevel_DEPRECATED;
  currentPriorityLevel_DEPRECATED = priorityLevel;
  try {
    return callback();
