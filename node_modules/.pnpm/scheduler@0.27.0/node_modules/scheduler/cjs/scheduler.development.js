...
"production" !== process.env.NODE_ENV &&
  (function () {
    ...
    function requestHostTimeout(callback, ms) {
      taskTimeoutID = localSetTimeout(function  taskTimeoutID() {
    ...
    if ("function" === typeof localSetImmediate)
      var schedulePerformWorkUntilDeadline = function  schedulePerformWorkUntilDeadline() {
    ...
    exports.unstable_forceFrameRate = function  unstable_forceFrameRate(fps) {
      0 > fps || 125 < fps
        ? console.error(
