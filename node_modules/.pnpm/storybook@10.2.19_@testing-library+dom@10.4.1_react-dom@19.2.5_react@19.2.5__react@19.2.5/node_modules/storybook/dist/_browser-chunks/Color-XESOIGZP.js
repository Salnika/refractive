...
function u() {
  return (u = Object.assign || function u(e2) {
...
}, m = e.memo(function m(o2) {
  var a2 = o2.onMove, l2 = o2.onKey, s2 = c(o2, ["onMove", "onKey"]), m2 = r(null), g2 = i(a2), p2 = i(l2), b2 = r(null), _2 = r(!1), x2 = t(function x2() {
    var e2 = function e2(e3) {
    ...
    return [function x2(e3) {
      var r3 = e3.nativeEvent, n2 = m2.current;
      if (n2 && (h(r3), !(function x2(e4, r4) {
        return r4 && !f(e4);
      })(r3, _2.current) && n2)) {
        if (f(r3)) {
          _2.current = !0;
...
}, b = function b(e2, r2, t2) {
  return r2 === void 0 && (r2 = 0), t2 === void 0 && (t2 = Math.pow(10, r2)), Math.round(t2 * e2) / t2;
}, _ = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) }, x = function x(e2) {
  return L(C(e2));
}, C = function C(e2) {
...
var S = e.memo(function S(r2) {
  var t2 = r2.hue, n2 = r2.onChange, o2 = g(["react-colorful__hue", r2.className]);
  return e.createElement("div", { className: o2 }, e.createElement(m, { onMove: function onMove(e2) {
    n2({ h: 360 * e2.left });
  }, onKey: function onKey(e2) {
...
}), T = e.memo(function T(r2) {
  var t2 = r2.hsva, n2 = r2.onChange, o2 = { backgroundColor: q({ h: t2.h, s: 100, v: 100, a: 1 }) };
  return e.createElement("div", { className: "react-colorful__saturation", style: o2 }, e.createElement(m, { onMove: function onMove(e2) {
...
var J = /* @__PURE__ */ new Map(), Q = function Q(e2) {
  V(function Q() {
...
}, W = { defaultColor: "000", toHsva: x, fromHsva: function fromHsva(e2) {
  return w({ h: e2.h, s: e2.s, v: e2.v, a: 1 });
}, equal: X }, Z = function Z(r2) {
  ...
  return e.createElement("div", { className: l2 }, e.createElement("div", { className: "react-colorful__alpha-gradient", style: a2 }), e.createElement(m, { onMove: function onMove(e2) {
    o2({ a: e2.left });
  }, onKey: function onKey(e2) {
    o2({ a: s(n2.a + e2.left) });
...
var le = { defaultColor: "hsla(0, 0%, 0%, 1)", toHsva: H, fromHsva: k, equal: P }, ue = function ue(r2) {
  return e.createElement(re, u({}, r2, { colorModel: le }));
};
var Ee = { defaultColor: "rgba(0, 0, 0, 1)", toHsva: z, fromHsva: function fromHsva(e2) {
  var r2 = I(e2);
  return "rgba(" + r2.r + ", " + r2.g + ", " + r2.b + ", " + r2.a + ")";
}, equal: P }, He = function He(r2) {
