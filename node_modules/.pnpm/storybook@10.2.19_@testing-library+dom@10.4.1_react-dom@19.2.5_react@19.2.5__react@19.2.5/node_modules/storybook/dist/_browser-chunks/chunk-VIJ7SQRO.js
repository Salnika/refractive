...
var require_conversions = __commonJS({
  "../../node_modules/color-convert/conversions.js"(exports, module) {
    ...
    convert.rgb.hsl = function hsl(rgb) {
    ...
    convert.rgb.hsv = function hsv(rgb) {
      let rdif, gdif, bdif, h, s, r = rgb[0] / 255, g = rgb[1] / 255, b = rgb[2] / 255, v = Math.max(r, g, b), diff = v - Math.min(r, g, b), diffc = function diffc(c) {
    ...
    convert.rgb.hwb = function hwb(rgb) {
    ...
    convert.rgb.cmyk = function cmyk(rgb) {
    ...
    convert.rgb.keyword = function keyword(rgb) {
    ...
    convert.keyword.rgb = function rgb(keyword) {
      return cssKeywords[keyword];
    };
    convert.rgb.xyz = function xyz(rgb) {
    ...
    convert.rgb.lab = function lab(rgb) {
    ...
    convert.hsl.hsv = function hsv(hsl) {
    ...
    convert.hsv.rgb = function rgb(hsv) {
    ...
    convert.hsv.hsl = function hsl(hsv) {
    ...
    convert.hwb.rgb = function rgb(hwb) {
    ...
    convert.cmyk.rgb = function rgb(cmyk) {
    ...
    convert.xyz.rgb = function rgb(xyz) {
    ...
    convert.xyz.lab = function lab(xyz) {
      let x = xyz[0], y = xyz[1], z = xyz[2];
      x /= 95.047, y /= 100, z /= 108.883, x = x > 8856e-6 ? x ** (1 / 3) : 7.787 * x + 16 / 116, y = y > 8856e-6 ? y ** (1 / 3) : 7.787 * y + 16 / 116, z = z > 8856e-6 ? z ** (1 / 3) : 7.787 * z + 16 / 116;
      let l = 116 * y - 16, a = 500 * (x - y), b = 200 * (y - z);
      return [l, a, b];
    };
    convert.lab.xyz = function xyz(lab) {
    ...
    convert.hsv.ansi16 = function ansi16(args) {
      return convert.rgb.ansi16(convert.hsv.rgb(args), args[2]);
    };
    convert.rgb.ansi256 = function ansi256(args) {
    ...
    convert.ansi16.rgb = function rgb(args) {
      let color = args % 10;
      if (color === 0 || color === 7)
    ...
    convert.ansi256.rgb = function rgb(args) {
      if (args >= 232) {
        let c = (args - 232) * 10 + 8;
        return [c, c, c];
      }
    ...
    convert.rgb.hcg = function hcg(rgb) {
    ...
    convert.gray.rgb = function rgb(args) {
      return [args[0] / 100 * 255, args[0] / 100 * 255, args[0] / 100 * 255];
    };
    convert.gray.hsl = function hsl(args) {
      return [0, 0, args[0]];
    };
    convert.gray.hsv = convert.gray.hsl;
    convert.gray.hwb = function hwb(gray) {
      return [0, 100, gray[0]];
    };
    convert.gray.cmyk = function cmyk(gray) {
      return [0, 0, 0, gray[0]];
    };
    convert.gray.lab = function lab(gray) {
      return [gray[0], 0, 0];
    };
    convert.gray.hex = function hex(gray) {
      let val = Math.round(gray[0] / 100 * 255) & 255, string = ((val << 16) + (val << 8) + val).toString(16).toUpperCase();
      return "000000".substring(string.length) + string;
    };
    convert.rgb.gray = function gray(rgb) {
...
var require_route = __commonJS({
  "../../node_modules/color-convert/route.js"(exports, module) {
    ...
    module.exports = function exports(fromModel) {
...
var require_color_convert = __commonJS({
  "../../node_modules/color-convert/index.js"(exports, module) {
    ...
    function wrapRaw(fn) {
      let wrappedFn = function wrappedFn(...args) {
        let arg0 = args[0];
