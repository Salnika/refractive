    ...
    function graphql2(Prism) {
      Prism.languages.graphql = {
        ...
        if (env.language !== "graphql")
          return;
        var validTokens = env.tokens.filter(function validTokens(token) {
    ...
    function jsx2(Prism) {
      (function(Prism2) {
        ...
        function re(source, flags) {
          return source = source.replace(/<S>/g, function source() {
            return space;
          }).replace(/<BRACES>/g, function source() {
            return braces;
          }).replace(/<SPREAD>/g, function source() {
            return spread;
          }), RegExp(source, flags);
        }
    ...
    function markdown2(Prism) {
      (function(Prism2) {
        ...
        function createInline(pattern) {
          return pattern = pattern.replace(/<inner>/g, function pattern() {
            return inner;
        ...
        function textContent(html) {
          ...
          return text = text.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function text(m, code) {
  ...
  "../../node_modules/refractor/lang/markup.js"(exports, module) {
    ...
    function markup2(Prism) {
      Prism.languages.markup = {
         ...
         */
        value: function value(tagName, lang) {
    ...
    function yaml2(Prism) {
      (function(Prism2) {
        ...
        function createValuePattern(value, flags) {
          ...
          var pattern = /([:\-,[{]\s*(?:\s<<prop>>[ \t]+)?)(?:<<value>>)(?=[ \t]*(?:$|,|\]|\}|(?:[\r\n]\s*)?#))/.source.replace(/<<prop>>/g, function pattern() {
            return properties;
          }).replace(/<<value>>/g, function pattern() {
            return value;
          });
        ...
        Prism2.languages.yaml = {
          ...
          key: {
            pattern: RegExp(
              /((?:^|[:\-,[{\r\n?])[ \t]*(?:<<prop>>[ \t]+)?)<<key>>(?=\s*:\s)/.source.replace(/<<prop>>/g, function pattern() {
                return properties;
              }).replace(/<<key>>/g, function pattern() {
...
var require_prism_core = __commonJS({
  "../../node_modules/refractor/node_modules/prismjs/components/prism-core.js"(exports, module) {
    ...
    var Prism = (function Prism(_self2) {
      var lang = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, uniqueId = 0, plainTextGrammar = {}, _ = {
        ...
        languages: {
          ...
          insertBefore: function insertBefore(inside, before, insert, root) {
            ...
            var old = root[inside];
            return root[inside] = ret, _.languages.DFS(_.languages, function insertBefore(key, value) {
      ...
      if (!_self2.document)
        return _self2.addEventListener && (_.disableWorkerMessageHandler || _self2.addEventListener("message", function Prism(evt) {
...
function createStyleObject(classNames) {
  var elementStyle = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, stylesheet = arguments.length > 2 ? arguments[2] : void 0, nonTokenClassNames = classNames.filter(function nonTokenClassNames(className) {
...
function createElement(_ref) {
  ...
  if (TagName) {
    ...
    if (!useInlineStyles)
      ...
      var allStylesheetSelectors = Object.keys(stylesheet).reduce(function allStylesheetSelectors(classes, selector) {
        return selector.split(".").forEach(function allStylesheetSelectors(className2) {
          classes.includes(className2) || classes.push(className2);
        }), classes;
      }, []), startingClassName = properties.className && properties.className.includes("token") ? ["token"] : [], className = properties.className && startingClassName.concat(properties.className.filter(function className(className2) {
...
var checkForListedLanguage_default = (function checkForListedLanguage_default(astGenerator, language) {
...
`);
      splitValue.forEach(function _loop(text, i) {
...
SyntaxHighlighter.registerLanguage = function registerLanguage(_, language) {
  return import_core.default.register(language);
};
SyntaxHighlighter.alias = function alias(name, aliases) {
