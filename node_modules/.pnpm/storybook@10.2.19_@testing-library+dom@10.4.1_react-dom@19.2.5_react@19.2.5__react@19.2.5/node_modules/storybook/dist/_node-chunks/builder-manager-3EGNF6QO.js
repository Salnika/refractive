...
var require_utils = __commonJS({
  "../../node_modules/ejs/lib/utils.js"(exports) {
    "use strict";
    var regExpChars = /[|\\{}()[\]^$+*?.]/g, hasOwnProperty = Object.prototype.hasOwnProperty, hasOwn = function hasOwn(obj, key) {
      return hasOwnProperty.apply(obj, [key]);
    };
    exports.escapeRegExpChars = function escapeRegExpChars(string) {
...
`;
    exports.escapeXML = function escapeXML(markup) {
...
` + escapeFuncStr;
    ...
    exports.shallowCopy = function shallowCopy(to, from) {
      if (from = from || {}, to != null)
        for (var p in from)
          hasOwn(from, p) && (p === "__proto__" || p === "constructor" || (to[p] = from[p]));
      return to;
    };
    exports.shallowCopyFromList = function shallowCopyFromList(to, from, list) {
    ...
    exports.hyphenToCamel = function hyphenToCamel(str) {
      return str.replace(/-[a-z]/g, function hyphenToCamel(match) {
        return match[1].toUpperCase();
      });
    };
    exports.createNullProtoObjWherePossible = (function createNullProtoObjWherePossible() {
      return typeof Object.create === "function" ? function createNullProtoObjWherePossible() {
        return /* @__PURE__ */ Object.create(null);
      } : { __proto__: null } instanceof Object ? function createNullProtoObjWherePossible() {
        return {};
      } : function createNullProtoObjWherePossible() {
        return { __proto__: null };
      };
    })();
    exports.hasOwnOnlyObject = function hasOwnOnlyObject(obj) {
...
var require_ejs = __commonJS({
  "../../node_modules/ejs/lib/ejs.js"(exports) {
    ...
    exports.resolveInclude = function resolveInclude(name, filename, isDir) {
    ...
    function rethrow(err, str, flnm, lineno, esc) {
      var lines = str.split(`
`), start2 = Math.max(lineno - 3, 0), end = Math.min(lines.length, lineno + 3), filename = esc(flnm), context = lines.slice(start2, end).map(function context(line, i) {
        var curr = i + start2 + 1;
...
` + err.message, err;
    ...
    exports.render = function render(template, d, o) {
    ...
    exports.renderFile = function renderFile() {
...
`, e.message += "Or, if you meant to create an async function, pass `async: true` as an option.")), e;
        ...
        var returnedFn = opts.client ? fn : function returnedFn(data) {
          var include = function include(path2, includeData) {
...
`).replace(/^\s+|\s+$/gm, "")), this.templateText = this.templateText.replace(/[ \t]*<%_/gm, "<%_").replace(/_%>[ \t]*/gm, "_%>");
        ...
        matches && matches.length && matches.forEach(function generateSource(line, index) {
          var closing;
...
}, starter = async function*  starter({
  startTime,
  options,
  router
}) {
...
}, builder = async function*  builder({ startTime, options }) {
