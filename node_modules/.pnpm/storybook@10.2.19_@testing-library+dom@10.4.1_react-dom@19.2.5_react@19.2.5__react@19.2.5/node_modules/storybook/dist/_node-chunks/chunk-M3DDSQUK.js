        ...
        (function(modules) {
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            function parse(code, options, delegate) {
              var commentHandler = null, proxyDelegate = function proxyDelegate(node, metadata) {
          ...
          function(module2, exports2, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports2, "__esModule", { value: !0 });
            var syntax_1 = __webpack_require__(2), CommentHandler = (function CommentHandler() {
              function CommentHandler2() {
                this.attach = !1, this.comments = [], this.stack = [], this.leading = [], this.trailing = [];
              }
              return CommentHandler2.prototype.insertInnerComments = function insertInnerComments(node, metadata) {
              ...
              }, CommentHandler2.prototype.findTrailingComments = function findTrailingComments(metadata) {
              ...
              }, CommentHandler2.prototype.findLeadingComments = function findLeadingComments(metadata) {
              ...
              }, CommentHandler2.prototype.visitNode = function visitNode(node, metadata) {
              ...
              }, CommentHandler2.prototype.visitComment = function visitComment(node, metadata) {
              ...
              }, CommentHandler2.prototype.visit = function visit(node, metadata) {
          ...
          function(module2, exports2, __webpack_require__) {
            "use strict";
            var __extends = this && this.__extends || (function __extends() {
              var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function extendStatics(d, b) {
                d.__proto__ = b;
            ...
            var JSXParser = (function JSXParser(_super) {
              __extends(JSXParser2, _super);
              function JSXParser2(code, options, delegate) {
                return _super.call(this, code, options, delegate) || this;
              }
              return JSXParser2.prototype.parsePrimaryExpression = function parsePrimaryExpression() {
                return this.match("<") ? this.parseJSXRoot() : _super.prototype.parsePrimaryExpression.call(this);
              }, JSXParser2.prototype.startJSX = function startJSX() {
              ...
              }, JSXParser2.prototype.finishJSX = function finishJSX() {
                this.nextToken();
              }, JSXParser2.prototype.reenterJSX = function reenterJSX() {
                this.startJSX(), this.expectJSX("}"), this.config.tokens && this.tokens.pop();
              }, JSXParser2.prototype.createJSXNode = function createJSXNode() {
                return this.collectComments(), {
                  index: this.scanner.index,
                  line: this.scanner.lineNumber,
                  column: this.scanner.index - this.scanner.lineStart
                };
              }, JSXParser2.prototype.createJSXChildNode = function createJSXChildNode() {
                return {
                  index: this.scanner.index,
                  line: this.scanner.lineNumber,
                  column: this.scanner.index - this.scanner.lineStart
                };
              }, JSXParser2.prototype.scanXHTMLEntity = function scanXHTMLEntity(quote) {
                ...
                return result;
              }, JSXParser2.prototype.lexJSX = function lexJSX() {
              ...
              }, JSXParser2.prototype.nextJSXToken = function nextJSXToken() {
              ...
              }, JSXParser2.prototype.nextJSXText = function nextJSXText() {
...
` && ++this.scanner.index, this.scanner.lineStart = this.scanner.index);
              ...
              }, JSXParser2.prototype.peekJSXToken = function peekJSXToken() {
                var state = this.scanner.saveState();
                this.scanner.scanComments();
                var next = this.lexJSX();
                return this.scanner.restoreState(state), next;
              }, JSXParser2.prototype.expectJSX = function expectJSX(value) {
                var token = this.nextJSXToken();
                (token.type !== 7 || token.value !== value) && this.throwUnexpectedToken(token);
              }, JSXParser2.prototype.matchJSX = function matchJSX(value) {
                var next = this.peekJSXToken();
                return next.type === 7 && next.value === value;
              }, JSXParser2.prototype.parseJSXIdentifier = function parseJSXIdentifier() {
              ...
              }, JSXParser2.prototype.parseJSXElementName = function parseJSXElementName() {
                ...
                return elementName;
              }, JSXParser2.prototype.parseJSXAttributeName = function parseJSXAttributeName() {
              ...
              }, JSXParser2.prototype.parseJSXStringLiteralAttribute = function parseJSXStringLiteralAttribute() {
                var node = this.createJSXNode(), token = this.nextJSXToken();
                token.type !== 8 && this.throwUnexpectedToken(token);
                var raw = this.getTokenRaw(token);
                return this.finalize(node, new Node.Literal(token.value, raw));
              }, JSXParser2.prototype.parseJSXExpressionAttribute = function parseJSXExpressionAttribute() {
              ...
              }, JSXParser2.prototype.parseJSXAttributeValue = function parseJSXAttributeValue() {
                return this.matchJSX("{") ? this.parseJSXExpressionAttribute() : this.matchJSX("<") ? this.parseJSXElement() : this.parseJSXStringLiteralAttribute();
              }, JSXParser2.prototype.parseJSXNameValueAttribute = function parseJSXNameValueAttribute() {
              ...
              }, JSXParser2.prototype.parseJSXSpreadAttribute = function parseJSXSpreadAttribute() {
                var node = this.createJSXNode();
              ...
              }, JSXParser2.prototype.parseJSXAttributes = function parseJSXAttributes() {
                for (var attributes = []; !this.matchJSX("/") && !this.matchJSX(">"); ) {
                  var attribute = this.matchJSX("{") ? this.parseJSXSpreadAttribute() : this.parseJSXNameValueAttribute();
                  attributes.push(attribute);
                }
                return attributes;
              }, JSXParser2.prototype.parseJSXOpeningElement = function parseJSXOpeningElement() {
                var node = this.createJSXNode();
                this.expectJSX("<");
              ...
              }, JSXParser2.prototype.parseJSXBoundaryElement = function parseJSXBoundaryElement() {
                var node = this.createJSXNode();
                ...
                var name = this.parseJSXElementName(), attributes = this.parseJSXAttributes(), selfClosing = this.matchJSX("/");
                return selfClosing && this.expectJSX("/"), this.expectJSX(">"), this.finalize(node, new JSXNode.JSXOpeningElement(name, selfClosing, attributes));
              }, JSXParser2.prototype.parseJSXEmptyExpression = function parseJSXEmptyExpression() {
              ...
              }, JSXParser2.prototype.parseJSXExpressionContainer = function parseJSXExpressionContainer() {
                var node = this.createJSXNode();
                this.expectJSX("{");
                var expression;
              ...
              }, JSXParser2.prototype.parseJSXChildren = function parseJSXChildren() {
                ...
                return children;
              }, JSXParser2.prototype.parseComplexJSXElement = function parseComplexJSXElement(el) {
                ...
                return el;
              }, JSXParser2.prototype.parseJSXElement = function parseJSXElement() {
              ...
              }, JSXParser2.prototype.parseJSXRoot = function parseJSXRoot() {
                this.config.tokens && this.tokens.pop(), this.startJSX();
                var element = this.parseJSXElement();
                return this.finishJSX(), element;
              }, JSXParser2.prototype.isStartOfExpression = function isStartOfExpression() {
          ...
          function(module2, exports2) {
            ...
            exports2.Character = {
              ...
              fromCodePoint: function fromCodePoint(cp2) {
              ...
              isWhiteSpace: function isWhiteSpace(cp2) {
              ...
              isLineTerminator: function isLineTerminator(cp2) {
                return cp2 === 10 || cp2 === 13 || cp2 === 8232 || cp2 === 8233;
              },
              // https://tc39.github.io/ecma262/#sec-names-and-keywords
              isIdentifierStart: function isIdentifierStart(cp2) {
              ...
              isIdentifierPart: function isIdentifierPart(cp2) {
              ...
              isDecimalDigit: function isDecimalDigit(cp2) {
                return cp2 >= 48 && cp2 <= 57;
              },
              isHexDigit: function isHexDigit(cp2) {
                return cp2 >= 48 && cp2 <= 57 || cp2 >= 65 && cp2 <= 70 || cp2 >= 97 && cp2 <= 102;
              },
              isOctalDigit: function isOctalDigit(cp2) {
          ...
          function(module2, exports2, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports2, "__esModule", { value: !0 });
            var jsx_syntax_1 = __webpack_require__(6), JSXClosingElement = /* @__PURE__ */ (function JSXClosingElement() {
            ...
            var JSXElement = /* @__PURE__ */ (function JSXElement() {
            ...
            var JSXEmptyExpression = /* @__PURE__ */ (function JSXEmptyExpression() {
            ...
            var JSXExpressionContainer = /* @__PURE__ */ (function JSXExpressionContainer() {
            ...
            var JSXIdentifier = /* @__PURE__ */ (function JSXIdentifier() {
            ...
            var JSXMemberExpression = /* @__PURE__ */ (function JSXMemberExpression() {
            ...
            var JSXAttribute = /* @__PURE__ */ (function JSXAttribute() {
            ...
            var JSXNamespacedName = /* @__PURE__ */ (function JSXNamespacedName() {
            ...
            var JSXOpeningElement = /* @__PURE__ */ (function JSXOpeningElement() {
            ...
            var JSXSpreadAttribute = /* @__PURE__ */ (function JSXSpreadAttribute() {
            ...
            var JSXText = /* @__PURE__ */ (function JSXText() {
          ...
          function(module2, exports2, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports2, "__esModule", { value: !0 });
            var syntax_1 = __webpack_require__(2), ArrayExpression = /* @__PURE__ */ (function ArrayExpression() {
            ...
            var ArrayPattern = /* @__PURE__ */ (function ArrayPattern() {
            ...
            var ArrowFunctionExpression = /* @__PURE__ */ (function ArrowFunctionExpression() {
            ...
            var AssignmentExpression = /* @__PURE__ */ (function AssignmentExpression() {
            ...
            var AssignmentPattern = /* @__PURE__ */ (function AssignmentPattern() {
            ...
            var AsyncArrowFunctionExpression = /* @__PURE__ */ (function AsyncArrowFunctionExpression() {
            ...
            var AsyncFunctionDeclaration = /* @__PURE__ */ (function AsyncFunctionDeclaration() {
            ...
            var AsyncFunctionExpression = /* @__PURE__ */ (function AsyncFunctionExpression() {
            ...
            var AwaitExpression = /* @__PURE__ */ (function AwaitExpression() {
            ...
            var BinaryExpression = /* @__PURE__ */ (function BinaryExpression() {
            ...
            var BlockStatement = /* @__PURE__ */ (function BlockStatement() {
            ...
            var BreakStatement = /* @__PURE__ */ (function BreakStatement() {
            ...
            var CallExpression = /* @__PURE__ */ (function CallExpression() {
            ...
            var CatchClause = /* @__PURE__ */ (function CatchClause() {
            ...
            var ClassBody = /* @__PURE__ */ (function ClassBody() {
            ...
            var ClassDeclaration = /* @__PURE__ */ (function ClassDeclaration() {
            ...
            var ClassExpression = /* @__PURE__ */ (function ClassExpression() {
            ...
            var ComputedMemberExpression = /* @__PURE__ */ (function ComputedMemberExpression() {
            ...
            var ConditionalExpression = /* @__PURE__ */ (function ConditionalExpression() {
            ...
            var ContinueStatement = /* @__PURE__ */ (function ContinueStatement() {
            ...
            var DebuggerStatement = /* @__PURE__ */ (function DebuggerStatement() {
            ...
            var DoWhileStatement = /* @__PURE__ */ (function DoWhileStatement() {
            ...
            var EmptyStatement = /* @__PURE__ */ (function EmptyStatement() {
            ...
            var ExportAllDeclaration = /* @__PURE__ */ (function ExportAllDeclaration() {
            ...
            var ExportDefaultDeclaration = /* @__PURE__ */ (function ExportDefaultDeclaration() {
            ...
            var ExportNamedDeclaration = /* @__PURE__ */ (function ExportNamedDeclaration() {
            ...
            var ExportSpecifier = /* @__PURE__ */ (function ExportSpecifier() {
            ...
            var ExpressionStatement = /* @__PURE__ */ (function ExpressionStatement() {
            ...
            var ForInStatement = /* @__PURE__ */ (function ForInStatement() {
            ...
            var ForOfStatement = /* @__PURE__ */ (function ForOfStatement() {
            ...
            var ForStatement = /* @__PURE__ */ (function ForStatement() {
            ...
            var FunctionDeclaration = /* @__PURE__ */ (function FunctionDeclaration() {
            ...
            var FunctionExpression = /* @__PURE__ */ (function FunctionExpression() {
            ...
            var Identifier = /* @__PURE__ */ (function Identifier() {
            ...
            var IfStatement = /* @__PURE__ */ (function IfStatement() {
            ...
            var ImportDeclaration = /* @__PURE__ */ (function ImportDeclaration() {
            ...
            var ImportDefaultSpecifier = /* @__PURE__ */ (function ImportDefaultSpecifier() {
            ...
            var ImportNamespaceSpecifier = /* @__PURE__ */ (function ImportNamespaceSpecifier() {
            ...
            var ImportSpecifier = /* @__PURE__ */ (function ImportSpecifier() {
            ...
            var LabeledStatement = /* @__PURE__ */ (function LabeledStatement() {
            ...
            var MetaProperty = /* @__PURE__ */ (function MetaProperty() {
            ...
            var MethodDefinition = /* @__PURE__ */ (function MethodDefinition() {
            ...
            var NewExpression = /* @__PURE__ */ (function NewExpression() {
            ...
            var ObjectExpression = /* @__PURE__ */ (function ObjectExpression() {
            ...
            var ObjectPattern = /* @__PURE__ */ (function ObjectPattern() {
            ...
            var Property = /* @__PURE__ */ (function Property() {
            ...
            var RegexLiteral = /* @__PURE__ */ (function RegexLiteral() {
            ...
            var RestElement = /* @__PURE__ */ (function RestElement() {
            ...
            var ReturnStatement = /* @__PURE__ */ (function ReturnStatement() {
            ...
            var Script = /* @__PURE__ */ (function Script() {
            ...
            var SequenceExpression = /* @__PURE__ */ (function SequenceExpression() {
            ...
            var SpreadElement = /* @__PURE__ */ (function SpreadElement() {
            ...
            var StaticMemberExpression = /* @__PURE__ */ (function StaticMemberExpression() {
            ...
            var Super = /* @__PURE__ */ (function Super() {
              function Super2() {
            ...
            var SwitchCase = /* @__PURE__ */ (function SwitchCase() {
            ...
            var SwitchStatement = /* @__PURE__ */ (function SwitchStatement() {
            ...
            var TaggedTemplateExpression = /* @__PURE__ */ (function TaggedTemplateExpression() {
            ...
            var TemplateElement = /* @__PURE__ */ (function TemplateElement() {
            ...
            var TemplateLiteral = /* @__PURE__ */ (function TemplateLiteral() {
            ...
            var ThisExpression = /* @__PURE__ */ (function ThisExpression() {
            ...
            var ThrowStatement = /* @__PURE__ */ (function ThrowStatement() {
            ...
            var TryStatement = /* @__PURE__ */ (function TryStatement() {
            ...
            var UnaryExpression = /* @__PURE__ */ (function UnaryExpression() {
            ...
            var UpdateExpression = /* @__PURE__ */ (function UpdateExpression() {
            ...
            var VariableDeclaration = /* @__PURE__ */ (function VariableDeclaration() {
            ...
            var VariableDeclarator = /* @__PURE__ */ (function VariableDeclarator() {
            ...
            var WhileStatement = /* @__PURE__ */ (function WhileStatement() {
            ...
            var WithStatement = /* @__PURE__ */ (function WithStatement() {
            ...
            var YieldExpression = /* @__PURE__ */ (function YieldExpression() {
          ...
          function(module2, exports2, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports2, "__esModule", { value: !0 });
            var assert_1 = __webpack_require__(9), error_handler_1 = __webpack_require__(10), messages_1 = __webpack_require__(11), Node = __webpack_require__(7), scanner_1 = __webpack_require__(12), syntax_1 = __webpack_require__(2), token_1 = __webpack_require__(13), ArrowParameterPlaceHolder = "ArrowParameterPlaceHolder", Parser = (function Parser() {
              ...
              return Parser2.prototype.throwError = function throwError(messageFormat) {
                for (var values = [], _i = 1; _i < arguments.length; _i++)
                  values[_i - 1] = arguments[_i];
                var args = Array.prototype.slice.call(arguments, 1), msg = messageFormat.replace(/%(\d)/g, function msg(whole, idx) {
              ...
              }, Parser2.prototype.tolerateError = function tolerateError(messageFormat) {
                for (var values = [], _i = 1; _i < arguments.length; _i++)
                  values[_i - 1] = arguments[_i];
                var args = Array.prototype.slice.call(arguments, 1), msg = messageFormat.replace(/%(\d)/g, function msg(whole, idx) {
                  return assert_1.assert(idx < args.length, "Message reference must be in range"), args[idx];
              ...
              }, Parser2.prototype.unexpectedTokenError = function unexpectedTokenError(token, message) {
              ...
              }, Parser2.prototype.throwUnexpectedToken = function throwUnexpectedToken(token, message) {
                throw this.unexpectedTokenError(token, message);
              }, Parser2.prototype.tolerateUnexpectedToken = function tolerateUnexpectedToken(token, message) {
                this.errorHandler.tolerate(this.unexpectedTokenError(token, message));
              }, Parser2.prototype.collectComments = function collectComments() {
              ...
              }, Parser2.prototype.getTokenRaw = function getTokenRaw(token) {
                return this.scanner.source.slice(token.start, token.end);
              }, Parser2.prototype.convertToken = function convertToken(token) {
                var t = {
                ...
                return t;
              }, Parser2.prototype.nextToken = function nextToken() {
              ...
              }, Parser2.prototype.nextRegexToken = function nextRegexToken() {
              ...
              }, Parser2.prototype.createNode = function createNode() {
                return {
                  index: this.startMarker.index,
                  line: this.startMarker.line,
                  column: this.startMarker.column
                };
              }, Parser2.prototype.startNode = function startNode(token, lastLineStart) {
              ...
              }, Parser2.prototype.finalize = function finalize(marker, node) {
                ...
                return node;
              }, Parser2.prototype.expect = function expect(value) {
                var token = this.nextToken();
                (token.type !== 7 || token.value !== value) && this.throwUnexpectedToken(token);
              }, Parser2.prototype.expectCommaSeparator = function expectCommaSeparator() {
                if (this.config.tolerant) {
                  ...
                  this.expect(",");
              }, Parser2.prototype.expectKeyword = function expectKeyword(keyword) {
                var token = this.nextToken();
                (token.type !== 4 || token.value !== keyword) && this.throwUnexpectedToken(token);
              }, Parser2.prototype.match = function match(value) {
                return this.lookahead.type === 7 && this.lookahead.value === value;
              }, Parser2.prototype.matchKeyword = function matchKeyword(keyword) {
                return this.lookahead.type === 4 && this.lookahead.value === keyword;
              }, Parser2.prototype.matchContextualKeyword = function matchContextualKeyword(keyword) {
                return this.lookahead.type === 3 && this.lookahead.value === keyword;
              }, Parser2.prototype.matchAssign = function matchAssign() {
                if (this.lookahead.type !== 7)
                  return !1;
                var op = this.lookahead.value;
                return op === "=" || op === "*=" || op === "**=" || op === "/=" || op === "%=" || op === "+=" || op === "-=" || op === "<<=" || op === ">>=" || op === ">>>=" || op === "&=" || op === "^=" || op === "|=";
              }, Parser2.prototype.isolateCoverGrammar = function isolateCoverGrammar(parseFunction) {
              ...
              }, Parser2.prototype.inheritCoverGrammar = function inheritCoverGrammar(parseFunction) {
                var previousIsBindingElement = this.context.isBindingElement, previousIsAssignmentTarget = this.context.isAssignmentTarget, previousFirstCoverInitializedNameError = this.context.firstCoverInitializedNameError;
                this.context.isBindingElement = !0, this.context.isAssignmentTarget = !0, this.context.firstCoverInitializedNameError = null;
                var result = parseFunction.call(this);
              ...
              }, Parser2.prototype.consumeSemicolon = function consumeSemicolon() {
              ...
              }, Parser2.prototype.parsePrimaryExpression = function parsePrimaryExpression() {
                ...
                return expr;
              }, Parser2.prototype.parseSpreadElement = function parseSpreadElement() {
                var node = this.createNode();
                this.expect("...");
                var arg = this.inheritCoverGrammar(this.parseAssignmentExpression);
                return this.finalize(node, new Node.SpreadElement(arg));
              }, Parser2.prototype.parseArrayInitializer = function parseArrayInitializer() {
              ...
              }, Parser2.prototype.parsePropertyMethod = function parsePropertyMethod(params) {
              ...
              }, Parser2.prototype.parsePropertyMethodFunction = function parsePropertyMethodFunction() {
              ...
              }, Parser2.prototype.parsePropertyMethodAsyncFunction = function parsePropertyMethodAsyncFunction() {
              ...
              }, Parser2.prototype.parseObjectPropertyKey = function parseObjectPropertyKey() {
                ...
                return key;
              }, Parser2.prototype.isPropertyKey = function isPropertyKey(key, value) {
                return key.type === syntax_1.Syntax.Identifier && key.name === value || key.type === syntax_1.Syntax.Literal && key.value === value;
              }, Parser2.prototype.parseObjectProperty = function parseObjectProperty(hasProto) {
              ...
              }, Parser2.prototype.parseObjectInitializer = function parseObjectInitializer() {
                var node = this.createNode();
                this.expect("{");
              ...
              }, Parser2.prototype.parseTemplateHead = function parseTemplateHead() {
              ...
              }, Parser2.prototype.parseTemplateElement = function parseTemplateElement() {
                this.lookahead.type !== 10 && this.throwUnexpectedToken();
                var node = this.createNode(), token = this.nextToken(), raw = token.value, cooked = token.cooked;
                return this.finalize(node, new Node.TemplateElement({ raw, cooked }, token.tail));
              }, Parser2.prototype.parseTemplateLiteral = function parseTemplateLiteral() {
              ...
              }, Parser2.prototype.reinterpretExpressionAsPattern = function reinterpretExpressionAsPattern(expr) {
                switch (expr.type) {
              ...
              }, Parser2.prototype.parseGroupExpression = function parseGroupExpression() {
                var expr;
                ...
                return expr;
              }, Parser2.prototype.parseArguments = function parseArguments() {
                this.expect("(");
                var args = [];
                if (!this.match(")"))
                  for (; ; ) {
              ...
              }, Parser2.prototype.isIdentifierName = function isIdentifierName(token) {
                return token.type === 3 || token.type === 4 || token.type === 1 || token.type === 5;
              }, Parser2.prototype.parseIdentifierName = function parseIdentifierName() {
              ...
              }, Parser2.prototype.parseNewExpression = function parseNewExpression() {
              ...
              }, Parser2.prototype.parseAsyncArgument = function parseAsyncArgument() {
                var arg = this.parseAssignmentExpression();
                return this.context.firstCoverInitializedNameError = null, arg;
              }, Parser2.prototype.parseAsyncArguments = function parseAsyncArguments() {
                this.expect("(");
                var args = [];
                if (!this.match(")"))
                  for (; ; ) {
                ...
                return this.expect(")"), args;
              }, Parser2.prototype.parseLeftHandSideExpressionAllowCall = function parseLeftHandSideExpressionAllowCall() {
              ...
              }, Parser2.prototype.parseSuper = function parseSuper() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseLeftHandSideExpression = function parseLeftHandSideExpression() {
                ...
                for (var node = this.startNode(this.lookahead), expr = this.matchKeyword("super") && this.context.inFunctionBody ? this.parseSuper() : this.inheritCoverGrammar(this.matchKeyword("new") ? this.parseNewExpression : this.parsePrimaryExpression); ; )
                  if (this.match("[")) {
                    ...
                    break;
                return expr;
              }, Parser2.prototype.parseUpdateExpression = function parseUpdateExpression() {
                ...
                return expr;
              }, Parser2.prototype.parseAwaitExpression = function parseAwaitExpression() {
                var node = this.createNode();
                this.nextToken();
                var argument = this.parseUnaryExpression();
                return this.finalize(node, new Node.AwaitExpression(argument));
              }, Parser2.prototype.parseUnaryExpression = function parseUnaryExpression() {
                var expr;
                ...
                return expr;
              }, Parser2.prototype.parseExponentiationExpression = function parseExponentiationExpression() {
                ...
                return expr;
              }, Parser2.prototype.binaryPrecedence = function binaryPrecedence(token) {
              ...
              }, Parser2.prototype.parseBinaryExpression = function parseBinaryExpression() {
                ...
                return expr;
              }, Parser2.prototype.parseConditionalExpression = function parseConditionalExpression() {
                ...
                return expr;
              }, Parser2.prototype.checkPatternParam = function checkPatternParam(options, param) {
                switch (param.type) {
                  case syntax_1.Syntax.Identifier:
              ...
              }, Parser2.prototype.reinterpretAsCoverFormalsList = function reinterpretAsCoverFormalsList(expr) {
              ...
              }, Parser2.prototype.parseAssignmentExpression = function parseAssignmentExpression() {
                var expr;
                ...
                return expr;
              }, Parser2.prototype.parseExpression = function parseExpression() {
                ...
                return expr;
              }, Parser2.prototype.parseStatementListItem = function parseStatementListItem() {
                var statement;
                if (this.context.isAssignmentTarget = !0, this.context.isBindingElement = !0, this.lookahead.type === 4)
                  ...
                  statement = this.parseStatement();
                return statement;
              }, Parser2.prototype.parseBlock = function parseBlock() {
                var node = this.createNode();
                this.expect("{");
                for (var block = []; !this.match("}"); )
                  block.push(this.parseStatementListItem());
                return this.expect("}"), this.finalize(node, new Node.BlockStatement(block));
              }, Parser2.prototype.parseLexicalBinding = function parseLexicalBinding(kind, options) {
              ...
              }, Parser2.prototype.parseBindingList = function parseBindingList(kind, options) {
                ...
                return list;
              }, Parser2.prototype.isLexicalDeclaration = function isLexicalDeclaration() {
                var state = this.scanner.saveState();
                this.scanner.scanComments();
                var next = this.scanner.lex();
              ...
              }, Parser2.prototype.parseLexicalDeclaration = function parseLexicalDeclaration(options) {
              ...
              }, Parser2.prototype.parseBindingRestElement = function parseBindingRestElement(params, kind) {
                var node = this.createNode();
                this.expect("...");
                var arg = this.parsePattern(params, kind);
                return this.finalize(node, new Node.RestElement(arg));
              }, Parser2.prototype.parseArrayPattern = function parseArrayPattern(params, kind) {
                var node = this.createNode();
                this.expect("[");
              ...
              }, Parser2.prototype.parsePropertyPattern = function parsePropertyPattern(params, kind) {
              ...
              }, Parser2.prototype.parseObjectPattern = function parseObjectPattern(params, kind) {
              ...
              }, Parser2.prototype.parsePattern = function parsePattern(params, kind) {
                var pattern;
              ...
              }, Parser2.prototype.parsePatternWithDefault = function parsePatternWithDefault(params, kind) {
                ...
                return pattern;
              }, Parser2.prototype.parseVariableIdentifier = function parseVariableIdentifier(kind) {
                var node = this.createNode(), token = this.nextToken();
              ...
              }, Parser2.prototype.parseVariableDeclaration = function parseVariableDeclaration(options) {
              ...
              }, Parser2.prototype.parseVariableDeclarationList = function parseVariableDeclarationList(options) {
                ...
                return list;
              }, Parser2.prototype.parseVariableStatement = function parseVariableStatement() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseEmptyStatement = function parseEmptyStatement() {
                var node = this.createNode();
                return this.expect(";"), this.finalize(node, new Node.EmptyStatement());
              }, Parser2.prototype.parseExpressionStatement = function parseExpressionStatement() {
              ...
              }, Parser2.prototype.parseIfClause = function parseIfClause() {
              ...
              }, Parser2.prototype.parseIfStatement = function parseIfStatement() {
              ...
              }, Parser2.prototype.parseDoWhileStatement = function parseDoWhileStatement() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseWhileStatement = function parseWhileStatement() {
              ...
              }, Parser2.prototype.parseForStatement = function parseForStatement() {
              ...
              }, Parser2.prototype.parseContinueStatement = function parseContinueStatement() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseBreakStatement = function parseBreakStatement() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseReturnStatement = function parseReturnStatement() {
              ...
              }, Parser2.prototype.parseWithStatement = function parseWithStatement() {
              ...
              }, Parser2.prototype.parseSwitchCase = function parseSwitchCase() {
              ...
              }, Parser2.prototype.parseSwitchStatement = function parseSwitchStatement() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseLabelledStatement = function parseLabelledStatement() {
              ...
              }, Parser2.prototype.parseThrowStatement = function parseThrowStatement() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseCatchClause = function parseCatchClause() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseFinallyClause = function parseFinallyClause() {
                return this.expectKeyword("finally"), this.parseBlock();
              }, Parser2.prototype.parseTryStatement = function parseTryStatement() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseDebuggerStatement = function parseDebuggerStatement() {
                var node = this.createNode();
                return this.expectKeyword("debugger"), this.consumeSemicolon(), this.finalize(node, new Node.DebuggerStatement());
              }, Parser2.prototype.parseStatement = function parseStatement() {
                var statement;
                switch (this.lookahead.type) {
                  case 1:
                  case 5:
                ...
                return statement;
              }, Parser2.prototype.parseFunctionSourceElements = function parseFunctionSourceElements() {
                var node = this.createNode();
                this.expect("{");
              ...
              }, Parser2.prototype.validateParam = function validateParam(options, param, name) {
                var key = "$" + name;
              ...
              }, Parser2.prototype.parseRestElement = function parseRestElement(params) {
                var node = this.createNode();
                this.expect("...");
              ...
              }, Parser2.prototype.parseFormalParameter = function parseFormalParameter(options) {
              ...
              }, Parser2.prototype.parseFormalParameters = function parseFormalParameters(firstRestricted) {
                var options;
                if (options = {
                  simple: !0,
                  params: [],
              ...
              }, Parser2.prototype.matchAsyncFunction = function matchAsyncFunction() {
                ...
                return match;
              }, Parser2.prototype.parseFunctionDeclaration = function parseFunctionDeclaration(identifierIsOptional) {
              ...
              }, Parser2.prototype.parseFunctionExpression = function parseFunctionExpression() {
                var node = this.createNode(), isAsync = this.matchContextualKeyword("async");
                isAsync && this.nextToken(), this.expectKeyword("function");
                var isGenerator = isAsync ? !1 : this.match("*");
                isGenerator && this.nextToken();
              ...
              }, Parser2.prototype.parseDirective = function parseDirective() {
              ...
              }, Parser2.prototype.parseDirectivePrologues = function parseDirectivePrologues() {
                ...
                return body;
              }, Parser2.prototype.qualifiedPropertyName = function qualifiedPropertyName(token) {
                switch (token.type) {
                  case 3:
                  case 8:
                  case 1:
                ...
                return !1;
              }, Parser2.prototype.parseGetterMethod = function parseGetterMethod() {
              ...
              }, Parser2.prototype.parseSetterMethod = function parseSetterMethod() {
                var node = this.createNode(), isGenerator = !1, previousAllowYield = this.context.allowYield;
                this.context.allowYield = !isGenerator;
                var formalParameters = this.parseFormalParameters();
                ...
                var method = this.parsePropertyMethod(formalParameters);
                return this.context.allowYield = previousAllowYield, this.finalize(node, new Node.FunctionExpression(null, formalParameters.params, method, isGenerator));
              }, Parser2.prototype.parseGeneratorMethod = function parseGeneratorMethod() {
                ...
                return this.context.allowYield = previousAllowYield, this.finalize(node, new Node.FunctionExpression(null, params.params, method, isGenerator));
              }, Parser2.prototype.isStartOfExpression = function isStartOfExpression() {
                ...
                return start;
              }, Parser2.prototype.parseYieldExpression = function parseYieldExpression() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseClassElement = function parseClassElement(hasConstructor) {
              ...
              }, Parser2.prototype.parseClassElementList = function parseClassElementList() {
              ...
              }, Parser2.prototype.parseClassBody = function parseClassBody() {
                var node = this.createNode(), elementList = this.parseClassElementList();
                return this.finalize(node, new Node.ClassBody(elementList));
              }, Parser2.prototype.parseClassDeclaration = function parseClassDeclaration(identifierIsOptional) {
              ...
              }, Parser2.prototype.parseClassExpression = function parseClassExpression() {
                var node = this.createNode(), previousStrict = this.context.strict;
                this.context.strict = !0, this.expectKeyword("class");
              ...
              }, Parser2.prototype.parseModule = function parseModule() {
              ...
              }, Parser2.prototype.parseScript = function parseScript() {
                for (var node = this.createNode(), body = this.parseDirectivePrologues(); this.lookahead.type !== 2; )
                  body.push(this.parseStatementListItem());
                return this.finalize(node, new Node.Script(body));
              }, Parser2.prototype.parseModuleSpecifier = function parseModuleSpecifier() {
                var node = this.createNode();
                ...
                return this.finalize(node, new Node.Literal(token.value, raw));
              }, Parser2.prototype.parseImportSpecifier = function parseImportSpecifier() {
              ...
              }, Parser2.prototype.parseNamedImports = function parseNamedImports() {
                this.expect("{");
              ...
              }, Parser2.prototype.parseImportDefaultSpecifier = function parseImportDefaultSpecifier() {
                var node = this.createNode(), local = this.parseIdentifierName();
                return this.finalize(node, new Node.ImportDefaultSpecifier(local));
              }, Parser2.prototype.parseImportNamespaceSpecifier = function parseImportNamespaceSpecifier() {
                var node = this.createNode();
              ...
              }, Parser2.prototype.parseImportDeclaration = function parseImportDeclaration() {
              ...
              }, Parser2.prototype.parseExportSpecifier = function parseExportSpecifier() {
              ...
              }, Parser2.prototype.parseExportDeclaration = function parseExportDeclaration() {
          ...
          function(module2, exports2) {
            ...
            var ErrorHandler = (function ErrorHandler() {
              ...
              return ErrorHandler2.prototype.recordError = function recordError(error) {
                this.errors.push(error);
              }, ErrorHandler2.prototype.tolerate = function tolerate(error) {
                if (this.tolerant)
                  this.recordError(error);
                else
                  throw error;
              }, ErrorHandler2.prototype.constructError = function constructError(msg, column) {
                ...
                return error;
              }, ErrorHandler2.prototype.createError = function createError(index, line, col, description) {
              ...
              }, ErrorHandler2.prototype.throwError = function throwError(index, line, col, description) {
                throw this.createError(index, line, col, description);
              }, ErrorHandler2.prototype.tolerateError = function tolerateError(index, line, col, description) {
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var Scanner = (function Scanner() {
              ...
              return Scanner2.prototype.saveState = function saveState() {
                return {
                  index: this.index,
                  lineNumber: this.lineNumber,
                  lineStart: this.lineStart
                };
              }, Scanner2.prototype.restoreState = function restoreState(state) {
                this.index = state.index, this.lineNumber = state.lineNumber, this.lineStart = state.lineStart;
              }, Scanner2.prototype.eof = function eof() {
                return this.index >= this.length;
              }, Scanner2.prototype.throwUnexpectedToken = function throwUnexpectedToken(message) {
              ...
              }, Scanner2.prototype.tolerateUnexpectedToken = function tolerateUnexpectedToken(message) {
              ...
              }, Scanner2.prototype.skipSingleLineComment = function skipSingleLineComment(offset) {
                ...
                return comments;
              }, Scanner2.prototype.skipMultiLineComment = function skipMultiLineComment() {
                var comments = [], start, loc;
              ...
              }, Scanner2.prototype.scanComments = function scanComments() {
                var comments;
                ...
                return comments;
              }, Scanner2.prototype.isFutureReservedWord = function isFutureReservedWord(id) {
                switch (id) {
                  case "enum":
                  case "export":
                  case "import":
              ...
              }, Scanner2.prototype.isStrictModeReservedWord = function isStrictModeReservedWord(id) {
                switch (id) {
                  case "implements":
                  case "interface":
                  case "package":
              ...
              }, Scanner2.prototype.isRestrictedWord = function isRestrictedWord(id) {
                return id === "eval" || id === "arguments";
              }, Scanner2.prototype.isKeyword = function isKeyword(id) {
                switch (id.length) {
                  case 2:
              ...
              }, Scanner2.prototype.codePointAt = function codePointAt(i) {
                ...
                return cp2;
              }, Scanner2.prototype.scanHexEscape = function scanHexEscape(prefix) {
              ...
              }, Scanner2.prototype.scanUnicodeCodePointEscape = function scanUnicodeCodePointEscape() {
              ...
              }, Scanner2.prototype.getIdentifier = function getIdentifier() {
              ...
              }, Scanner2.prototype.getComplexIdentifier = function getComplexIdentifier() {
                ...
                return id;
              }, Scanner2.prototype.octalToDecimal = function octalToDecimal(ch) {
              ...
              }, Scanner2.prototype.scanIdentifier = function scanIdentifier() {
              ...
              }, Scanner2.prototype.scanPunctuator = function scanPunctuator() {
              ...
              }, Scanner2.prototype.scanHexLiteral = function scanHexLiteral(start) {
              ...
              }, Scanner2.prototype.scanBinaryLiteral = function scanBinaryLiteral(start) {
              ...
              }, Scanner2.prototype.scanOctalLiteral = function scanOctalLiteral(prefix, start) {
                var num = "", octal = !1;
              ...
              }, Scanner2.prototype.isImplicitOctalLiteral = function isImplicitOctalLiteral() {
                ...
                return !0;
              }, Scanner2.prototype.scanNumericLiteral = function scanNumericLiteral() {
              ...
              }, Scanner2.prototype.scanStringLiteral = function scanStringLiteral() {
...
` && ++this.index, this.lineStart = this.index;
              ...
              }, Scanner2.prototype.scanTemplate = function scanTemplate() {
...
`) : cooked += ch;
              ...
              }, Scanner2.prototype.testRegExp = function testRegExp(pattern, flags) {
                var astralSubstitute = "\uFFFF", tmp = pattern, self = this;
                flags.indexOf("u") >= 0 && (tmp = tmp.replace(/\\u\{([0-9a-fA-F]+)\}|\\u([a-fA-F0-9]{4})/g, function tmp($0, $1, $2) {
              ...
              }, Scanner2.prototype.scanRegExpBody = function scanRegExpBody() {
                var ch = this.source[this.index];
              ...
              }, Scanner2.prototype.scanRegExpFlags = function scanRegExpFlags() {
                ...
                return flags;
              }, Scanner2.prototype.scanRegExp = function scanRegExp() {
              ...
              }, Scanner2.prototype.lex = function lex() {
                if (this.eof())
                  return {
                    type: 2,
                    value: "",
          ...
          function(module2, exports2, __webpack_require__) {
            "use strict";
            Object.defineProperty(exports2, "__esModule", { value: !0 });
            var error_handler_1 = __webpack_require__(10), scanner_1 = __webpack_require__(12), token_1 = __webpack_require__(13), Reader = (function Reader() {
              function Reader2() {
                this.values = [], this.curly = this.paren = -1;
              }
              return Reader2.prototype.beforeFunctionExpression = function beforeFunctionExpression(t) {
                return [
                  "(",
                  "{",
                  "[",
              ...
              }, Reader2.prototype.isRegexStart = function isRegexStart() {
                ...
                return regex;
              }, Reader2.prototype.push = function push(token) {
              ...
              return Tokenizer2.prototype.errors = function errors() {
                return this.errorHandler.errors;
              }, Tokenizer2.prototype.getNextToken = function getNextToken() {
