...
`;
        return this.trackers.forEach(function TrackerGroup(tracker) {
...
var require_console_control_strings = __commonJS({
  "../../node_modules/console-control-strings/index.js"(exports) {
    ...
    exports.goto = function goto(x3, y2) {
      return prefix + y2 + ";" + x3 + "H";
    };
    exports.gotoSOL = function gotoSOL() {
      return "\r";
    };
...
var require_template_item = __commonJS({
  "../../node_modules/gauge/lib/template-item.js"(exports, module) {
    ...
    TemplateItem.prototype.getBaseLength = function getBaseLength() {
    ...
    TemplateItem.prototype.getLength = function getLength() {
      var length = this.getBaseLength();
      return length == null ? null : length + this.padLeft + this.padRight;
    };
    TemplateItem.prototype.getMaxLength = function getMaxLength() {
      return this.maxLength == null ? null : this.maxLength + this.padLeft + this.padRight;
    };
    TemplateItem.prototype.getMinLength = function getMinLength() {
...
var require_render_template = __commonJS({
  "../../node_modules/gauge/lib/render-template.js"(exports, module) {
    ...
    var renderTemplate = module.exports = function exports(width, template, values) {
    ...
    function prepareItems(width, template, values) {
      ...
      var output = template.map(cloneAndObjectify).filter(function output(item) {
        return item != null;
...
var require_plumbing = __commonJS({
  "../../node_modules/gauge/lib/plumbing.js"(exports, module) {
    "use strict";
    var consoleControl = require_console_control_strings(), renderTemplate = require_render_template(), validate2 = require_aproba(), Plumbing = module.exports = function exports(theme, template, width) {
    ...
    Plumbing.prototype = {};
    Plumbing.prototype.setTheme = function setTheme(theme) {
      validate2("O", [theme]), this.theme = theme;
    };
    Plumbing.prototype.setTemplate = function setTemplate(template) {
      validate2("A", [template]), this.template = template;
    };
    Plumbing.prototype.setWidth = function setWidth(width) {
      validate2("N", [width]), this.width = width;
    };
    Plumbing.prototype.hide = function hide() {
      return consoleControl.gotoSOL() + consoleControl.eraseLine();
    };
    Plumbing.prototype.hideCursor = consoleControl.hideCursor;
    Plumbing.prototype.showCursor = consoleControl.showCursor;
    Plumbing.prototype.show = function show(status) {
...
var require_has_unicode = __commonJS({
  "../../node_modules/has-unicode/index.js"(exports, module) {
    "use strict";
    var os = __require("os"), hasUnicode = module.exports = function exports() {
...
var require_color_support = __commonJS({
  "../../node_modules/color-support/index.js"(exports, module) {
    ...
    function colorSupport(options, obj) {
      ...
      return term.startsWith('xterm-256') ? has256(obj) : /^screen|^xterm|^vt100|color|ansi|cygwin|linux/i.test(term) || env.COLORTERM ? hasBasic(obj) : hasNone(obj, options);
    }
  }
});
...
var require_cjs = __commonJS({
  "../../node_modules/gauge/node_modules/signal-exit/dist/cjs/index.js"(exports) {
    ...
    Object.defineProperty(exports, "signals", { enumerable: !0, get: function get() {
...
var require_spin = __commonJS({
  "../../node_modules/gauge/lib/spin.js"(exports, module) {
    "use strict";
    module.exports = function exports(spinstr, spun) {
...
var require_progress_bar = __commonJS({
  "../../node_modules/gauge/lib/progress-bar.js"(exports, module) {
    ...
    module.exports = function exports(theme, width, completed) {
...
var require_base_theme = __commonJS({
  "../../node_modules/gauge/lib/base-theme.js"(exports, module) {
    ...
    module.exports = {
      activityIndicator: function activityIndicator(values, theme) {
        if (values.spun != null)
...
var require_theme_set = __commonJS({
  "../../node_modules/gauge/lib/theme-set.js"(exports, module) {
    ...
    ThemeSetProto.newTheme = function newTheme(parent, theme) {
      return theme || (theme = parent, parent = this.baseTheme), Object.assign({}, parent, theme);
    };
    ThemeSetProto.getThemeNames = function getThemeNames() {
      return Object.keys(this.themes);
    };
    ThemeSetProto.addTheme = function addTheme(name, parent, theme) {
      this.themes[name] = this.newTheme(parent, theme);
    };
    ThemeSetProto.addToAllThemes = function addToAllThemes(theme) {
      var themes = this.themes;
      Object.keys(themes).forEach(function addToAllThemes(name) {
        Object.assign(themes[name], theme);
      }), Object.assign(this.baseTheme, theme);
    };
    ThemeSetProto.getTheme = function getTheme(name) {
      if (!this.themes[name])
        throw this.newMissingThemeError(name);
      return this.themes[name];
    };
    ThemeSetProto.setDefault = function setDefault(opts, name) {
    ...
    ThemeSetProto.getDefault = function getDefault(opts) {
      opts || (opts = {});
    ...
    ThemeSetProto.newThemeSet = function newThemeSet() {
  ...
  "../../node_modules/gauge/lib/index.js"(exports, module) {
    ...
    function Gauge(arg1, arg2) {
      ...
      arg1 && arg1.write ? (writeTo = arg1, options = arg2 || {}) : arg2 && arg2.write ? (writeTo = arg2, options = arg1 || {}) : (writeTo = process2.stderr, options = arg1 || arg2 || {}), this._status = {
        ...
        section: "",
        subsection: ""
      }, this._paused = !1, this._disabled = !0, this._showing = !1, this._onScreen = !1, this._needsRedraw = !1, this._hideCursor = options.hideCursor == null ? !0 : options.hideCursor, this._fixedFramerate = options.fixedFramerate == null ? !process2.version.startsWith('v0.8.') : options.fixedFramerate, this._lastUpdateAt = null, this._updateInterval = options.updateInterval == null ? 50 : options.updateInterval, this._themes = options.themes || defaultThemes, this._theme = options.theme;
    ...
    Gauge.prototype = {};
    Gauge.prototype.isEnabled = function isEnabled() {
      return !this._disabled;
    };
    Gauge.prototype.setTemplate = function setTemplate(template) {
      this._gauge.setTemplate(template), this._showing && this._requestRedraw();
    };
    Gauge.prototype._computeTheme = function _computeTheme(theme) {
    ...
    Gauge.prototype.setThemeset = function setThemeset(themes) {
      this._themes = themes, this.setTheme(this._theme);
    };
    Gauge.prototype.setTheme = function setTheme(theme) {
      this._gauge.setTheme(this._computeTheme(theme)), this._showing && this._requestRedraw(), this._theme = theme;
    };
    Gauge.prototype._requestRedraw = function _requestRedraw() {
      this._needsRedraw = !0, this._fixedFramerate || this._doRedraw();
    };
    Gauge.prototype.getWidth = function getWidth() {
      return (this._tty && this._tty.columns || 80) - 1;
    };
    Gauge.prototype.setWriteTo = function setWriteTo(writeTo, tty) {
    ...
    Gauge.prototype._enableEvents = function _enableEvents() {
    ...
    Gauge.prototype._disableEvents = function _disableEvents() {
    ...
    Gauge.prototype._doRedraw = function _doRedraw() {
      if (!(this._disabled || this._paused)) {
        ...
        !this._showing && !this._onScreen || (this._showing && !this._onScreen && (this._onScreen = !0, this._needsRedraw = !0, this._hideCursor && this._writeTo.write(this._gauge.hideCursor())), this._needsRedraw && (this._writeTo.write(this._gauge.show(this._status)) || (this._paused = !0, this._writeTo.on("drain", callWith(this, function _doRedraw() {
...
var require_set_blocking = __commonJS({
  "../../node_modules/set-blocking/index.js"(exports, module) {
    module.exports = function exports(blocking) {
      [process.stdout, process.stderr].forEach(function exports(stream) {
...
var require_log = __commonJS({
  "../../node_modules/npmlog/lib/log.js"(exports, module) {
    ...
    var trackerConstructors = ["newGroup", "newItem", "newStream"], mixinLog = function(tracker) {
      return Object.keys(log2).forEach(function mixinLog(P2) {
        if (P2[0] !== "_" && !trackerConstructors.filter(function mixinLog(C) {
          return C === P2;
    ...
    log2.clearProgress = function clearProgress(cb) {
      if (!this.progressEnabled)
        return cb && process.nextTick(cb);
      this.gauge.hide(cb);
    };
    log2.showProgress = function showProgress(name, completed) {
      if (this.progressEnabled) {
        var values = {};
    ...
    log2.pause = function pause() {
      this._paused = !0, this.progressEnabled && this.gauge.disable();
    };
    log2.resume = function resume() {
      if (this._paused) {
        this._paused = !1;
        var b = this._buffer;
        this._buffer = [], b.forEach(function resume(m) {
          this.emitLog(m);
    ...
    log2.log = function log(lvl, prefix, message) {
...
`), message = util.format.apply(util, a);
    ...
    log2.emitLog = function emitLog(m) {
      if (this._paused) {
        this._buffer.push(m);
        return;
      }
...
`);
    ...
    log2._format = function _format(msg, style) {
      if (stream) {
        var output = "";
        if (this.useColor()) {
          style = style || {};
    ...
    log2.write = function write(msg, style) {
      stream && stream.write(this._format(msg, style));
    };
    log2.addLevel = function addLevel(lvl, n, style, disp) {
...
var require_pretty_hrtime = __commonJS({
  "../../node_modules/pretty-hrtime/index.js"(exports, module) {
    ...
    module.exports = function exports(source, opts) {
