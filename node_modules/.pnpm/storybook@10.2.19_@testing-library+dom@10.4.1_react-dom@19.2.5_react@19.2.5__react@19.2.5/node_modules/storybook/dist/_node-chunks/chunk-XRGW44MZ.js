...
var require_fetch_retry = __commonJS({
  "../../node_modules/fetch-retry/index.js"(exports, module) {
    "use strict";
    module.exports = function exports(fetch2, defaults) {
      ...
      return defaults = Object.assign(baseDefaults, defaults), function exports(input, init) {
        ...
        if (init && init.retryOn)
          if (Array.isArray(init.retryOn) || typeof init.retryOn === "function")
            ...
            throw new ArgumentError("retryOn property expects an array or function");
        return new Promise(function exports(resolve2, reject) {
          var wrappedFetch = function wrappedFetch(attempt) {
            var _input = typeof Request < "u" && input instanceof Request ? input.clone() : input;
            fetch2(_input, init).then(function wrappedFetch(response) {
              if (Array.isArray(retryOn) && retryOn.indexOf(response.status) === -1)
                resolve2(response);
              else if (typeof retryOn === "function")
                try {
                  return Promise.resolve(retryOn(attempt, null, response)).then(function wrappedFetch(retryOnResponse) {
            ...
            }).catch(function wrappedFetch(error) {
              if (typeof retryOn === "function")
                try {
                  Promise.resolve(retryOn(attempt, error, null)).then(function wrappedFetch(retryOnResponse) {
                    retryOnResponse ? retry2(attempt, error, null) : reject(error);
                  }).catch(function wrappedFetch(error2) {
                    reject(error2);
                  });
                } catch (error2) {
                  reject(error2);
