...
var require_is_glob = __commonJS({
  "../../node_modules/is-glob/index.js"(exports, module) {
    var isExtglob = require_is_extglob(), chars = { "{": "}", "(": ")", "[": "]" }, strictCheck = function strictCheck(str) {
      if (str[0] === "!")
        return !0;
      ...
      return !1;
    }, relaxedCheck = function relaxedCheck(str) {
      if (str[0] === "!")
        return !0;
    ...
    module.exports = function exports(str, options) {
      if (typeof str !== "string" || str === "")
        return !1;
      if (isExtglob(str))
        return !0;
...
var require_glob_parent = __commonJS({
  "../../node_modules/fast-glob/node_modules/glob-parent/index.js"(exports, module) {
    ...
    module.exports = function exports(str, opts) {
...
var require_queue = __commonJS({
  "../../node_modules/fastq/queue.js"(exports, module) {
    ...
    function queueAsPromised(context, worker, _concurrency) {
      ...
      function push(value) {
        var p = new Promise(function p(resolve, reject) {
      ...
      function drained() {
        var p = new Promise(function p(resolve) {
...
var require_ignore = __commonJS({
  "../../node_modules/globby/node_modules/ignore/index.js"(exports, module) {
    ...
    var Ignore = class {
      ...
      let makePosix = (str) => str.startsWith('\\\\?\\') || /["<>|\u0000-\u001F]+/u.test(str) ? str : str.replace(/\\/g, "/");
