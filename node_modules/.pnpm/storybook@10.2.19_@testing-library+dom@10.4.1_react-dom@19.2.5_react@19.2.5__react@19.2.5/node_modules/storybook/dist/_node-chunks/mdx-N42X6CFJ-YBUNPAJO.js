...
var nonASCIIwhitespace = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, skipWhiteSpace = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, ref = Object.prototype, hasOwnProperty = ref.hasOwnProperty, toString = ref.toString, hasOwn = Object.hasOwn || (function hasOwn(obj, propName) {
...
var SourceLocation = function SourceLocation(p, start2, end) {
...
pp$9.strictDirective = function strictDirective(start2) {
...
pp$9.isContextual = function isContextual(name2) {
  return this.type === types$1.name && this.value === name2 && !this.containsEsc;
};
pp$9.eatContextual = function eatContextual(name2) {
  return this.isContextual(name2) ? (this.next(), !0) : !1;
};
pp$9.expectContextual = function expectContextual(name2) {
...
pp$8.parseTopLevel = function parseTopLevel(node2) {
...
pp$8.parseBreakContinueStatement = function parseBreakContinueStatement(node2, keyword) {
...
pp$8.parseDebuggerStatement = function parseDebuggerStatement(node2) {
  return this.next(), this.semicolon(), this.finishNode(node2, "DebuggerStatement");
};
pp$8.parseDoStatement = function parseDoStatement(node2) {
...
pp$8.parseForStatement = function parseForStatement(node2) {
  this.next();
...
pp$8.parseForAfterInit = function parseForAfterInit(node2, init, awaitAt) {
...
pp$8.parseFunctionStatement = function parseFunctionStatement(node2, isAsync, declarationPosition) {
  return this.next(), this.parseFunction(node2, FUNC_STATEMENT | (declarationPosition ? 0 : FUNC_HANGING_STATEMENT), !1, isAsync);
};
pp$8.parseIfStatement = function parseIfStatement(node2) {
...
pp$8.parseReturnStatement = function parseReturnStatement(node2) {
...
pp$8.parseSwitchStatement = function parseSwitchStatement(node2) {
...
pp$8.parseThrowStatement = function parseThrowStatement(node2) {
...
pp$8.parseTryStatement = function parseTryStatement(node2) {
...
pp$8.parseVarStatement = function parseVarStatement(node2, kind, allowMissingInitializer) {
...
pp$8.parseWhileStatement = function parseWhileStatement(node2) {
...
pp$8.parseWithStatement = function parseWithStatement(node2) {
...
pp$8.parseEmptyStatement = function parseEmptyStatement(node2) {
  return this.next(), this.finishNode(node2, "EmptyStatement");
};
pp$8.parseLabeledStatement = function parseLabeledStatement(node2, maybeName, expr, context) {
...
pp$8.parseExpressionStatement = function parseExpressionStatement(node2, expr) {
  return node2.expression = expr, this.semicolon(), this.finishNode(node2, "ExpressionStatement");
};
pp$8.parseBlock = function parseBlock(createNewLexicalScope, node2, exitStrict) {
...
pp$8.parseFor = function parseFor(node2, init) {
...
pp$8.parseForIn = function parseForIn(node2, init) {
...
pp$8.parseVar = function parseVar(node2, isFor, kind, allowMissingInitializer) {
...
pp$8.parseFunction = function parseFunction(node2, statement, allowExpressionBody, isAsync, forInit) {
...
pp$8.parseFunctionParams = function parseFunctionParams(node2) {
...
pp$8.parseClass = function parseClass(node2, isStatement) {
  this.next();
...
pp$8.parseClassStaticBlock = function parseClassStaticBlock(node2) {
  node2.body = [];
...
pp$8.parseClassId = function parseClassId(node2, isStatement) {
...
pp$8.parseClassSuper = function parseClassSuper(node2) {
...
pp$8.parseExportAllDeclaration = function parseExportAllDeclaration(node2, exports) {
...
pp$8.parseExport = function parseExport(node2, exports) {
...
pp$8.parseExportDeclaration = function parseExportDeclaration(node2) {
...
pp$8.checkExport = function checkExport(exports, name2, pos) {
...
pp$8.parseImport = function parseImport(node2) {
...
pp$7.toAssignable = function toAssignable(node2, isBinding, refDestructuringErrors) {
...
pp$5.parseDynamicImport = function parseDynamicImport(node2) {
...
pp$5.parseImportMeta = function parseImportMeta(node2) {
  this.next();
...
pp$5.parseTemplateElement = function parseTemplateElement(ref2) {
...
pp$5.parseTemplate = function parseTemplate(ref2) {
  ref2 === void 0 && (ref2 = {});
...
pp$5.initFunction = function initFunction(node2) {
...
pp$5.parseArrowExpression = function parseArrowExpression(node2, params, isAsync, forInit) {
  var oldYieldPos = this.yieldPos, oldAwaitPos = this.awaitPos, oldAwaitIdentPos = this.awaitIdentPos;
...
pp$5.parseFunctionBody = function parseFunctionBody(node2, isArrowFunction, isMethod, forInit) {
...
pp$5.checkParams = function checkParams(node2, allowDuplicates) {
...
pp$5.checkUnreserved = function checkUnreserved(ref2) {
...
pp$3.declareName = function declareName(name2, bindingType, pos) {
  var redeclared = !1;
...
pp$2.finishNode = function finishNode(node2, type) {
...
pp$2.copyNode = function copyNode(node2) {
...
var ecmaVersion, i, list3, pp$1 = Parser.prototype, BranchID = function BranchID(parent, base) {
...
pp$1.regexp_validateUnicodePropertyNameAndValue = function regexp_validateUnicodePropertyNameAndValue(state, name2, value) {
...
pp.readToken = function readToken(code2) {
...
pp.readToken_mult_modulo_exp = function readToken_mult_modulo_exp(code2) {
...
pp.readToken_pipe_amp = function readToken_pipe_amp(code2) {
  var next = this.input.charCodeAt(this.pos + 1);
  if (next === code2) {
...
pp.readToken_plus_min = function readToken_plus_min(code2) {
  var next = this.input.charCodeAt(this.pos + 1);
...
pp.readToken_lt_gt = function readToken_lt_gt(code2) {
...
pp.readToken_eq_excl = function readToken_eq_excl(code2) {
  var next = this.input.charCodeAt(this.pos + 1);
...
pp.getTokenFromCode = function getTokenFromCode(code2) {
  switch (code2) {
...
pp.invalidStringToken = function invalidStringToken(position3, message) {
...
var require_xhtml = __commonJS({
  ...
  "node_modules/micromark-extension-mdxjs/node_modules/acorn-jsx/index.js"(exports, module) {
    ...
    module.exports = function exports(options) {
      return options = options || {}, function exports(Parser22) {
        return plugin({
...
`) : out = String.fromCharCode(ch), this.options.locations && (++this.curLine, this.lineStart = this.pos), out;
  ...
  "node_modules/extend/index.js"(exports, module) {
    "use strict";
    var hasOwn2 = Object.prototype.hasOwnProperty, toStr = Object.prototype.toString, defineProperty = Object.defineProperty, gOPD = Object.getOwnPropertyDescriptor, isArray2 = function isArray2(arr) {
      return typeof Array.isArray === "function" ? Array.isArray(arr) : toStr.call(arr) === "[object Array]";
    }, isPlainObject2 = function isPlainObject2(obj) {
    ...
    }, getProperty = function getProperty(obj, name2) {
      if (name2 === "__proto__")
...
var markdownExtension = [
  ...
  "mkdown",
  "ron"
], markdown_extensions_default = markdownExtension, md = markdown_extensions_default.map(function md(d) {
  return "." + d;
});
...
`, after: `
`, ...tracker.current() }, result = state.handle(child, parent, state, childInfo), serializedChild = child.type === "mdxJsxFlowElement" ? result : state.indentLines(result, function serializedChild(line, _, blank) {
...
var CallableInstance = (
  ...
  process(file, done) {
    ...
    function executor(resolve, reject) {
      ...
      self2.run(parseTree, realFile, function Processor(error, tree, file2) {
        if (error || !tree || !file2)
...
function specifiersToDeclarations(specifiers, init) {
  ...
  return declarations.push({
    ...
    id: {
      type: "ObjectPattern",
      properties: otherSpecifiers.map(function properties(specifier) {
  ...
  return function(tree, file) {
    ...
    for (child of tree.body)
      if (child.type === "ExportDefaultDeclaration")
        ...
        child.specifiers = child.specifiers.filter(function specifiers(specifier) {
    ...
    content3 || replacement.push(
      ...
      argument: {
        ...
        properties: [
          ...
          ...exportedIdentifiers.map(function properties(d) {
            return {
              type: "Property",
              kind: "init",
              method: !1,
    ...
    function handleEsm(node2) {
      ...
      if (outputFormat === "function-body")
        if (
          ...
          let declarators = node2.specifiers.filter(function declarators(specifier) {
            return specifier.local.name !== specifier.exported.name;
          }).map(function declarators(specifier) {
            return {
              type: "VariableDeclarator",
        ...
        currentScope.parent), node2.type === "FunctionDeclaration" || node2.type === "FunctionExpression" || node2.type === "ArrowFunctionExpression") {
          ...
          if (defaults.length > 0 || actual.length > 0 || scope.idToInvalidComponentName.size > 0) {
            ...
            if (actual.length > 0 && (componentsPattern = {
              type: "ObjectPattern",
              properties: actual.map(function properties(name3) {
                return {
                  type: "Property",
                  kind: "init",
                  key: {
...
var ForInStatement, FunctionDeclaration, RestElement, BinaryExpression, ArrayExpression, BlockStatement, GENERATOR = {
  ...
  */
  ...
  BlockStatement: BlockStatement = function BlockStatement(node2, state) {
  ...
  ForInStatement: ForInStatement = function ForInStatement(node2, state) {
  ...
  FunctionDeclaration: FunctionDeclaration = function FunctionDeclaration(node2, state) {
    state.write(
  ...
  RestElement: RestElement = function RestElement(node2, state) {
  ...
  ArrayExpression: ArrayExpression = function ArrayExpression(node2, state) {
  ...
  BinaryExpression: BinaryExpression = function BinaryExpression(node2, state) {
