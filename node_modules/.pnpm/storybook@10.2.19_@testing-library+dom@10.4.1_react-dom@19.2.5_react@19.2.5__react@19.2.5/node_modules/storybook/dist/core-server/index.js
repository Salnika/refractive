...
var require_glob_to_regexp = __commonJS({
  "../../node_modules/glob-to-regexp/index.js"(exports, module) {
    module.exports = function exports(glob, opts) {
...
var require_polyfills = __commonJS({
  "../../node_modules/graceful-fs/polyfills.js"(exports, module) {
    ...
    function patch(fs) {
      constants.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && patchLchmod(fs), fs.lutimes || patchLutimes(fs), fs.chown = chownFix(fs.chown), fs.fchown = chownFix(fs.fchown), fs.lchown = chownFix(fs.lchown), fs.chmod = chmodFix(fs.chmod), fs.fchmod = chmodFix(fs.fchmod), fs.lchmod = chmodFix(fs.lchmod), fs.chownSync = chownFixSync(fs.chownSync), fs.fchownSync = chownFixSync(fs.fchownSync), fs.lchownSync = chownFixSync(fs.lchownSync), fs.chmodSync = chmodFixSync(fs.chmodSync), fs.fchmodSync = chmodFixSync(fs.fchmodSync), fs.lchmodSync = chmodFixSync(fs.lchmodSync), fs.stat = statFix(fs.stat), fs.fstat = statFix(fs.fstat), fs.lstat = statFix(fs.lstat), fs.statSync = statFixSync(fs.statSync), fs.fstatSync = statFixSync(fs.fstatSync), fs.lstatSync = statFixSync(fs.lstatSync), fs.chmod && !fs.lchmod && (fs.lchmod = function lchmod(path2, mode, cb) {
        cb && process.nextTick(cb);
      }, fs.lchmodSync = function lchmodSync() {
      }), fs.chown && !fs.lchown && (fs.lchown = function lchown(path2, uid, gid, cb) {
        cb && process.nextTick(cb);
      }, fs.lchownSync = function lchownSync() {
          ...
          fs$rename(from, to, function CB(er) {
            if (er && (er.code === "EACCES" || er.code === "EPERM" || er.code === "EBUSY") && Date.now() - start < 6e4) {
              setTimeout(function rename() {
                fs.stat(to, function rename(stater, st) {
      ...
      })(fs.read), fs.readSync = typeof fs.readSync !== "function" ? fs.readSync : /* @__PURE__ */ (function readSync(fs$readSync) {
        return function readSync(fd, buffer, offset, length, position) {
      ...
      function patchLchmod(fs2) {
        fs2.lchmod = function lchmod(path2, mode, callback) {
          fs2.open(
            path2,
            constants.O_WRONLY | constants.O_SYMLINK,
            mode,
            function lchmod(err, fd) {
              if (err) {
                callback && callback(err);
                return;
              }
              fs2.fchmod(fd, mode, function lchmod(err2) {
                fs2.close(fd, function lchmod(err22) {
                  callback && callback(err2 || err22);
                });
              });
            }
          );
        }, fs2.lchmodSync = function lchmodSync(path2, mode) {
      ...
      function patchLutimes(fs2) {
        constants.hasOwnProperty("O_SYMLINK") && fs2.futimes ? (fs2.lutimes = function lutimes(path2, at, mt, cb) {
          fs2.open(path2, constants.O_SYMLINK, function lutimes(er, fd) {
            if (er) {
              cb && cb(er);
              return;
            }
            fs2.futimes(fd, at, mt, function lutimes(er2) {
              fs2.close(fd, function lutimes(er22) {
                cb && cb(er2 || er22);
              });
            });
          });
        }, fs2.lutimesSync = function lutimesSync(path2, at, mt) {
          ...
          return ret;
        }) : fs2.futimes && (fs2.lutimes = function lutimes(_a, _b, _c, cb) {
          cb && process.nextTick(cb);
        }, fs2.lutimesSync = function lutimesSync() {
        });
      }
...
var require_clone = __commonJS({
  "../../node_modules/graceful-fs/clone.js"(exports, module) {
    ...
    var getPrototypeOf = Object.getPrototypeOf || function getPrototypeOf(obj) {
...
var require_graceful_fs = __commonJS({
  "../../node_modules/graceful-fs/graceful-fs.js"(exports, module) {
    ...
    var debug = noop;
    util.debuglog ? debug = util.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (debug = function debug() {
...
GFS4: `), console.error(m);
    ...
    fs[gracefulQueue] || (queue = global[gracefulQueue] || [], publishQueue(fs, queue), fs.close = (function(fs$close) {
      function close(fd, cb) {
        return fs$close.call(fs, fd, function close(err) {
...
var require_stringify_info = __commonJS({
  "../../node_modules/@discoveryjs/json-ext/src/stringify-info.js"(exports, module) {
    ...
    module.exports = function exports(value, replacer, space, options) {
...
${this.space.repeat(this._depth - 1)}]`) : this.push("]"), this.popStack();
    ...
    var processReadableObject = createStreamReader(function processReadableObject(data, current) {
      this.processValue(current.value, current.index, data, processArrayItem), current.index++;
    }), processReadableString = createStreamReader(function processReadableString(data) {
      this.push(data);
...
var require_parse_chunked = __commonJS({
  "../../node_modules/@discoveryjs/json-ext/src/parse-chunked.js"(exports, module) {
    ...
    module.exports = function exports(chunkEmitter) {
...
var require_tsconfig_loader = __commonJS({
  "../../node_modules/tsconfig-paths/lib/tsconfig-loader.js"(exports) {
    ...
    function loadTsconfig(configFilePath, existsSync3, readFileSync) {
      if (existsSync3 === void 0 && (existsSync3 = fs.existsSync), readFileSync === void 0 && (readFileSync = function readFileSync(filename) {
        ...
        if (extendedConfig) {
          var base = void 0;
          return Array.isArray(extendedConfig) ? base = extendedConfig.reduce(function base(currBase, extendedConfigElement) {
...
var require_dist2 = __commonJS({
  "../../node_modules/telejson/dist/index.js"(exports, module) {
    "use strict";
    var __create = Object.create, __defProp = Object.defineProperty, __getOwnPropDesc = Object.getOwnPropertyDescriptor, __getOwnPropNames = Object.getOwnPropertyNames, __getProtoOf = Object.getPrototypeOf, __hasOwnProp = Object.prototype.hasOwnProperty, __commonJS2 = (cb, mod) => function __commonJS2() {
      ...
      "node_modules/.pnpm/math-intrinsics@1.1.0/node_modules/math-intrinsics/isNaN.js"(exports2, module2) {
        "use strict";
        module2.exports = Number.isNaN || function exports(a) {
          return a !== a;
        };
      }
      ...
      "node_modules/.pnpm/math-intrinsics@1.1.0/node_modules/math-intrinsics/sign.js"(exports2, module2) {
        ...
        module2.exports = function exports(number) {
      ...
      "node_modules/.pnpm/has-symbols@1.1.0/node_modules/has-symbols/shams.js"(exports2, module2) {
        "use strict";
        module2.exports = function exports() {
      ...
      "node_modules/.pnpm/function-bind@1.1.2/node_modules/function-bind/implementation.js"(exports2, module2) {
        ...
        module2.exports = function exports(that) {
          var target = this;
      ...
      "node_modules/.pnpm/call-bind-apply-helpers@1.0.2/node_modules/call-bind-apply-helpers/index.js"(exports2, module2) {
        ...
        module2.exports = function exports(args) {
      ...
      "node_modules/.pnpm/get-proto@1.0.1/node_modules/get-proto/index.js"(exports2, module2) {
        ...
        module2.exports = reflectGetProto ? function exports(O) {
          return reflectGetProto(O);
        } : originalGetProto ? function exports(O) {
          if (!O || typeof O !== "object" && typeof O !== "function")
            throw new TypeError("getProto: not an object");
          return originalGetProto(O);
        } : getDunderProto ? function exports(O) {
      ...
      "node_modules/.pnpm/get-intrinsic@1.3.0/node_modules/get-intrinsic/index.js"(exports2, module2) {
        "use strict";
        var undefined2, $Object = require_es_object_atoms(), $Error = require_es_errors(), $EvalError = require_eval(), $RangeError = require_range(), $ReferenceError = require_ref(), $SyntaxError = require_syntax(), $TypeError = require_type(), $URIError = require_uri(), abs = require_abs(), floor = require_floor(), max = require_max(), min = require_min(), pow = require_pow(), round = require_round(), sign = require_sign(), $Function = Function, getEvalledConstructor = function getEvalledConstructor(expressionSyntax) {
          try {
            return $Function('"use strict"; return (' + expressionSyntax + ").constructor;")();
          } catch {
          }
        }, $gOPD = require_gopd(), $defineProperty = require_es_define_property(), throwTypeError = function throwTypeError() {
          throw new $TypeError();
        }, ThrowTypeError = $gOPD ? (function ThrowTypeError() {
          try {
        ...
        var errorProto, doEval = function doEval2(name) {
        ...
        }, bind = require_function_bind(), hasOwn = require_hasown(), $concat = bind.call($call, Array.prototype.concat), $spliceApply = bind.call($apply, Array.prototype.splice), $replace = bind.call($call, String.prototype.replace), $strSlice = bind.call($call, String.prototype.slice), $exec = bind.call($call, RegExp.prototype.exec), rePropName2 = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, reEscapeChar2 = /\\(\\)?/g, stringToPath2 = function stringToPath2(string) {
          ...
          var result = [];
          return $replace(string, rePropName2, function stringToPath2(match, number, quote, subString) {
        ...
        module2.exports = function exports(name, allowMissing) {
      ...
      "node_modules/.pnpm/is-regex@1.2.1/node_modules/is-regex/index.js"(exports2, module2) {
        ...
        hasToStringTag ? ($exec = callBound("RegExp.prototype.exec"), isRegexMarker = {}, throwRegexMarker = function throwRegexMarker() {
          throw isRegexMarker;
        }, badStringifier = {
          toString: throwRegexMarker,
          valueOf: throwRegexMarker
        }, typeof Symbol.toPrimitive === "symbol" && (badStringifier[Symbol.toPrimitive] = throwRegexMarker), fn = function fn(value) {
        ...
        }) : ($toString = callBound("Object.prototype.toString"), regexClass = "[object RegExp]", fn = function fn(value) {
      ...
      "node_modules/.pnpm/safe-regex-test@1.1.0/node_modules/safe-regex-test/index.js"(exports2, module2) {
        ...
        module2.exports = function exports(regex) {
          if (!isRegex(regex))
            throw new $TypeError("`regex` must be a RegExp");
          return function exports(s) {
      ...
      "node_modules/.pnpm/is-symbol@1.1.1/node_modules/is-symbol/index.js"(exports2, module2) {
        ...
        hasSymbols ? ($symToStr = callBound("Symbol.prototype.toString"), isSymString = safeRegexTest(/^Symbol\(.*\)$/), isSymbolObject = function isSymbolObject(value) {
          return typeof value.valueOf() !== "symbol" ? !1 : isSymString($symToStr(value));
        }, module2.exports = function exports(value) {
    ...
    var isFunction_default = isFunction, coreJsData = root_default["__core-js_shared__"], coreJsData_default = coreJsData, maskSrcKey = (function maskSrcKey() {
    ...
    function memoizeCapped(func) {
      var result = memoize_default(func, function result(key) {
        return cache3.size === MAX_MEMOIZE_SIZE && cache3.clear(), key;
      }), cache3 = result.cache;
      return result;
    }
    var memoizeCapped_default = memoizeCapped, rePropName = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, reEscapeChar = /\\(\\)?/g, stringToPath = memoizeCapped_default(function stringToPath(string) {
      var result = [];
      return string.charCodeAt(0) === 46 && result.push(""), string.replace(rePropName, function stringToPath(match, number, quote, subString) {
...
var require_address = __commonJS({
  "../../node_modules/address/lib/address.js"(exports, module) {
    ...
    address.ip = function ip(interfaceName) {
      var item = address.interface("IPv4", interfaceName);
      return item && item.address;
    };
    address.ipv6 = function ipv6(interfaceName) {
...
`), i = 0; i < lines.length; i++) {
    ...
    address.mac = function mac(interfaceName, callback) {
    ...
    address.dns = function dns(filepath, callback) {
      typeof filepath === "function" && (callback = filepath, filepath = null), filepath = filepath || DEFAULT_RESOLV_FILE, fs.readFile(filepath, "utf8", function dns(err, content) {
        if (err)
          return callback(err);
        var servers = [];
        content = content || "";
...
`), socket.destroy();
    ...
    this.socket.on("close", function ServerChannelTransport() {
