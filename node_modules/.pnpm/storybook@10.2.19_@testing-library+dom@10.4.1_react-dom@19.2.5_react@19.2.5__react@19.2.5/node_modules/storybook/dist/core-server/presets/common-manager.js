...
function n() {
  return n = Object.assign ? Object.assign.bind() : function n(e2) {
...
function qe(e2, n2) {
  ...
  return { t: (e3) => a2.test(e3), o: je(function o(e3, n3) {
...
`).match(o2), u2 = !1;
    return { items: i2.map(function items(e4, r3) {
...
`) : (t2.inline = !0, p2 = Se(l2));
  ...
  }, l: (n3, r3, t2) => e2(n3.ordered ? "ol" : "ul", { key: t2.key, start: n3.type === "20" ? n3.start : void 0 }, n3.items.map(function l(n4, o3) {
...
function Le(e2, n2, r2) {
  r2.inline = !0;
  let t = e2[2] ? e2[2].replace(G, "").split("|").map(Re) : [], o2 = e2[3] ? (function o2(e3, n3, r3) {
...
`, { inline: n2 }));
  ...
  function ce2(e2, n2) {
    ...
    return r3 ? r3.reduce(function(n3, r4) {
      let t2 = r4.indexOf("=");
      if (t2 !== -1) {
        let a2 = (function a2(e3) {
          return e3.indexOf("-") !== -1 && e3.match(L) === null && (e3 = e3.replace(T, function e3(e4, n4) {
            return n4.toUpperCase();
          })), e3;
        })(r4.slice(0, t2)).trim(), c2 = (function c2(e3) {
          let n4 = e3[0];
...
`, t2), o3 = e2.slice(t2, n3 === -1 ? void 0 : n3 + 1);
    ...
    let t2 = e2;
    return W2("table", { key: r3.key }, W2("thead", null, W2("tr", null, t2.header.map(function l(e3, o2) {
      return W2("th", { key: o2, style: Oe(t2, o2) }, n2(e3, r3));
    }))), W2("tbody", null, t2.cells.map(function l(e3, o2) {
      return W2("tr", { key: o2 }, e3.map(function l(e4, o3) {
        return W2("td", { key: o3, style: Oe(t2, o3) }, n2(e4, r3));
      }));
    })));
  } }, 27: { o: je(function o(e2, n2) {
    let r3;
  ...
  let se2 = (function se2(e2) {
    ...
    return n2.sort(function se2(n3, r4) {
      return e2[n3].i - e2[r4].i || (n3 < r4 ? -1 : 1);
    }), function se2(e3, n3) {
      return r3((function se2(e4) {
        return e4.replace(k, `
`).replace(v, "").replace(N, "    ");
      })(e3), n3);
    };
  })(le2), fe2 = /* @__PURE__ */ (function fe2(e2, n2) {
...
var index_modern_default = (n2) => {
  let { children: t, options: o2 } = n2, a2 = (function a2(e2, n3) {
    if (e2 == null) return {};
...
var __create = Object.create, __defProp = Object.defineProperty, __getOwnPropDesc = Object.getOwnPropertyDescriptor, __getOwnPropNames = Object.getOwnPropertyNames, __getProtoOf = Object.getPrototypeOf, __hasOwnProp = Object.prototype.hasOwnProperty, __commonJS = (cb, mod) => function __commonJS() {
  ...
  "node_modules/is-object/index.js"(exports, module) {
    "use strict";
    module.exports = function exports(x2) {
...
}, createIterator = (showNonenumerable, sortObjectKeys) => function*  createIterator(data) {
...
}, domIterator = function*  domIterator(data) {
...
function ownKeys(e2, r2) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    r2 && (o2 = o2.filter(function o2(r3) {
...
var INITIAL_CONTROL_STATES = {
  ...
  function Panel({ refId, storyId, storyUrl }) {
...
var BackgroundTool = memo5(function BackgroundTool() {
...
}), Pure = memo5(function Pure(props) {
  let {
    length,
    updateGlobals,
    backgroundMap,
...
var OutlineSelector = memo6(function OutlineSelector() {
