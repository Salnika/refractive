...
var require_quote = __commonJS({
  "../../node_modules/shell-quote/quote.js"(exports, module) {
    "use strict";
    module.exports = function exports(xs) {
      return xs.map(function exports(s) {
...
var require_parse = __commonJS({
  "../../node_modules/shell-quote/parse.js"(exports, module) {
    ...
    module.exports = function exports(s, env2, opts) {
      var mapped = parseInternal(s, env2, opts);
      return typeof env2 !== "function" ? mapped : mapped.reduce(function exports(acc, s2) {
        if (typeof s2 === "object")
          return acc.concat(s2);
        var xs = s2.split(RegExp("(" + TOKEN + ".*?" + TOKEN + ")", "g"));
        return xs.length === 1 ? acc.concat(xs[0]) : acc.concat(xs.filter(Boolean).map(function exports(x) {
...
var require_guess = __commonJS({
  "../../node_modules/launch-editor/guess.js"(exports, module) {
    ...
    module.exports = function exports(specifiedEditor) {
      if (specifiedEditor)
...
var require_get_args = __commonJS({
  "../../node_modules/launch-editor/get-args.js"(exports, module) {
    ...
    module.exports = function exports(editor, fileName, lineNumber, columnNumber = 1) {
  ...
  "../../node_modules/launch-editor/index.js"(exports, module) {
    ...
    function launchEditor(file, specifiedEditor, onErrorCallback) {
      ...
      if (_childProcess && isTerminalEditor(editor) && _childProcess.kill("SIGKILL"), process.platform === "win32") {
        let escapeCmdArgs2 = function escapeCmdArgs2(cmdArgs) {
          return cmdArgs.replace(/([&|<>,;=^])/g, "^$1");
        }, doubleQuoteIfNeeded2 = function doubleQuoteIfNeeded2(str) {
...
var GenericParser = class {
  ...
  async parse(content) {
    ...
    return ast.program.body.forEach(function GenericParser(node) {
