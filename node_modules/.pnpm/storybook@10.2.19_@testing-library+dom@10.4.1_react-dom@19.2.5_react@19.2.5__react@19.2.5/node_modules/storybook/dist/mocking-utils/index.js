...
function n2(n3, i, o2, f) {
  let s, u, l = r(n3, o2), c = (function c(e2) {
...
function extractMockCalls(options, parse, root, findMockRedirect2) {
  try {
    let hasSpyTrue2 = function hasSpyTrue2(objectExpression) {
...
var _UNC_REGEX = /^[/\\]{2}/, _IS_ABSOLUTE_RE = /^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/, _DRIVE_LETTER_RE = /^[A-Za-z]:$/, _EXTNAME_RE = /.(\.[^./]+|\.)$/, normalize2 = function normalize2(path) {
  if (path.length === 0)
    return ".";
...
var resolve2 = function resolve2(...arguments_) {
