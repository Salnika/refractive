...
function _extends() {
  return _extends = Object.assign ? Object.assign.bind() : function _extends(target) {
...
// ../../node_modules/react-router/dist/index.js
function _extends2() {
  return _extends2 = Object.assign ? Object.assign.bind() : function _extends2(target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
      for (var key in source)
        Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]);
...
var DataRouterHook = (function DataRouterHook(DataRouterHook3) {
...
})(DataRouterHook || {}), DataRouterStateHook = (function DataRouterStateHook(DataRouterStateHook3) {
...
var AwaitRenderStatus = (function AwaitRenderStatus(AwaitRenderStatus2) {
...
// ../../node_modules/react-router-dom/dist/index.js
function _extends3() {
  return _extends3 = Object.assign ? Object.assign.bind() : function _extends3(target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
      for (var key in source)
        Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]);
...
var isBrowser = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", ABSOLUTE_URL_REGEX = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, Link = React2.forwardRef(function Link(_ref4, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
...
var NavLink = React2.forwardRef(function NavLink(_ref5, ref) {
  let {
