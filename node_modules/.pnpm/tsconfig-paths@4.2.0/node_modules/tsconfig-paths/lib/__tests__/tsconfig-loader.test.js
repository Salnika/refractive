...
describe("tsconfig-loader", function () {
    it("should find tsconfig in cwd", function () {
        var result = (0, tsconfig_loader_1.tsConfigLoader)({
            cwd: "/foo/bar",
            getEnv: function  getEnv(_) { return undefined; },
            loadSync: function  loadSync(cwd) {
                return {
    ...
    it("should use TS_NODE_PROJECT env if exists", function () {
        var result = (0, tsconfig_loader_1.tsConfigLoader)({
            ...
            loadSync: function  loadSync(cwd, fileName) {
    ...
    it("should use TS_NODE_BASEURL env if exists", function () {
        var result = (0, tsconfig_loader_1.tsConfigLoader)({
            ...
            loadSync: function  loadSync(_0, _1, baseUrl) {
                return {
                    tsConfigPath: undefined,
                    baseUrl: baseUrl,
                    paths: {},
...
describe("walkForTsConfig", function () {
    it("should find tsconfig in starting directory", function () {
        ...
        var res = (0, tsconfig_loader_1.walkForTsConfig)((0, path_1.join)("/root", "dir1"), function  res(path) { return mockFiles[path] || []; });
    ...
    it("should return undefined when reaching the top", function () {
        var res = (0, tsconfig_loader_1.walkForTsConfig)((0, path_1.join)("/root", "dir1", "kalle"), function  res() { return []; });
...
describe("loadConfig", function () {
    it("should load a config", function () {
        ...
        var res = (0, tsconfig_loader_1.loadTsconfig)("/root/dir1/tsconfig.json", function  res(path) { return path === "/root/dir1/tsconfig.json"; }, function  res(_) { return JSON.stringify(config); });
        expect(res).toStrictEqual(config);
    });
    it("should load a config with comments", function () {
        var config = { compilerOptions: { baseUrl: "hej" } };
        var res = (0, tsconfig_loader_1.loadTsconfig)("/root/dir1/tsconfig.json", function  res(path) { return path === "/root/dir1/tsconfig.json"; }, function  res(_) { return "{\n          // my comment\n          \"compilerOptions\": { \n            \"baseUrl\": \"hej\"\n          }\n        }"; });
        expect(res).toStrictEqual(config);
    });
    ...
    it("should load a config with string extends and overwrite all options", function () {
        ...
        var res = (0, tsconfig_loader_1.loadTsconfig)((0, path_1.join)("/root", "dir1", "tsconfig.json"), function  res(path) { return path === firstConfigPath || path === baseConfigPath; }, function  res(path) {
    ...
    it("should use baseUrl relative to location of extended tsconfig", function () {
        ...
        var res = (0, tsconfig_loader_1.loadTsconfig)((0, path_1.join)("/root", "dir1", "dir2", "third-config.json"), function  res(path) {
    ...
    it("should load a config with array extends and overwrite all options", function () {
        ...
        var res = (0, tsconfig_loader_1.loadTsconfig)((0, path_1.join)("/root", "tsconfig.json"), function  res(path) {
            return [
                baseConfig1Path,
                baseConfig2Path,
                baseConfig3Path,
    ...
    it("should load a config with array extends without .json extension", function () {
        ...
        var actualConfigPath = (0, path_1.join)("/root", "tsconfig.json");
        var res = (0, tsconfig_loader_1.loadTsconfig)((0, path_1.join)("/root", "tsconfig.json"), function  res(path) { return [baseConfigPath, actualConfigPath].indexOf(path) >= 0; }, function  res(path) {
            if (path === baseConfigPath) {
                return JSON.stringify(baseConfig);
            }
            if (path === actualConfigPath) {
