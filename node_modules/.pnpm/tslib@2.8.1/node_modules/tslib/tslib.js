...
(function (exporter) {
    var extendStatics = Object.setPrototypeOf ||
        ...
        function  extendStatics(d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
    ...
    __param = function  __param(paramIndex, decorator) {
        return function  __param(target, key) { decorator(target, key, paramIndex); }
    };
    ...
    __esDecorate = function  __esDecorate(ctor, descriptorIn, decorators, contextIn, initializers, extraInitializers) {
        ...
        for (var i = decorators.length - 1; i >= 0; i--) {
            ...
            context.addInitializer = function  addInitializer(f) { if (done) throw new TypeError("Cannot add initializers after decoration has completed"); extraInitializers.push(accept(f || null)); };
    ...
    __awaiter = function  __awaiter(thisArg, _arguments, P, generator) {
        function adopt(value) { return value instanceof P ? value : new P(function  __awaiter(resolve) { resolve(value); }); }
        return new (P || (P = Promise))(function  __awaiter(resolve, reject) {
    ...
    __generator = function  __generator(thisArg, body) {
        var _ = { label: 0, sent: function sent() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
        return g.next = verb(0), g["throw"] = verb(1), g["return"] = verb(2), typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
        function verb(n) { return function  __generator(v) { return step([n, v]); }; }
        function step(op) {
    ...
    __createBinding = Object.create ? (function __createBinding(o, m, k, k2) {
        ...
        if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) {
            desc = { enumerable: true, get: function get() { return m[k]; } };
        }
    ...
    __asyncGenerator = function  __asyncGenerator(thisArg, _arguments, generator) {
        ...
        function awaitReturn(f) { return function  __asyncGenerator(v) { return Promise.resolve(v).then(f, reject); }; }
    ...
    __asyncDelegator = function  __asyncDelegator(o) {
        var i, p;
        return i = {}, verb("next"), verb("throw", function  __asyncDelegator(e) { throw e; }), verb("return"), i[Symbol.iterator] = function () { return this; }, i;
    ...
    __asyncValues = function  __asyncValues(o) {
        ...
        function settle(resolve, reject, d, v) { Promise.resolve(v).then(function __asyncValues(v) { resolve({ value: v, done: d }); }, reject); }
    };
    ...
    var ownKeys = function(o) {
        ownKeys = Object.getOwnPropertyNames || function  ownKeys(o) {
            var ar = [];
    ...
    __addDisposableResource = function  __addDisposableResource(env, value, async) {
        if (value !== null && value !== void 0) {
            ...
            if (inner) dispose = function dispose() { try { inner.call(this); } catch (e) { return Promise.reject(e); } };
            ...
            while (r = env.stack.pop()) {
                try {
                    ...
                    if (r.dispose) {
                        ...
                        if (r.async) return s |= 2, Promise.resolve(result).then(next, function __disposeResources(e) { fail(e); return next(); });
                    }
                    else s |= 1;
                }
                catch (e) {
    ...
    __rewriteRelativeImportExtension = function  __rewriteRelativeImportExtension(path, preserveJsx) {
        if (typeof path === "string" && /^\.\.?\//.test(path)) {
            return path.replace(/\.(tsx)$|((?:\.d)?)((?:\.[^./]+?)?)\.([cm]?)ts$/i, function  __rewriteRelativeImportExtension(m, tsx, d, ext, cm) {
