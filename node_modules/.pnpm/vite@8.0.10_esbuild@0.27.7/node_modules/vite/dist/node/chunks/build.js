...
var require_lodash_camelcase = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function basePropertyOf(object) {
		return function require_lodash_camelcase(key) {
	...
	*/
	function createCaseFirst(methodName) {
		return function require_lodash_camelcase(string) {
	...
	* // => 'fooBar'
	*/
	var camelCase = createCompounder(function camelCase(result, word, index) {
...
var require_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function uniqs() {
		...
		return list.filter(function require_parser(item, i) {
...
var require_src$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	plugin.postcss = true;
	plugin.generateScopedName = function generateScopedName(name, path) {
		return `_${path.replace(/\.[^./\\]+$/, "").replace(/[\W_]+/g, "_").replace(/^_|_$/g, "")}__${name}`.trim();
	};
	plugin.generateExportEntry = function generateExportEntry(name, scopedName) {
		return {
			key: unescape(name),
