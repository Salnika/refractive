...
const AsyncFunction = async function AsyncFunction() {}.constructor;
...
function wrapCallSite(frame, state) {
	...
	if (source) {
		...
		return frame.getFunctionName = function getFunctionName() {
	...
	return origin ? (origin = mapEvalOrigin(origin), frame = cloneCallSite(frame), frame.getEvalOrigin = function getEvalOrigin() {
